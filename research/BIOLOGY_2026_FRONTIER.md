...
| `WholeCell.bend` | 215 | 1 / 525 | two presentations composed: product state, sum of generators; uncoupled steps commute by refl, the coupled ones do not; under the coupling the other subsystem's unread gene is necessary state; the two subsystems' receivers are folds of one composite history |
