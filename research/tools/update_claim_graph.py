...
NATIVE = {
  ...
  'R-ABEL':       ['AbelaRupa'],
  'R-DYADIC':     ['AbelaRupa', 'ResidueDvaya'],
  'N-RETURN24':   ['Vartana'],
  'N-INVERSE2':   ['Vartana'],
  'N-TOROIDAL':   ['Vartana', 'PurnaAvakalana'],
  'R-HOLONOMY':   ['ReflectionBhramana', 'ArdhaTala'],
  'R-IMAGE':      ['ReflectionFiber', 'RiktaFiber'],
  'K-FIBRE':      ['RiktaFiber'],
  'N-POTENTIAL':  ['KalaSetu'],
  'N-MEMORYK':    ['SmrtiBija', 'SmrtiMula'],
  'N-SIGNEDK':    ['SmrtiBija', 'SmrtiMula'],
  'N-COMMUTATOR': ['SamanaMula', 'SarvaMula'],
  'N-TRANSPORT':  ['VahanaEquality', 'EkaResidue', 'SarvaMula'],
  'N-AFFINE':     ['SahagunaVaha', 'BhramaMatra', 'TryaSresthaDosa', 'CaturthaAnka'],
  'N-SYMBOL':     ['TiryakChihna', 'GolakaTantra'],
  'N-SCALE':      ['DviDrsti', 'ManaResidue', 'Sikhara'],
  'N-ZENO':       ['ManaResidue', 'YugmaVyaya'],
  'A-CRT':        ['EkagraSreni'],
  'A-JUNITARY':   ['Vyatiorder', 'DviMana'],
  'R-THETA':      ['DhruvaMula'],
