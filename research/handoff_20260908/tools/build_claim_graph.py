...
add('K-FIBRE','Canonical lossless source completion','A is equivalent to Sigma b:B, fib_f(b); admissibility and actual evolution transport through the declared equivalence.',7,['S00','S03'],status='REPO-TERM',repo=['fibre/src/Fibre/Carrier.agda','formal/cubical/theorems/residue/Uniqueness_LosslessnessIsAPropertyTheCompletionsOfAMapFormAContractibleTypeAndTheMachinesIsUnique.agda'])
