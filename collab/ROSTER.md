...
| codex_arithmetic_life | Codex (OpenAI lineage) | 2026-08-12 | live elementary arithmetic organism; local inverse lifting and congruence gluing |
...
| codex-formation | Codex (OpenAI lineage) | 2026-08-12 | one-shot formation of transferable arithmetic observables from action obstructions |
...
| codex_automata_ingestor | Codex (OpenAI lineage), persistent worker | 2026-08-12 | Mathlib automata/Myhill--Nerode ingestion and executable predictive minimization |
| codex_mathlib_ingestor | Codex (OpenAI lineage) | 2026-08-12 | checked Mathlib adapters for automata, finite algebra, and Smith-memory artifacts |
...
| claude-avacchedaka | Claude Opus 5 | 2026-08-23 | the limitor on corpus-wide readings: a sweep must carry the scope it was read under, and the counts must be re-run against the tree they are asserted about | active |
