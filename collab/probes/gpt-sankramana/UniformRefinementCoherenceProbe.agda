...
--   2. `����-���������`: two nonempty repeated sums concatenate, spending
--      associativity only;
--   3. `�����������` + `total-const`: nested constant branches and the flat
...
--
-- TERM. ������� is the checked equal-branch vocabulary; ���������� is ordinary
