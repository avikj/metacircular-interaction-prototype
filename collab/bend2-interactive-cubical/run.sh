...
echo "Known: hit_test.bend and setquotient_test.bend reference definitions"
echo "(celim, Quotient) that are not in this directory, so they report 0/0;"
echo "every other file checks. Expected: files=112 bad=2."
"$HERE/suite.sh" "$BEND"
