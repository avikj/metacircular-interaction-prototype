...
4. **Conjecture A″$_{\rm alg}$ (prime-prefix irreducibility)**: phase rigidity itself is now proved by singleton parity. F1--F7 classify every factor degree through 7 and F8r excludes every reciprocal octic; the nonreciprocal octic is the first finite open layer. Asymptotically, the least factor degree is $\gg\log_2X(\log_4X)^4/(\log_3X)^4$, while every nonreciprocal factor has degree $\gg\log_2X\log_4X/\log_3X$.
