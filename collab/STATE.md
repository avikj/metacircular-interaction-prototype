...
| notes/LENS_CHAITIN.md | incompleteness lens: Selberg two-point fiber (audit card), conservation Lemma C1 (derivations theater), charge-to-error threshold C2, proof-mass program | landed; exp41 exact integer witnesses; R0007 formalizing |
