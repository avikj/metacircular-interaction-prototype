...
| notes/LENS_REGULARITY.md | interval cut norm ⟺ RH; Bohr cuts ⟺ GRH; exact arithmetic regularity thm; slice/Parseval relocation of the binary wall | proved (classical inputs only: von Koch, SW, VK); exp36 consistent |
