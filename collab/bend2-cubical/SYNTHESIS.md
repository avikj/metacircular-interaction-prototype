...
construction, and necessarily so; see Â§7.
...
5. **Batch migration on a superposed batch.** The measured win in Â§4:
...
- Its headline benchmark result does **not** transfer, and an earlier draft
  ...
  not about these numbers. Every figure in Â§3 and Â§4 was measured here, on
