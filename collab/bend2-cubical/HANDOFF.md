# HANDOFF — the cubical Bend2 work
...
- Native DUP-SUP routing confirmed on HVM4: a match commutes over a
  ...
  � branches get 1 and 2). `supline.bend` is the Bend2 test for it.

## supline.bend (6�; full runtime &0{0,1}, native routing) and
isprop_run.bend (5�; 4-face composite decided at every corner) are recorded in
