...
**Toolchain differs from the pin.** Fibers listed below may be
version skew (BUILD.md "Where the skew bites"), which is
evidence about the container, not the tree. Align the
container with the pin before treating any fiber below as a
reconstruction question; do not edit modules to appease the
wrong toolchain.
...
- `NaturalMachine/CountedDigitsEdge.agda`
- `NaturalMachine/DSOFiniteCore.agda`
