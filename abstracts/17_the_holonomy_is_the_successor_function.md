...
The system is a discrete circuit with an integer
fibre; "holonomy" names the action of the loop on that fibre, and "observable"
names a function out of the state. The physical reading is a reading.
