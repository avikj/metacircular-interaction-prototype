...
-- SaptabhangiGarbha_TheResidueIsTheSeed -- the seven positions, carrying
-- the standpoints that produced them, and the birth that takes the fourth
-- position on to the next derivation.
--
-- WHAT IT REPLACES.  `machine/Saptabhangi_TheSevenfoldVerdict.hs` gives the
...
module SaptabhangiGarbha_TheResidueIsTheSeed
