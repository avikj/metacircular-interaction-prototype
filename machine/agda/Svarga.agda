...
--
-- ������� � heaven, the weightless place; here: the law made portable enough
...
-- the theorems, which are cubical-corpus facts (Return.Carrier;
-- Saptabhangi.�������) restated as a FINITE EXHAUSTIVE computation, which is
...
-- SanghattaMachine (this repo).  `report : String` is the entire pure
