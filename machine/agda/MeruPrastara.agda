...
------------------------------------------------------------------------
-- ����-��������� � ported from machine/MeruPrastara_TheSignedArrayIsOne
...
-- kernel's own backend (MAlonzo/GHC).  �������� is Pigala's word for the
...
-- ������� m k � Pigala's array with the Mbius sign, by the recursion.
bindu : Nat → Nat → Int
