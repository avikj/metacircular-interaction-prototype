...
-- The fiber is �[ k ∈ � ] (������� D (a , b) ≡ k) = singl (������� D (a , b)),
...
-- driving at.
--
-- DEFECT, written rather than hidden.  The �������� STEP ITSELF is not
-- formalised.  It requires choosing m with k � (a + b�m), and then
-- dividing the composed row through by k � exact division in �, which
-- needs a divisibility witness carried alongside and is not done here.
-- What is formalised is the ����� the �������� is built out of.  Calling
