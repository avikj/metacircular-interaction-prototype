...
--
--   * the fiber is **empty** � over `b` there is simply no source: syd
...
-- exhibits by hand:
--
--   ������     the fiber is empty        � syd nsti: no source over b; ����������
--   ��������   the fiber is contractible  � level �, one utterance carries all
...
-- simultaneous fiber census whose every entry is level �.
------------------------------------------------------------------------
...
-- �������������) are both crowded fibers, and both land in `���������` here.
--
...
-- `������-������������` (level �).  Its candidate criterion � the fiber is a
