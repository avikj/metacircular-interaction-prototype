...
-- never a stale payload: at depth n it is exactly ����� of the n-th state.
-- Losslessness read forward through an infinite trajectory � the carried
-- datum is �������� (alive) at every rung of the coinductive orbit.
module Fiber.JivitaSmrti where
open import Cubical.Foundations.Prelude
open import Cubical.Data.Nat using (ℕ)
open import Cubical.Data.Sigma using (_×_)
open import Fiber.Orbit using (lookup ; iterate)
