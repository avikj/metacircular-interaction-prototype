...
--
--   मूल-प्रक्षेप : Γ f → A     fiber over a is  singl (f a)  — ALWAYS
--                              contractible, so this is ALWAYS an
--                              equivalence.  (§3)
--
--   लक्ष्य-प्रक्षेप : Γ f → B    fiber over b is  शेष b  — contractible
...
--
--   the fiber is EMPTY   — over `b` there is no source: syād नास्ति.
...
--                          every empty fiber.)
--   the fiber is CROWDED — two points not identified.  नष्टि, हिंसा,
--                          अप्रतिकार्या.
--
...
module Fiber.Residue_TheResidualIsTheOtherProjectionOfTheSameGraph where
