...
-- `Fiber.Sthanivadbhava….स्थानिवत्` to the number component at
...
-- adds NOTHING to the cardinality, because the fiber is contractible.
...
module Fiber.SthanivatSankhya_TheAdesaStateSpaceIsExactlyEightyOneAndTheJoinToTheNumberComponentIsChecked where
...
open import Fiber.Carrier using (Carrier≃)
