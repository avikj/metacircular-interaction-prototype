...
- **Homometric rigidity of the primes**: the set $\{p\le X\}$ is determined by its difference multiset up to reflection whenever the non-cyclotomic part of $\sum_{p\le X}x^{p-2}$ is irreducible — verified through degree 49,997.  The cyclotomic layer is classified globally (only $\Phi_2\mid F_3$ and $\Phi_6\mid F_{11}$), every irreducible factor through degree seven is classified exactly, and reciprocal octics are excluded.  In particular the unique septic is $F_{11}/\Phi_6$, no factor of degree at most seven occurs for $X\ge13$, and $F_{13},F_{17},F_{19}$ are irreducible.
