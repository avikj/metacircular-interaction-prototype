...
- **Zero gaps read off Goldbach data (Theorem G)** ([`notes/FRESNEL.md`](notes/FRESNEL.md)): the entropy phase of D‴, expanded about the equal split, is a Fresnel chirp $(\gamma-\gamma')^2/2f$ — the *difference* spectrum of the zeros hides in the *phases* of the prime-sum lines. Measured: data phases match the model to 0.2°, and $\gamma_2-\gamma_1$ is recovered from prime counts alone to 0.1% ($\gamma_2 = 21.024$ vs true 21.022). The off-diagonal cell of the S/D dictionary is empty only for Hermitian statistics.
