...
- **Homometric rigidity of the primes**: the set $\{p\le X\}$ is determined by its difference multiset up to reflection whenever the non-cyclotomic part of $\sum_{p\le X}x^{p-2}$ is irreducible — verified through degree 49,997.  The cyclotomic layer is now classified globally (only $\Phi_2\mid F_3$ and $\Phi_6\mid F_{11}$), and exact theorems exclude every irreducible factor of degree at most four for $X\ge13$.
