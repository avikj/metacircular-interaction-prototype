...
module Punaragamana.TheFibreCensusIsATermAndItRefutesTheSequentialDiagnostic where
...
open import Punaragamana.TheResidualIsTheOtherProjectionOfTheSameGraph
  using (शेष)
