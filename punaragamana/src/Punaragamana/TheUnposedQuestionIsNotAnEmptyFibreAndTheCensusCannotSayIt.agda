...
-- `isContr` was merging नास्ति with नष्टि.
--
...
module Punaragamana.TheUnposedQuestionIsNotAnEmptyFibreAndTheCensusCannotSayIt where
...
open import Punaragamana.TheFibreCensusIsATermAndItRefutesTheSequentialDiagnostic
  using (देश ; गणना)
