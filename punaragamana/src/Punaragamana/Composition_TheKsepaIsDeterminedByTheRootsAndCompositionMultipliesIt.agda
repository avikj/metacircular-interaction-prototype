...
-- The fibre is Σ[ k ∈ ℤ ] (क्षेपः D (a , b) ≡ k) = singl (क्षेपः D (a , b)),
...
-- driving at.
--
-- What is formalised is the भावना the चक्रवाल is built out of.
--
...
module Punaragamana.Composition_TheKsepaIsDeterminedByTheRootsAndCompositionMultipliesIt where
