...
module Punaragamana.TheImageFactorsEveryMapAsSurjectionThenEmbeddingAndEqualitySplitIsBothLegsTrivial where
...
open import Punaragamana.TheResidualIsTheOtherProjectionOfTheSameGraph
  using (शेष)
open import Punaragamana.TheContractibleFibreSplitsAsEmbeddingTimesSurjectionAndTheEmptyAndCrowdedRefusalsAreTheTwoFactorsFailingApart
