...
module Punaragamana.TheAdesaStateSpaceIsExactlyEightyOneAndTheJoinToTheNumberComponentIsChecked where
...
open import Punaragamana.Carrier using (Carrier≃)
open import Punaragamana.TheAdesasFormIsTheFreeSlotAndItsDesignationsAreCarried
