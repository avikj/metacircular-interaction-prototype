...
--   materialises : A � �[ a' ∈ A ] Residue a'   the source is the sum
...
-- provably not an equivalence; its residue over 0 is provably �, hence
-- provably not contractible; and � � �[ n ] fiber collapse n all the same,
...
-- 2.  Its residue over 0 is the whole of � � every source is still there.
