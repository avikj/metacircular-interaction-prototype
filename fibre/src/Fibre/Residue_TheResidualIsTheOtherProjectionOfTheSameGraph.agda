...
--
-- SYT � THE CLAIM, EXACTLY OF THE SOURCE.  Nothing below is ryabhaa's.  The
...
--
--   ���-��������� : Γ f � A     fibre over a is  singl (f a)  � ALWAYS
--                              contractible, so this is ALWAYS an
--                              equivalence.  (§3)
--
--   �������-��������� : Γ f � B    fibre over b is  ��� b  � contractible
...
--
--   the fibre is EMPTY   � over `b` there is no source: syd ������.
