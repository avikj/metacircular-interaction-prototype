...
====================================================================
  ...
  Turn it before you read it — the machine is judged by being turned::

      sh interactive/run-yantra.sh --wire     # JSON in/out; for a person or an LLM
      {"kriya":"vargaprakrti","angani":{"D":61}}   → x²−61y²=1 at Bhāskara's number
