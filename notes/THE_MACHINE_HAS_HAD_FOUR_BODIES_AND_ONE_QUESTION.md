...
which changed an instrument. Six links, three of them terms with exit codes
(`Durnaya_CollapseIffEveryNayaAgrees.agda`, `cb0abfff`, `d19a83e6`); link 2 is
a journal entry, link 5 a message, link 6 a shell script. Crossing from
`formal/` into a book and back into `machine/`.
...
five links, not six, and this section overstates by one. That is recorded
