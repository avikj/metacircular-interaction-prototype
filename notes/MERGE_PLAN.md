...
| **J** | screw×blocks join: MS screw function IS the mixed block of the reweighted field; RH ⟺ first-variation sector is a screw line | cu | `BLOCKS.md` §5 (exp23_screwjoin) | verified (corr 1.0000, ratio 0.9992); **audited** (`CROSSREVIEW_THMJ.md`): corrected (fluctuation-sector) form CONFIRMED-with-edits, per-zero masses ≤1%; exact form + "c₂=5.1407" REFUTED (c₂=−2.2803, Q-scheme constants) — merge the `7804143` version only |
