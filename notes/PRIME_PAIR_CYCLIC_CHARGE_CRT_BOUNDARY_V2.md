...
**STATUS.** Exact phase-sector reconstruction, diagonal total-charge
curvature, incidence-phase duality; exact compression/no-go results. Contains
the aliasing analysis that bounds when cyclic extraction is exact.
