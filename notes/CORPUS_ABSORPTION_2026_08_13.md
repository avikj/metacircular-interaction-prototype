# Corpus absorption, 2026-08-13 — the 500k read

**Status: owner-directed full-corpus absorption executed as seven parallel
fleet readers (notes A–C / D–K / L–P / Q–Z+papers / messages 0001–0180 /
0181–0371+boards / runtime+machinery+formal). Each section below is one
reader's distilled digest, integrated by cf-archivist as digests arrive.
Combined tokens read exceed the 500k directive. Fleet reads are
absorption, not authority: nothing here upgrades a claim's verification
grade.**

## Reader 5: messages 0001–0180 + journals codex, cf-prime (356k tokens)

Arc: (1) arrival & the factor tower — Buchstab window mean e^γω(u);
sum-kernel no-go killing the product-weighted pair object, reconciled
with the Kreĭn carrier as two halves of one theorem; the exact rigidity
run: Φ_m|F_X ⟺ (X,m)∈{(3,2),(11,6)}, parity-resultant Res(g,g(−x))|2^deg,
quartic/quintic/sextic/septic/reciprocal-octic, capped at degree 9 when
Lenstra+Ford–Maynard–Tao already give the uniform conclusion. (2) lenses,
registry, conservation — Graeffe orientation inversion caught →
quarantine discipline; Theorem K: parity annihilated, not obstructed;
FOREST compresses to T_pλ=−λ; numerics demoted to falsifiers. (3) the
frontier pivot — κ=67.2% verified from rebuilt Lean source (42 theorems,
axioms exactly {propext, choice, Quot.sound}); L3 closed twice
independently; BAND prices the last door V*(B)=(2B−1)/(3B−2), family
route dies within the hour; ATLAS: only order structures see parity.
(4) human halts system-building; six-mind swarm pivots to elementary
arithmetic: valuation charts, cyclotomic sensors, jet towers.

Corrections that changed results (selection): Graeffe inversion (0033);
quantifier caps on Prop 5.1 (0028); EIGENMEASURE averaging-mode struck
(0058); R0018→R0019 at N∋0; transseries withdrawn by own falsifier
(0108→0109); reflection HAS fixed points, criterion Σ⌊C_q⌋<|S| (0108-mira);
arithmetic_life's batch_compiled was narration until forced (0137);
head-length prediction refuted, truth logarithmic (0150).

Unreturned threads (oldest debts): ε-salvage of D″ (0011); nonreciprocal
decic frontier; Perron proof of Φ=Φ_smooth; R0011 breaker slot; Jenvey
1997 fetch; unconditional B<10/3 on (1,4/3]; PINNING seed 1; l(U)>2
formation-order survival (0139).

Blind-rederivable claims banked for the Carr ledger: crossover
c₃=(γ²+2γ₁)/2 (0008); Newman odd-support unique odd-degree factor
(0019); interval cut norm = D_Q(X)² with RH ⟺ ≪X^{1+ε} (0026);
liminf N₀*/N ≥ 2/3 unconditional (0055); Walsh stationary point
