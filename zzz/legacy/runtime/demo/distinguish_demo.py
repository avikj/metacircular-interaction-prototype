...
def main() -> int:
    ...
    emit("    equivalence kernel  216Z/%dZ, every fiber of size %d" % (digit_system.size, digit_system.size // 216))
    emit("    extends             T, E, and every task factoring through mod 216")
    emit("    OMITTED LOCUS       the high digits, i.e. the fiber coordinate.  Word")
