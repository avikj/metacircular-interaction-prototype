...
ISC/orbit: [`Samvada...agda`](../../fibre/src/Fibre/Samvada_TheOrbitIsTheOneQueryCaseOfTheInteractiveCoalgebraAndTheDemandIsWhatDiffers.agda). Carrier/transport: [`Nucleus.agda`](../../fibre/src/Fibre/Nucleus.agda). Lifecycle: [`LIFECYCLE.rst`](../../LIFECYCLE.rst). Runtime convergence: [`collab/bend2-cubical/CONVERGENCE.md`](../../collab/bend2-cubical/CONVERGENCE.md).
