...
Continuity is also internalized through the causal modulus. One local crossing consumes one unit of lookahead; a word of length `m` consumes at most `m`. The same law simultaneously controls continuity in the prefix topology, causal propagation in time, and information demand. This is the bridge to [State/Event â” Time/Information](06-state-event-time-information.md).
