...
name of a module family, following `punaragamana/README.md` and
`punaragamana/src/Punaragamana/Carrier.agda` in this repository. **The compound
...
namespace Pairfield.Punaragamana
