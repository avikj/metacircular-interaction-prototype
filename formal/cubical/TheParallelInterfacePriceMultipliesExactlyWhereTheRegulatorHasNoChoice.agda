...
------------------------------------------------------------------------
-- TheParallelInterfacePriceMultipliesExactlyWhereTheRegulatorHasNoChoice
--
...
--
-- (Indian comparison, same grep, same hour: Adhyy 20, Chandastra
-- 13, Brhmasphuasiddhnta 12, Anuyogadvra 7, Sthnga 5.)  An author's
...
-- `TheArchimedeanConditionIsIndependentOfOrderAdditionAndALeastPositive.agda`
...
-- *Anuyogadvra* / *Sthnga*, and Pigala/Halyudha carry no signed
...
-- as `NaturalMachine/TheGaugeStreamCostsZeroCarriedBitsAndInvisibilityIsWeakerThanGauge.agda`
...
module TheParallelInterfacePriceMultipliesExactlyWhereTheRegulatorHasNoChoice where
