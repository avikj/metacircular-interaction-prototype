...
module TheFirstTolledCrossingOfAOneWayEdge where
...
open import TheValliRecoversItsLengthModuloTwoAndNoFurther
...
-- one-step vall land on determinants 1 and −1.  So the parity bit is
