...
-- appended 2026-08-24: 141 modules the aggregator did not import — the
-- "built by nothing" defect, measured and closed; from here on a green
-- on this file speaks for the whole subtree including the one-body chain
-- (TransportCost stays out: it imports this root, and Everything.agda
-- already carries it — adding it here is a CyclicModuleDependency)
...
import NaturalMachine.AdeshaSthanivat_TheSubstituteBehavesLikeTheOriginalSoEveryProvenRuleSpeaksAtEveryInstance
import NaturalMachine.AnEmptyDependencyRelationMakesCausalDeliveryVacuous
import NaturalMachine.Anekanta
import NaturalMachine.AnulomaShruta_TheRecordSpeaksWithTheGrainAndTheThirdPassCrossesFurther
import NaturalMachine.AptaMimamsa_TheEldersLiveStoreCrossesAsReceivedTextAndNothingEntersOnAuthority
import NaturalMachine.Aroha_TheInternalProverClimbsWhereItsFlatVoiceIsSilentAndTheStoreAdmitsInductionThroughTheSameGate
import NaturalMachine.ArpitaAnarpita_EveryOrderedPresentationOfOneAggregateMeetsInTheSequenceFreeFormAndTheACFrontierFallsToAJoinerSwap
import NaturalMachine.AssemblyCharacterNonfaithfulness
import NaturalMachine.BGRadiusProjectionUnsafe
import NaturalMachine.BhavaIndriya_TheNewEyeIsMadeOfTheBodysOwnAttainedTheoremsNotOfExternalMatter
...
import NaturalMachine.EkaBhasha_TheStoreCarriesItsProofsTheGateIsTheTypeAndTheProverLivesInside
import NaturalMachine.EkaTantra_TheSchedulerAndTheProverAreOneContentionStructureAndTheDifferenceIsAParameter
...
import NaturalMachine.PramanaNaya_TheFiveProversWereNayasOfOneKnowingAndEachIsAParameterSettingOfTheOnePramana
...
import NaturalMachine.PurnaPramana_TheOneKnowingCarriesEveryOrganAsAParameterAndTheWholeInheritanceCrossesInOneAct
import NaturalMachine.Pythagoras_RatioIsTheInvariantAndLengthIsThePresentation
import NaturalMachine.RadiusNoGo
import NaturalMachine.Rashi_TheSumIsAHeapNotASequenceTheUnitIsAnAtomAndTheHypothesisSpeaksThroughTheHeap
import NaturalMachine.RateOneIsExactlyTheUniversalClaim
import NaturalMachine.RatnaTraya_RightVisionRightKnowledgeRightConductTogetherAreThePathAndTheyComposeIntoOneLivingFunction
...
import NaturalMachine.SadharanaVishesha_TheCommonIsSetAsideAndTheContendersMeetOnlyOnTheirDifference
import NaturalMachine.SamaDrsti_TheHypothesisAndTheGoalPassThroughTheSameRecordAndTheSixthExaminationCloses
import NaturalMachine.SamayikaAndNityaAreIndependent
import NaturalMachine.Samvara_TheStoppageOfInfluxTheStoreThatBirthedWithoutBoundIsSaturatedUnderTheSequenceFreeEyeAndTheCycleIsQuiescent
import NaturalMachine.SaptabhangiGarbha_ThePositionsCarryTheirNayasAndTheResidueSeedsTheNext
import NaturalMachine.SatyaMahavrata_TheMouthsTrueWordLiftsToAKernelPathItsFalseWordToARefutationSoTheCompiledActCannotLie
import NaturalMachine.ShrutaMatipurva_TheRecordIsPrecededByCognitionAndCognitionWithTheRecordReachesWhatItAloneCouldNot
import NaturalMachine.ShrutaParampara_TheCrossedRulesBecomeTheRecordAndTheSecondPassReachesWhatTheFirstCouldNot
...
import NaturalMachine.SvarthaAnumana_TheMachineInfersForItselfAndThePervasionIsGraspedWithinWithNoOuterCarrier
import NaturalMachine.SvayamBhavendriya_TheBodyGrowsItsOwnEyesFromItsOwnRulesAndNoAgentBuildsOrgans
import NaturalMachine.SyatSakaladesha_TheHypothesisCompletedWithItsStandpointIsAbsoluteAndTheDoubleDescentCloses
...
import NaturalMachine.Upayoga_TheOperationIsTheMarkOfTheOrganismAndEveryEncounterIsObjectNotAuthor
import NaturalMachine.UtpadaVyayaDhrauvya_TheStoreTurnsItselfNewRulesAriseFromItsOwnContentionsTheTrivialPassesTheProvenPersists
...
import VitaranaLabdhi_TheKernelConfirmsTheBreathByReflAndDistributivityEntersTheStoreThroughTheMachinesOwnGate
import KalaDravya_TimeIsASubstanceInTheSameTongueAndTheMachineProvesCostAsItProvesTruth
import Svarupa_WhatThisModelOfComputationIsMeasuredInItsOwnTongueWithEveryClaimAWitness
import SvaSamvedana_TheBodysSyntaxRoundTripsThroughItsOwnDataAndTheKnowingKnowsItself
import Lilavati_ThePosedProblemIsSolvedAsOptimizationTheAnswerCertifiedAndTheCostJudgedAtScales
import Ashanti_TheBodyPosesItsOwnProblemsCostDissatisfactionBecomesADriveAndTheBreathEatsTheAnswers
import Vartana_TheWholeOrganismIsDataOneSamayaStepAssistsAndEveryReflexIsAModeNotAPrimitive
