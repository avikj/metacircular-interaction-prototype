...
--
-- Sha256Residue fenced this off: "� isEquiv sha256 is not asserted: the
...
--
--   ��������   : (m : List Bool) � length (sha256 m) ≡ 256
--   �-�������  : � isEquiv sha256
--
...
------------------------------------------------------------------------
-- §5  �������� � the digest is exactly 256 bits, for every message.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- §6  �-������� � the real hash is unconditionally a non-equivalence.
...
--     Residue's "one-way ⟺ non-equivalence", landed on SHA-256 with no
