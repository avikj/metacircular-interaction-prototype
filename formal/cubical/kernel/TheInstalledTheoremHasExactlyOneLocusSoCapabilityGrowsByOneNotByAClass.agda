...
-- ���������� � one locus.
--
-- TERM.  ������� � adhikaraa, "locus, substratum" � the place a property
...
-- is �[ t ] (t ≡ lhs).  Reversing each path identifies it with singl lhs,
...
-- The locus type of an installed theorem is �[ t ] (t ≡ lhs): the
