...
-- is cited.
-- What is proved is one step's shape â”
-- install kills by a contractible cone (Â§Â§1â“3) and leaves a residual
-- one level up (the cited fee) â” which is one Postnikov step's content.
------------------------------------------------------------------------
