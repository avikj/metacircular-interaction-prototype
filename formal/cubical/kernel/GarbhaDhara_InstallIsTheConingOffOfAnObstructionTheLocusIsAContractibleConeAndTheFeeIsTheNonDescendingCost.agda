...
-- is cited.  NOT claimed: that the FULL Postnikov climb (an âˆž-tower of
-- precipitated classes) is generated by iterated install â” that is the
-- conjecture the note records; what is proved is one step's shape â”
