...
------------------------------------------------------------------------
-- àà•ààà°-àà°àààµ â” the bit returns exactly on the alphabet.  The queue's
-- last real row (notes/SADHYA_OPEN_OBLIGATIONS.md, "induction on â•",
-- rung à) guessed aksara (parity w) â‰¡ w â” that a number is determined
