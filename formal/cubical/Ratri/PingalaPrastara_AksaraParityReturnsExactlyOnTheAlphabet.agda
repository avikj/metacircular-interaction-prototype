...
------------------------------------------------------------------------
-- अक्षर-परत्व — the bit returns exactly on the alphabet.  The guess
-- aksara (parity w) ≡ w, that a number is determined
...
module Ratri.PingalaPrastara_AksaraParityReturnsExactlyOnTheAlphabet where
