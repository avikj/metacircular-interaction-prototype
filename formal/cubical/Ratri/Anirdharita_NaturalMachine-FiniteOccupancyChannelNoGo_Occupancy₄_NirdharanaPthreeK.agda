...
module Ratri.Anirdharita_NaturalMachine-FiniteOccupancyChannelNoGo_Occupancy₄_NirdharanaPthreeK where
...
censusR1 = record { site₀ = true ; site₁ = false ; site₂ = true ; site₃ = true }
