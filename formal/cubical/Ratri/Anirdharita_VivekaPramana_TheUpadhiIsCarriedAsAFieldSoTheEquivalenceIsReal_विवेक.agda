...
module Ratri.Anirdharita_VivekaPramana_TheUpadhiIsCarriedAsAFieldSoTheEquivalenceIsReal_विवेक where
...
censusR1 = record { सम = 1 ; वाम = 0 ; दक्षिण = 0 }

censusAgree-0 : विवेक.वाम censusR0 ≡ विवेक.वाम censusR1
censusAgree-0 = refl
...
NOT-DETERMINED censusP = znots (cong विवेक.सम censusP)
