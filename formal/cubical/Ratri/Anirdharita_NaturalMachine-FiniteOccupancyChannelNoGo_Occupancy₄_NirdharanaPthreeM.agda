...
module Ratri.Anirdharita_NaturalMachine-FiniteOccupancyChannelNoGo_Occupancy₄_NirdharanaPthreeM where
...
censusR1 = record { site₀ = true ; site₁ = true ; site₂ = true ; site₃ = false }
