...
--
-- ����� ������� � loss has location, not only size.  This module gives
...
--       ��-����� : subW (addW u v) v ≡ u, by twelve clauses each of
...
--   §3  ���������-����� � one round undone: roundInv ∘ roundStep is
--       the identity on the eight named registers.
--   §4  ����-����� � ALL SIXTY-FOUR undone: the whole round phase of
