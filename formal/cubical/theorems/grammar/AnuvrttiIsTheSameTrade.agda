...
------------------------------------------------------------------------
-- 6.  CORRECTION to §5: the column ������� is in.
--
-- §5 puts ���������� in the local column.  ������ is not local.
--
...
-- 7.  PRIOR ART
--
-- FIRST.  `Anuvrtti.agda` §, which this module builds on, states:
--
...
-- are about अनुवृत्ति, not about conflict resolution.
--
