...
--     fibre of the present sensorium S : X → O —  S x ≡ S y  but  q x ≢ q y.
...
--
--     factoring through S      → blind on S's fibres → dashboard
...
module AMapThatFactorsIsBlindOnTheFibresSoASeparatedBlindPairCertifiesANewSense where
...
------------------------------------------------------------------------
-- २ · तन्तु-अन्धत्वम् — a derived reading is blind inside its source's fibres
--
...
--   NOTHING — it is §२ at O = Unit, where every fibre is the whole type, so
