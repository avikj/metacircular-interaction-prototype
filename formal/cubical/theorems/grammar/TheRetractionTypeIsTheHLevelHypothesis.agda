...
--     - `ShabdeJivahVartante.agda` — §४/§५ of the sūtra verbatim,
...
--     - `ARetractionThatIsNotStrictIsNotARetraction.agda` —
...
module TheRetractionTypeIsTheHLevelHypothesis where
...
open import ShabdeJivahVartante using (अविशेषः)
