...
--     collect 1 sivasutra6 ≡ a i u   e o ai au h y v r l          refl
--
...
-- the totality/locality trade-off of §5 is a different quantity.
--
-- The §3 collision is a computation about `x y z x`, and
