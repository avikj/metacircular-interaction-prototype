...
module Population
  ...
  --
  -- `� : Scoring` is the ground truth an evaluator is trying to report; an
  ...
  -- Residual's `no-invariant-response-sees-�`: the maps of a bridge do not
...
--
--   * the SAME presentation (definitionally: both are `pres � (λ x y �
