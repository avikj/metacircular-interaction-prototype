...
--     fiber of the present sensorium S : X ‚í O ‚î  S x ‚â° S y  but  q x ‚â q y.
...
--
--     factoring through S      ‚í blind on S's fibers ‚í dashboard
...
------------------------------------------------------------------------
-- ‡® ¬ ‡‡®‡‡‡-‡‡®‡‡ß‡‡‡µ‡Æ‡ ‚î a derived reading is blind inside its source's fibers
--
...
--   NOTHING ‚î it is ¬ß‡® at O = Unit, where every fiber is the whole type, so
