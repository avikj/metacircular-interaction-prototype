...
-- Checked warm through à¨à¾à¡à against the container's agda â” àà¿à¦àà°à à¨à¾àààà¿.
------------------------------------------------------------------------
...
and-comm : (a b : Bool) â†’ (a and b) â‰¡ (b and a)
...
avaktavya-order-free :
  (Ï† : Profile)
  â†’ (denotes (asti-from rewriter) Ï† and denotes (nasti-from kernel-refl) Ï†)
  â‰¡ (denotes (nasti-from kernel-refl) Ï† and denotes (asti-from rewriter) Ï†)
avaktavya-order-free Ï† = and-comm (Ï† rewriter) (not (Ï† kernel-refl))

-- so the REVERSED krama-pair recovers joint too: the successive witness
-- can be read either way.
krama-expresses-reversed :
  (Ï† : Profile)
  â†’ joint Ï† â‰¡ (denotes (nasti-from kernel-refl) Ï† and denotes (asti-from rewriter) Ï†)
krama-expresses-reversed Ï† = krama-expresses Ï† âˆ™ avaktavya-order-free Ï†
