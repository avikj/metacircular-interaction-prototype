...
-- the RUN preserves anything.  §4 says it, in ������'s form.
--
...
-- ������ : ������� ≡ �� + ���, which makes the record the graph of + and
...
--------------------------------------------------------------------------
-- 2.  A rule carries its certificate.  ������� ���������� ��.
--------------------------------------------------------------------------
...
--------------------------------------------------------------------------
-- 5.  ������ : for every n, the run leaves every meaning where it was
--------------------------------------------------------------------------
