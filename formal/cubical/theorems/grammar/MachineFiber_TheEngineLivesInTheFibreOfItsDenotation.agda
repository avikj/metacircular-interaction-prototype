...
--            (§� is `Alopa.������` read as a fibre statement), and ����� �
...
--            inside a ��� fibre is the whole of what the engine does.
...
-- two distinct terms, one meaning: the fibre over ⟦ ��� ⟧ has two points
