...
--       field is integral: Q� = −9R, � = 2Q².  The jet of the state
...
--
--   §4  THE VIEILLEFOSSE POINT.  Over �, (Q , R) = (−3 , 2) has
...
-- the obligation.  ����� (prabhava, source/origin of a flow) and �����
-- (dhruva, constant) are ordinary .
------------------------------------------------------------------------
...
module _ (R : CommRing ℓ) where
  ...
  ----------------------------------------------------------------------
  -- � � The jet over R and the Euler derivation.
  ----------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------
  -- � � The restricted-Euler field and the discriminant.
  ----------------------------------------------------------------------
  ...
  -- the jet of the state along the field (Q� , �) = (−9R , 2Q²)
  q-jet : ⟨ R ⟩ → ⟨ R ⟩ → Jet
  ...
  ----------------------------------------------------------------------
  -- � � The tangent of D along the field vanishes.
  ----------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � The Vieillefosse point over �: (Q , R) = (−3 , 2) lies on D = 0.
------------------------------------------------------------------------
