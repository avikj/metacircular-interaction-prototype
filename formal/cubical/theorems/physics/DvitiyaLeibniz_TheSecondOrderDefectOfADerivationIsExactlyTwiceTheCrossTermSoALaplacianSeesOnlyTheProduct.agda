...
------------------------------------------------------------------------
-- �������-������������ � the second-order Leibniz defect.
--
...
-- proved here: for a family of derivations �� and K = − �� ��², negating
-- §2 and summing over j leaves
--
--     K (br a b) ⊖ br (K a) b ⊖ br a (K b)  =  − 2 �� br (�� a) (�� b) ,
--
-- with no first-order term anywhere.  The sum and the sign are the
-- reading; §2 is the theorem, at one derivation.
--
-- SYT � THE CLAIM, EXACTLY.  §§1�2 in an arbitrary ring, carrier taken
...
module _ (R : Ring ℓ) where
  ...
  module _ (br : A → A → A) (d : A → A)
    ...
    ------------------------------------------------------------------
    -- � � THE SECOND-ORDER LAW.  The cross term appears twice.
    ------------------------------------------------------------------
