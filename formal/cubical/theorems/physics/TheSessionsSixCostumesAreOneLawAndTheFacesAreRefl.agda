...
module TheSessionsSixCostumesAreOneLawAndTheFacesAreRefl where

open import Cubical.Foundations.Prelude
open import Cubical.Data.Empty using (⊥)
open import Cubical.Data.Sigma using (Σ-syntax ; _,_)

open import AMapThatFactorsIsBlindOnTheFibresSoASeparatedBlindPairCertifiesANewSense
  using (प्रवहति ; तन्तौ-अन्धः ; अपूर्वम्)
open import TheModulusStandpointCannotSeeMobiusSoNoBoundThroughItSeparatesACancellingFamily
  as PA using (परिमाणम् ; योगः ; संहरत् ; न-संहरत् ; अन्धत्वम् ; भेदः)
open import ThePhaseAndTheCoefficientFactorThroughTransverseQuotientsOfOneVariable
  as TT using (शेषः ; म्यू ; कलायाम्-अन्धम् ; म्यू-भिनत्ति ; गुणके-अन्धम् ; शेषः-भिनत्ति)
open import TheOneLawIsDescentTheFreeDirectionIsBindBAndTheCostlyOneNeedsASection
