...
--
-- SYT � THE CLAIM, EXACTLY.  Linear algebra over � on ten coefficients,
...
-- monomials that can occur are carried.  Coefficient of q�r� is
...
------------------------------------------------------------------------
-- §3  The pushforward fibre over y� is unbounded: � injects into it.
------------------------------------------------------------------------

-- The value identity is proved in an abstract ring, where the solver reads
-- the literals 1r, 0r; over � it is then instantiated.
module Lin {ℓ : Level} (R' : CommRing ℓ) where
  ...
  -- the Q� right-hand side at (A�' , k�H'): −3�tr A�'³ − 3�tr(A�'�kH') = −6k
