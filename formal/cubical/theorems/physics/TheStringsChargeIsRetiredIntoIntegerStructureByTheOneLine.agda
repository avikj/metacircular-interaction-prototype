...
module TheStringsChargeIsRetiredIntoIntegerStructureByTheOneLine where
...
open import JTheGraphAndTheFundamentalTheoremAreInstancesOfSingletonContractionSoAuthorsRetireIntoInstantiation
  using (निवृत्तिः)
