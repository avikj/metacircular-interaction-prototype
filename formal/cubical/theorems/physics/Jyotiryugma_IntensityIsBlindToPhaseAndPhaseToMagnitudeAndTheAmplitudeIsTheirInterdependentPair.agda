...
-- ��������������� � the light-pair.
--
-- WHAT THIS IS.  The interferometric instance of the Parasparraya
...
-- (dvitya-payati), neither can be discarded (na-ekkin), and � by
-- UpakaranaVrddhi's na-pral � NEITHER IS A FUNCTION OF THE OTHER:
...
------------------------------------------------------------------------
-- � � Joint faithfulness: the reconstruction, by case analysis.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � The interdependent pair, inhabited.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � The laws, landed.  Free from the record: intensity and phase
-- each separate the other's blind pair, neither is discardable, and
-- (via UpakaranaVrddhi.na-pral, applicable to this very term)
