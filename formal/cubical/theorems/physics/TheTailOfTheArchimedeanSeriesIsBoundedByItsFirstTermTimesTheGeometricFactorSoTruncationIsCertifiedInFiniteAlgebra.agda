...
module TheTailOfTheArchimedeanSeriesIsBoundedByItsFirstTermTimesTheGeometricFactorSoTruncationIsCertifiedInFiniteAlgebra where
...
open import TheModeOfRatioAboveOneOverstepsEveryBoundAndTheModeOfRatioAtMostOneStaysWithinOneSoAModeIsBoundedExactlyWhenItsRatioIsAtMostOne
  using (antar)
open import TheDominantModeWinsSoASignedSumOfModesWithADominantRatioAboveOneOverstepsEveryBoundAndTheGrowthRateIsTheDominantRatio
  using (Σ-mono)
