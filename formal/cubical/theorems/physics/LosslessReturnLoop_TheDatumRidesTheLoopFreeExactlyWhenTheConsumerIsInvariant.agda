...
--  invariant.)
--
-- WHAT THIS IS.  `HolonomyIsInvisibleExactlyToAnInvariant-
...
import HolonomyIsInvisibleExactlyToAnInvariantSemantics as H
...
------------------------------------------------------------------------
-- ‡ß ¬ ‡µ‡æ‡‡ï‡ ‚î the law, five lines, as in loss/.
------------------------------------------------------------------------
...
-- the shape `loss/`'s Œ¶-carrier already has.
------------------------------------------------------------------------
