...
--       eliminated into ⊥.
--
-- अतिक्रम (atikrama, overstepping/transgression) is ordinary .
------------------------------------------------------------------------

module TheModeOfRatioAboveOneOverstepsEveryBoundAndTheModeOfRatioAtMostOneStaysWithinOneSoAModeIsBoundedExactlyWhenItsRatioIsAtMostOne where
