...
module TheWeightedCountingMapsFibreDecomposesByHeadWeightAndTheNilCaseIsASeparateSummand where
...
------------------------------------------------------------------------
-- २ · आवृत्तिः — the fibre decomposes: the nil case, or a head with its
