...
module TheReverseShiftDoesNotCrossSeparatedBoundariesAndOnlyAShellOfShiftsReachesTheReceiverSoTheFullPrimeBlockIsTheWeightedConvolutionSum where
...
open import OnAFiniteWindowTheTwoNetZeroShiftWordsAgreeInTheBulkAndDifferOnTheBoundaryStripsSoDisplacementDescendsAndBoundaryHistoryDoesNot
  using (S ; S*)
open import TheCrossBoundaryCoefficientOfATruncatedShiftIsTheConvolutionOfTheBoundaryProfilesAtTheShiftedTime
  using (Σ⟨_,_⟩ ; ⟨_∣_⟩ ; h ; Σ-vanish ; Σ-ext)
open import TheCrossBoundaryBlockOfTheWeightedShiftOperatorIsTheWeightedSumOfBoundaryConvolutionsAtTheShiftedTimes
