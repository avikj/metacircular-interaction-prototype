...
--  word, used here for the braid on three points.  यङ्ग्-बक्सर ··
-- "Yang–Baxter" is transliterated, not translated: the braid relation
-- στσ = τστ is named for C. N. Yang and R. J. Baxter (20th c.).
...
module TheThreeStrandBraidIsNonAbelianAndSatisfiesTheBraidRelation where
