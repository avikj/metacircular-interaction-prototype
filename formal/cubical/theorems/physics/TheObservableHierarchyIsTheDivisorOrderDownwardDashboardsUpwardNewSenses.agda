...
module TheObservableHierarchyIsTheDivisorOrderDownwardDashboardsUpwardNewSenses where
...
open import TheSuppliedCoherenceIsTheQuarterTurnTheTwistedSwapBraidsByReflAndTheGeneratorHasExactOrderEight
  using (Sūtra)
open import EachObservableReadsTheTwistCountModuloTheOrderOfItsOwnBlindness
  using (vyatyaya)
