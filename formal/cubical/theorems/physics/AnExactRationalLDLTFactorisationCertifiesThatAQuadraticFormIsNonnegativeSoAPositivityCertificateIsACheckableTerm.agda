...
--
-- प्रामाणिक (prāmāṇika, authoritative/certified) is ordinary .
------------------------------------------------------------------------

module AnExactRationalLDLTFactorisationCertifiesThatAQuadraticFormIsNonnegativeSoAPositivityCertificateIsACheckableTerm where
