...
module TheInstructionSetIsTheZeroChargePoleAndTheDiscreteLogSitsOffItByItsOrder where
...
open import TheDiscreteLogIsTheFibreOfPingalasPowerAndShorsPeriodQueryIsWhatReadsIt
  using (powg ; εC)
