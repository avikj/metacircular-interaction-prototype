...
-- factor multiset.
--
-- This module proves it.  The permutation machinery is the corpus's �
...
module TheValuationIsInvariantUnderPermutationSoFactorListsDifferingByASquareInAnyArrangementHaveTheSameSign where
...
open import ThePermutationRelationIsTransitiveBecauseTwoInsertionsCommuteSoTheFourConstructorRelationIsContainedInPermAndBothAreEquivalenceRelations
