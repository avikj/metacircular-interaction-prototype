...
--
-- The SMOOTH content of gauge theory is genuinely absent � no
...
--   `Visvarupa_�`         a family is a map into the universe, and � is
--                         its total space
--
...
module _ (Grp : Group ℓ) where
  ...
  -- ���� � the translating element is exactly one.  `EkaSankramana`'s
