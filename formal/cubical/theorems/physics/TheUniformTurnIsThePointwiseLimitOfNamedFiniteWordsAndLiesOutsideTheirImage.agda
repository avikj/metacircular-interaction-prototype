...
module TheUniformTurnIsThePointwiseLimitOfNamedFiniteWordsAndLiesOutsideTheirImage where
...
open import TheCentralizerExceedsTheGroupTheUniformQuarterTurnIsCentralOfOrderFourYetNoFiniteWordRealizesIt
  using (catur∞)
