...
-- the half-wave, pointwise negation (dvi-caturaa, by refl).  The
...
-- states (na-avataraa-prathama, na-avataraa-dvitya).  So a single
...
------------------------------------------------------------------------
-- � � The quarter turn and the half turn.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � The half-wave descends to each sense, definitionally.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � The quarter-wave descends to neither sense.  For EVERY candidate
...
------------------------------------------------------------------------
-- � � The ceiling, stated once: what a single sense carries of the
-- quarter turn is exactly its square.  The involution descends
-- (ardha-avataraa), the quarter turn does not (na-avataraa), and the
