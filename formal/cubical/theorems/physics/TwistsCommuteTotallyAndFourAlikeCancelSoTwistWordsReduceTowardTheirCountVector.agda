...
module TwistsCommuteTotallyAndFourAlikeCancelSoTwistWordsReduceTowardTheirCountVector where
...
open import EveryCrossingFactorsAsPureSwapAfterPureTwistAndTheSwapTransportsTheResidue
  using (ghūrṇa∞)
open import TheSquareOfEveryCrossingIsPureResidueSoThePureBraidsActVerticallyAndTheTwistsCommute
  using (catur-ghūrṇa)
