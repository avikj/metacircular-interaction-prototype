...
--       [0,1] stays in [0,1].
--
-- वृद्धि (vṛddhi, growth) is ordinary  and Pāṇini's own term.
------------------------------------------------------------------------

module AModeOfRatioAboveOneGrowsPastEveryBoundAndAModeOfRatioAtMostOneStaysBoundedSoTheFiniteGrowthTheoremReadsTheDominantRatio where
