...
-- fibre is contractible, so the section space is contractible ‚î ¬ß‡®
...
module _ {A B : Type ‚Ñì} (f : A ‚Üí B) where
  ...
  ------------------------------------------------------------------
  -- ¬ß‡ß ¬ THE LAW.  Conserving flows ‚â sections of one's own fibres.
  --
  ...
  ------------------------------------------------------------------
  -- ¬ß‡® ¬ THE NEAR POLE, STRENGTHENED.  Zero loss: contractible fibres,
...
-- induces a map of conserving flow spaces ‚î so larger fibres admit more
-- flows, functorially, with no order on observables needed: the order
-- IS the fibre-wise maps.  Three lines, because after ¬ß‡ß it is only
-- Œ†-postcomposition.
------------------------------------------------------------------------
