...
-- impossibilities.  तल is built here; the load-bearing
-- pigeonhole is Saptabhangi's दुर्नयः, used not reproved.
------------------------------------------------------------------------

module TheFloorIsTheThirdAssetEveryRouteFromSevenToTwoPaysAtLeastOneCollision where
...
open import TheSevenfoldCannotBeTwoValuedSoTheTopJoinCandidateIsAWall
