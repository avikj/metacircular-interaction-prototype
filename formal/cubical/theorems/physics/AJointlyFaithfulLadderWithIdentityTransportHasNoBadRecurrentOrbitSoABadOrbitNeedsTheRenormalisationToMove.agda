...
module AJointlyFaithfulLadderWithIdentityTransportHasNoBadRecurrentOrbitSoABadOrbitNeedsTheRenormalisationToMove where
...
open import TwoFieldsWithTheSameEntireCoarseMovieHaveDifferentSubgridEnergyAndDifferentCostSoNeitherDescendsThroughCoarseObservation
  using (Field ; chāyā)
