...
------------------------------------------------------------------------
-- ��������-����� � the conservation-net.  The crystal's L1 typed-edge lattice
...
--     conjugation a+b�2 � a−b�2 is a field iso of �(�2) that exchanges its
--     two orderings, so an iso does not carry order data.  (Witnessed at �
...
-- witnesses; that an Iso genuinely loses sign (not vacuously) is the �
-- witness in RnaDhanaOrder and the �(�2) certificate in
