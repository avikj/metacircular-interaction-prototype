...
--
--   Micro = �[ y ∈ Fin (suc c) ] Fin (suc (k y))
--   Flat  = Fin (totalSum (λ y � suc (k y)))
--
-- `SumFin��` gives `Micro � Flat`.  By univalence this is a universe path,
...
-- trips close by `�≡Prop`; no path witness is silently identified without the
-- set receipt.
--
-- WHAT THIS REACHES.
...
--
-- TERM. �������� is carried from the checked branch-family module; ���� is the
