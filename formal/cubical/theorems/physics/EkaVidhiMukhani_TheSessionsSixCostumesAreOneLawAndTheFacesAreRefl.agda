...
------------------------------------------------------------------------
-- �������-������� � one law, six faces, and the faces are refl.
--
...
--
-- WHAT EACH FACE SAYS.  `�����-����� S q` is: a reading derived from S is
-- constant on S's fibres.  `��������` is its contrapositive with a witness.
-- Then:
--
...
------------------------------------------------------------------------
-- ������ � � ������� � descent is the blindness, verbatim
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- �������� � the sentence.  Every face above is the same term as the
