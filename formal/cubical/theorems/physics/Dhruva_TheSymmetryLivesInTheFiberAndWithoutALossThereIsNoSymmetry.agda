...
--
--     **f ∘ Φ ≡ f  ⟺  Φ maps every fiber into itself.**
--
...
------------------------------------------------------------------------
-- १ · The symmetry acts inside the fibers.  Both directions.
--
-- Conservation gives an endomorphism of every fiber, and it is `Φ`
...
------------------------------------------------------------------------
  ...
  -- The converse needs no term: `Φ a` lying in the fiber over `f a` IS
...
--
-- If `f` is an equivalence — every fiber contractible, nothing hidden,
-- zero receipt — then conservation forces the flow to be the identity.
--
-- The proof is the contractibility of the fiber used once: `(Φ a, cons a)`
...
-- one physical state) exhibited at the smallest fiber.
------------------------------------------------------------------------
...
-- that `f` is Φ-invariant, so `f` descends to the orbits.
------------------------------------------------------------------------
