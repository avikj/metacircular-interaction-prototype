...
--   TransportResidue_EveryTransportOwesItsResidual.‡‡≤‡ã‡‡
...
‡§∂‡•á‡§∑-‡§§‡§æ‡§¶‡§æ‡§§‡•ç‡§Æ‡•ç‡§Ø‡§Æ‡•ç
  : {A B : Type ‚Ñì} (e : A ‚âÉ B) (a : A)
  ‚Üí TransportResidue_EveryTransportOwesItsResidual.‡§Ö‡§≤‡•ã‡§™‡§É e a ‚â° ‡§Ö‡§≤‡•ã‡§™‡§É e a
...
‡§∏‡§Æ‡§®‡§æ‡§Æ‡§®‡•ç-‡§§‡§æ‡§¶‡§æ‡§§‡•ç‡§Æ‡•ç‡§Ø‡§Æ‡•ç
  ...
  ‚â° TransportResidue_EveryTransportOwesItsResidual.‡§Ö‡§≤‡•ã‡§™‡§É e a
‡§∏‡§Æ‡§®‡§æ‡§Æ‡§®‡•ç-‡§§‡§æ‡§¶‡§æ‡§§‡•ç‡§Æ‡•ç‡§Ø‡§Æ‡•ç e a = refl

‡§§‡•É‡§§‡•Ä‡§Ø-‡§§‡§æ‡§¶‡§æ‡§§‡•ç‡§Æ‡•ç‡§Ø‡§Æ‡•ç
  : {A B : Type ‚Ñì} (e : A ‚âÉ B) (a : A)
  ‚Üí TransportResidue_EveryTransportOwesItsResidual.‡§Ö‡§≤‡•ã‡§™‡§É e a
...
‡§∏‡§Ç‡§ï‡•ç‡§∞‡§Æ‡§£-‡§§‡§æ‡§¶‡§æ‡§§‡•ç‡§Æ‡•ç‡§Ø‡§Æ‡•ç
  ...
  ‚â° TransportResidue_EveryTransportOwesItsResidual.‡§∏‡§Ç‡§ï‡•ç‡§∞‡§Æ‡§£‡§Æ‡•ç e
