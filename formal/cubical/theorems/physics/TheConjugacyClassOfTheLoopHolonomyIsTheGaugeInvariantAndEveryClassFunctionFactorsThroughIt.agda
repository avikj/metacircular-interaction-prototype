...
module TheConjugacyClassOfTheLoopHolonomyIsTheGaugeInvariantAndEveryClassFunctionFactorsThroughIt where
...
open import OnAGraphLoopGaugeNaturalityIsConjugationSoEveryClassFunctionOfTheLoopHolonomyIsGaugeInvariant
  using (loop-saṃyoga)
import TheNonabelianChainTelescopesToTheEndpointLawSoTheLoopIsCovariantByConjugationAndTheAbelianInvarianceWasAnArtifactOfCommutativity
  as Setu
