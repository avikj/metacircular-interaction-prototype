...
------------------------------------------------------------------------
module Trikona_TheTriangularFamilyHasConvectiveTermZeroZeroAdvectedVIsDivergenceFreeWithZeroPressureAndItsStrictlyLowerTriangularGradientKillsBothVelocityGradientInvariants where
...
module _ (R : CommRing ℓ) where
  ...
  module _ (∂₁ ∂₂ ∂₃ D : A → A)
    ...
    private
      c₁ : advect 0r ≡ 0r
      c₁ = cong₂ (λ w w' → (0r · ∂₁ 0r + a · w) + v · w') ∂₂0 ∂₃0 ∙ shape (∂₁ 0r)
        where shape : (p : A) → (0r · p + a · 0r) + v · 0r ≡ 0r
              shape p = solve! R
      c₂ : advect a ≡ 0r
      c₂ = cong₂ (λ w w' → (0r · ∂₁ a + a · w) + v · w') ∂₂a ∂₃a ∙ shape (∂₁ a)
        where shape : (p : A) → (0r · p + a · 0r) + v · 0r ≡ 0r
              shape p = solve! R
      c₃ : advect v ≡ a · ∂₂ v
      c₃ = cong (λ w → (0r · ∂₁ v + a · ∂₂ v) + v · w) ∂₃v ∙ shape (∂₁ v) (∂₂ v)
        where shape : (p q : A) → (0r · p + a · q) + v · 0r ≡ a · q
              shape p q = solve! R

    convective-collapses : convective ≡ (0r , 0r , a · ∂₂ v)
    ...
    convective-is-divergence-free : div convective ≡ 0r
    convective-is-divergence-free =
        cong div convective-collapses
      ∙ cong₂ _+_ (cong₂ _+_ ∂₁0 ∂₂0) (∂₃-leib a (∂₂ v) ∙ cong₂ _+_ (cong (_· ∂₂ v) ∂₃a) (cong (a ·_) (comm₂₃ v ∙ cong ∂₂ ∂₃v ∙ ∂₂0)))
      ∙ shape (∂₂ v)
      where shape : (q : A) → (0r + 0r) + (0r · q + a · 0r) ≡ 0r
            shape q = solve! R
    ...
    NS₃ = (D v + advect v) + (- (ν · Δ v))

    private
      Δ0 : Δ 0r ≡ 0r
      Δ0 = cong₂ _+_ (cong₂ _+_ (cong ∂₁ ∂₁0 ∙ ∂₁0) (cong ∂₂ ∂₂0 ∙ ∂₂0)) (cong ∂₃ ∂₃0 ∙ ∂₃0) ∙ shape
        where shape : (0r + 0r) + 0r ≡ 0r
              shape = solve! R

    first-component-is-trivial : NS₁ ≡ 0r
    first-component-is-trivial = cong₂ (λ w w' → (w + advect 0r) + (- (ν · w'))) D0 Δ0 ∙ cong (λ w → (0r + w) + (- (ν · 0r))) c₁ ∙ shape
      where shape : (0r + 0r) + (- (ν · 0r)) ≡ 0r
            shape = solve! R

    second-component-is-heat : NS₂ ≡ D a + (- (ν · Δ a))
    second-component-is-heat = cong (λ w → (D a + w) + (- (ν · Δ a))) c₂ ∙ cong (_+ (- (ν · Δ a))) (+IdR (D a))

    third-component-is-advected-heat : NS₃ ≡ (D v + a · ∂₂ v) + (- (ν · Δ v))
  ...
  module _ (p q r : A) where
    ...
    M² : A × A × A × A × A × A × A × A × A
    M² = (0r · 0r + 0r · p + 0r · q) , (0r · 0r + 0r · 0r + 0r · r) , (0r · 0r + 0r · 0r + 0r · 0r)
       , (p · 0r + 0r · p + 0r · q) , (p · 0r + 0r · 0r + 0r · r) , (p · 0r + 0r · 0r + 0r · 0r)
       , (q · 0r + r · p + 0r · q) , (q · 0r + r · 0r + 0r · r) , (q · 0r + r · 0r + 0r · 0r)
    ...
    square-is-one-corner = λ t → (e₁ t , e₂ t , e₃ t , e₄ t , e₅ t , e₆ t , e₇ t , e₈ t , e₉ t)
      where
        e₁ : 0r · 0r + 0r · p + 0r · q ≡ 0r
        e₁ = solve! R
        e₂ : 0r · 0r + 0r · 0r + 0r · r ≡ 0r
        e₂ = solve! R
        e₃ : 0r · 0r + 0r · 0r + 0r · 0r ≡ 0r
        e₃ = solve! R
        e₄ : p · 0r + 0r · p + 0r · q ≡ 0r
        e₄ = solve! R
        e₅ : p · 0r + 0r · 0r + 0r · r ≡ 0r
        e₅ = solve! R
        e₆ : p · 0r + 0r · 0r + 0r · 0r ≡ 0r
        e₆ = solve! R
        e₇ : q · 0r + r · p + 0r · q ≡ r · p
        e₇ = solve! R
        e₈ : q · 0r + r · 0r + 0r · r ≡ 0r
    ...
    cube-vanishes : (0r · 0r + 0r · 0r + 0r · (r · p)) + (p · 0r + 0r · 0r + 0r · (r · p)) + (q · 0r + r · 0r + 0r · (r · p)) ≡ 0r
    cube-vanishes = solve! R
