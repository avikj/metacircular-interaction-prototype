...
--
-- वलय (aneka, many) is ordinary .
------------------------------------------------------------------------

module ASumOfModesWithNonnegativeWeightsIsBoundedExactlyWhenEveryPositivelyWeightedModeHasRatioAtMostOneSoThePrimeSideOfBIsReadModeByMode where
...
open import EveryRationalLiesBelowANaturalAndEveryPositiveRationalHasANaturalMultipleAtLeastOneSoTheRationalsAreArchimedean
  using (guṇaka)
open import TheModeOfRatioAboveOneOverstepsEveryBoundAndTheModeOfRatioAtMostOneStaysWithinOneSoAModeIsBoundedExactlyWhenItsRatioIsAtMostOne
