...
--
--   ShabdeJivahVartante.संक्रमणम्-अलोपः
--   EveryTransportOwesItsResidual.अलोपः
--   TheRetractionTypeIsTheHLevelHypothesis.संक्रमणे-न-किञ्चिन्-नश्यति
--
...
नष्टि-तादात्म्यम्
  ...
  → ShabdeJivahVartante.संक्रमणम्-अलोपः e a ≡ अलोपः e a
नष्टि-तादात्म्यम् e a = refl

शेष-तादात्म्यम्
  : {A B : Type ℓ} (e : A ≃ B) (a : A)
  → EveryTransportOwesItsResidual.अलोपः e a ≡ अलोपः e a
शेष-तादात्म्यम् e a = refl

अप्रतिकार्य-तादात्म्यम्
  : {A B : Type ℓ} (e : A ≃ B) (a : A)
  → TheRetractionTypeIsTheHLevelHypothesis.संक्रमणे-न-किञ्चिन्-नश्यति e a
  ≡ अलोपः e a
...
समनामन्-तादात्म्यम्
  : {A B : Type ℓ} (e : A ≃ B) (a : A)
  → ShabdeJivahVartante.संक्रमणम्-अलोपः e a
  ≡ EveryTransportOwesItsResidual.अलोपः e a
...
संक्रमण-तादात्म्यम्
  : {A B : Type ℓ} (e : A ≃ B)
  → ShabdeJivahVartante.संक्रमणम् e
  ≡ EveryTransportOwesItsResidual.संक्रमणम् e
...
--
--   · ShabdeJivahVartante states it to set up the CONTRAST that is its
...
--   · TheRetractionTypeIsTheHLevelHypothesis states it as
