...
--
-- ���-������ � jva, the living one (Umsvti, ���������������, opening
-- adhyyas, ~2nd�5th c. CE: the knower persisting through karmic change);
-- tantu, thread (ordinary ; the weaver's word for continuity,
-- attested of the sacrificial line in the gveda � second-hand, verse
...
-- taken is the exact position being checked: the jva persists AND changes �
-- against both the eternalist and the annihilationist reading � and this
-- module is that position as theorems about one term.
--
-- U0022's line:
--     "The living thread � the jva � is a section through the changing
--      family: j_n ∈ M_n with �_n(j_n) � j_{n+1} ...  Continuity does
...
private
  ...
  -- no integer is its own successor: suc� (pos n) = pos (suc n) and
  -- suc� (negsuc (suc m)) = negsuc m reduce both cases to �; the
