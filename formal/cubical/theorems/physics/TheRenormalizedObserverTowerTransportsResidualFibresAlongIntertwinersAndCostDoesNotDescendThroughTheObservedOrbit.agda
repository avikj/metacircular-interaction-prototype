...
module TheRenormalizedObserverTowerTransportsResidualFibresAlongIntertwinersAndCostDoesNotDescendThroughTheObservedOrbit where
...
open import AliasesComposeAlongIntertwinersSoTheLadderIsACategoryAndDashboardsAreItsMorphisms
