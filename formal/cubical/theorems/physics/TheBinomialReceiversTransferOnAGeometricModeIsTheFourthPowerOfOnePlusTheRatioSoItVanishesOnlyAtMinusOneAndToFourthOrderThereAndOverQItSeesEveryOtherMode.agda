...
--
-- ग्राही (grāhī, receiver) and सर्व (sarva, all) are ordinary .
------------------------------------------------------------------------

module TheBinomialReceiversTransferOnAGeometricModeIsTheFourthPowerOfOnePlusTheRatioSoItVanishesOnlyAtMinusOneAndToFourthOrderThereAndOverQItSeesEveryOtherMode where
