...
module TheLadderOfATruncatedSpaceEndsExactlyAtItsOwnLevelAndTheUntwistedRingJoinsTheBell where
...
open import TheTwistedRingUttersOnceAndAboveTheOrderEveryStratumIsSilent
  using (अवरोहः)
