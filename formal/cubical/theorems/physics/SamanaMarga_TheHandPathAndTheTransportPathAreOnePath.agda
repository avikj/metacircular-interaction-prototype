...
------------------------------------------------------------------------
-- ����������� � the hand road and the transport road are ONE path.
--
...
-- `ua (Carrier� �����) ∙ sym (ua �������������)`, which `uaInvEquiv` and
...
-- the composite sends (s,l) to a record whose ������ field is `sym refl`,
-- the hand map to the same record with ������ = `refl`, and `sym refl` is
...
------------------------------------------------------------------------
-- � � The two equivalences underneath the two roads are the same map.
--
-- The composite  Carrier� �����  then  invEquiv �������������  equals, as an
-- equivalence, the hand-built  isoToEquiv iso╗�-������-������.  Their
-- forward functions are judgmentally equal (the only difference is
-- `sym refl` versus `refl` in the ������ component), so funext is refl.
------------------------------------------------------------------------
