...
-- with ‡‡‡∞‡ï‡‡‡‡Æ‡ (f ‚àò Œ¶ ‚â° f pointwise) give a flow INSIDE every fiber
-- (‡ß‡‡∞‡‡µ-‡‡®‡‡‡), and the conserved quantity is the fiber index.  That
...
--
-- THE CONSERVED QUANTITY IS THE FIBER INDEX ‚î the sum n.  The shears
...
--
-- ¬ß‡©‚ì¬ß‡ together say: **fiber ‡Ø‡ã‡ó n is a ‚-torsor.**  The fiber has no
...
-- ¬ß‡® ¬ the induced action inside the fiber, through Dhruva -----------
...
-- ¬ß‡© ¬ the action laws: ‚ acts on the fiber --------------------------
...
-- ¬ß‡ ¬ freeness: a shear fixing any fiber point is the zero shear ----
...
-- ¬ß‡ ¬ transitivity: any two fiber points differ by a shear ----------
