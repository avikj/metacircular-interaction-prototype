...
module TheInfiniteBraidActsOnTheInterdependentStreamAndEveryRelationOfEveryBraidGroupHoldsAtOnce where
...
-- ϵ : cross strands i and i+1, turning the strand that passes over.
veṇī∞ : ℕ → Rajju → Rajju
