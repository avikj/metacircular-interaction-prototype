...
------------------------------------------------------------------------
-- पूलः — pūla, "a bundle, a sheaf (of grass)".  The ordinary 
...
module ThePrincipalBundleIsAFamilyOfTorsorsSoItsHolonomyIsTheGroupAndTheFibrePointConjugatesIt where
...
open import AFreeTransitiveActionsTranslationIsUniqueSoTheTorsorIsAnEquivalence
