...
-- SATISFYING Yang�Baxter need not be unitary either � §� exhibits one
...
--
-- WHAT THE SPACE IS, exactly.  The free �-module on the eight basis
...
------------------------------------------------------------------------
-- � � the space.  Vectors are �-valued functions on the basis states.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � the basis is orthonormal � which is what makes �_,_� an inner
...
------------------------------------------------------------------------
-- � � operators, and what it is to be unitary.
--
...
------------------------------------------------------------------------
-- � � THE COUNTERMODEL OPERATORS ARE UNITARY.
--
