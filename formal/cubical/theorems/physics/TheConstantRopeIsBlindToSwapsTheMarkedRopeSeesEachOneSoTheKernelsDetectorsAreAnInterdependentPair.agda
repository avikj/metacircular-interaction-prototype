...
-- the series — two senses, a named blind pair each, jointly
...
module TheConstantRopeIsBlindToSwapsTheMarkedRopeSeesEachOneSoTheKernelsDetectorsAreAnInterdependentPair where
