...
-- `Avrtti_‚¶agda` ¬ß‡ names this as its next rung:
...
-- rides free ‚î `fiber/src/Fiber/Carrier.agda`, and `Lekha_‚¶agda` for the
-- same fact at length.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- ‡® ¬ ‡‡µ‡‡‡‡‡ø‡ ‚î the fiber decomposes: the nil case, or a head with its
