...
module WallsTransportAlongFordsSoEveryFordRetiresCandidatesForFree where
...
open import TheAmbiguousNameHidTheFordAndTheRemainderLawIsAlsoTheNaturals
  using (विवेक-प्रमाण≃ℕ)
open import TheNaturalsAndTheBooleansAreAProvedWallSoThatSeamIsRetiredForever
  using (भित्तिः)
