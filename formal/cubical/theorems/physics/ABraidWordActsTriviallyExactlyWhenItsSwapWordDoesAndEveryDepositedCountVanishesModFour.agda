...
module ABraidWordActsTriviallyExactlyWhenItsSwapWordDoesAndEveryDepositedCountVanishesModFour where
...
open import TheInfiniteBraidActsOnTheInterdependentStreamAndEveryRelationOfEveryBraidGroupHoldsAtOnce
  using (Rajju)
open import EveryCrossingFactorsAsPureSwapAfterPureTwistAndTheSwapTransportsTheResidue
  using (svap∞)
open import TwistsCommuteTotallyAndFourAlikeCancelSoTwistWordsReduceTowardTheirCountVector
  using (gaṇa)
open import EveryBraidWordIsItsBarePermutationFollowedByAComputedTwistWord
  using (vēṇī-gaṇa ; svap-gaṇa ; T ; nirūpa)
open import EachStrandReadsExactlyItsOwnTwistCountSoTheTwistWordActsByItsCountVector
  using (gaṇanā)
open import ATwistWordActsTriviallyExactlyWhenEveryCountVanishesModFour
  using (catuḥśeṣa ; nirvāha ; vipakṣa)
open import EveryCrossingIsLocalAndHasOrderExactlyEightAtEveryPositionOfTheEndlessBraid
  using (sthira)
open import TheConstantRopeIsBlindToSwapsTheMarkedRopeSeesEachOneSoTheKernelsDetectorsAreAnInterdependentPair
  using (svap-andha)
