...
-- ν = 0, and on Q = −½ tr A², R = −� tr A³ it CLOSES: Q� = −3R, � = �Q².
...
--       the exact right-hand sides of Q� and �: the restricted-Euler
--       part is a function of (tr A², tr A³), i.e. of (Q, R), and the
--       whole correction is tr(AM), tr(A²M).
--   §2  over �: A� = diag(1,−1,0) and A� = diag(0,1,−1) have the same
...
--
-- SYT � THE CLAIM, EXACTLY.  Ring identities in the entries of two 3�3
-- matrices, and two-point witnesses over �.  No derivative, no flow, no
...
------------------------------------------------------------------------
-- §2  Over �: the coupling does not descend through (Q, R, H).
------------------------------------------------------------------------
...
-- and therefore the full right-hand side of Q� does not either: the
