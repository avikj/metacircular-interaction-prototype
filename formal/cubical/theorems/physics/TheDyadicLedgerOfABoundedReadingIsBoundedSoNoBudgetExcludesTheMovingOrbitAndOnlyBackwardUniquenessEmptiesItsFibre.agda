...
module TheDyadicLedgerOfABoundedReadingIsBoundedSoNoBudgetExcludesTheMovingOrbitAndOnlyBackwardUniquenessEmptiesItsFibre where
...
open import TheBlowUpWitnessIsADependentRecordEachInheritedReadingShrinksItsFibreAndTwoIncompatibleReadingsEmptyIt
