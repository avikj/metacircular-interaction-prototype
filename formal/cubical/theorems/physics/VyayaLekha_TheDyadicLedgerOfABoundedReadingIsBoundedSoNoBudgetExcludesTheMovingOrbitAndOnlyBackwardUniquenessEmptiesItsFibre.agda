...
--       bounded by M at every rung has W_n + M � M � 2�: the total is
...
--       classical Escauriaza�Sereginⓠver�k mechanism, taken as a
...
--
-- ���� (vyaya, expense) and ���� (lekha, record) are the corpus's own
...
------------------------------------------------------------------------
-- � � The dyadic ledger: a bounded reading has a bounded budget.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � The witness record, and the one remaining field.
------------------------------------------------------------------------
