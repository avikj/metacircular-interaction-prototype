...
module EveryBraidWordIsItsBarePermutationFollowedByAComputedTwistWord where
...
open import TwistsCommuteTotallyAndFourAlikeCancelSoTwistWordsReduceTowardTheirCountVector
  using (gaṇa)
open import TheSwapConjugatesTheTwistByTheTranspositionSoTheTwoCoordinatesFormASemidirectWeave
  using (τ)
open import TheCrossingItselfConjugatesTheTwistByTheSameTranspositionSoTwistsPushThroughWholeWords
