...
--
--   §1  Dhr, truncation, the take-metric, and PurnataSutra's three
...
module TheValueStreamOfATraceUnderAnEvaluatorCompletesByCorecursionItsLimitDescendsToTruncationsAndBoundednessDoesNot where
...
open import TheMutualDependenceObjectionChecksWhenTheLeaningIsProductive using (Dhārā)
open Dhārā
...
module Take {A : Type₀} where
  ...
  -- THE LIMIT, by corecursion (PurnataSutra.sm)
  ...
  -- UNIQUENESS BY TRUNCATIONS (PurnataSutra.kartana-smya): meaning descends
...
module JetStream where
  ...
  open import TheTaylorJetsOfThePairAtTimeZeroAreExactOnAWideningWindowAndTheTruncationResidualSitsOnTheBoundaryRow
  open import TheTriangularPairIsDerivedFromItsVelocityFieldTheNonlinearTermIsDivergenceFreeSoThePressureIsConstantAndTheCoarseStressAndContinuationAreComputed using (Field)
