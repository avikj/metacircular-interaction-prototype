...
--
--   §2  A HOMOMORPHISM ONTO �/4: the residue of the writhe respects
--       composition (mod-four addition proved by the four-step
--       induction), and all four sectors are inhabited by the powers
--       of a single crossing � with the sector of �� being n mod 4,
--       computed.
--
