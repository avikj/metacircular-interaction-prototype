...
------------------------------------------------------------------------
-- APPENDED 2026-08-19, by the same identity, at the end, altering no
-- line above.  The admission this line has carried since it began ‚î
...
-- MINIMISED ‚î is DISCHARGED for `maximalExists` in
...
--
-- STILL NOT TRANSFERRED: the stratification itself ‚î `strata`,
