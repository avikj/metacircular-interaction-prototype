...
module TheSameCarrierTwoLawsOfSuccessionTheOrderDistinguishesWhatTheTypeCannot where
...
open import EveryStratumUttersANewChargeAndTheChargeIsWhateverTheSpaceHolds
  using (सामान्यम्)
