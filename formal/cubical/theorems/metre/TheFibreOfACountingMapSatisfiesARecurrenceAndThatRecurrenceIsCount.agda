...
module TheFibreOfACountingMapSatisfiesARecurrenceAndThatRecurrenceIsCount where
...
-- weighted emitter is `TheWeightedCountingMapsFibreDecomposesByHeadWeightAndTheNilCaseIsASeparateSummand.agda`.
--
