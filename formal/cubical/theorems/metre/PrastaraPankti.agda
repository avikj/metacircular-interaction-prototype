...
-- संख्या (PingalaPrastara.count, यत्र Vak n ≃ Fin(count n) साधितम्) , मेरु-
-- पङ्क्ति-योगः च (PanktiYoga.पूर्व n n = ∑ₖ C(n,k)) ।  उभौ 2ⁿ , अतः समौ :
-- count n ≡ पूर्व n n — छन्दो-गणना (संख्या) मेरु-पङ्क्ति-योगः एव ।
--
-- (Piṅgala's saṅkhyā — the count of n-syllable metres, 2ⁿ, established in
-- PingalaPrastara as Vak n ≃ Fin(count n) — equals the meru-prastāra row sum
...
संख्या-द्विघात : (n : ℕ) → count n ≡ द्वि-घात n
संख्या-द्विघात zero    = refl
संख्या-द्विघात (suc n) = cong₂ _+_ (संख्या-द्विघात n) (संख्या-द्विघात n)

------------------------------------------------------------------------
-- संख्या-पङ्क्तिः — संख्या-प्रत्ययः = मेरु-पङ्क्ति-योगः : count n = ∑ₖ C(n,k) ।
------------------------------------------------------------------------

संख्या-पङ्क्तिः : (n : ℕ) → count n ≡ पूर्व n n
