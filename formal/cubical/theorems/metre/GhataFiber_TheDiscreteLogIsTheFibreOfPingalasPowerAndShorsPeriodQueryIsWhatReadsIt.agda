...
--   and ‡ò‡æ‡ g 3 are BOTH Œµ, two distinct points of one fibre, so the
--   fibre over Œµ is not contractible ‚î proof, not assertion.
--
...
--                                                          determined: 0 and 3
--                                                          both land on Œµ
--   ¬ß3  ‡ï‡‡∞‡Æ‡-‡‡®‡‡‡‡  : the fibre over Œµ contains a full period ‚î 0, 3, 6
...
-- machine has no such query for ‡òÿßÿ's fibre ‚î that is the hardness
...
------------------------------------------------------------------------
-- ¬ß3  The secret road is not: the fibre over Œµ is not contractible,
...
-- the period is visible in the fibre: 0, 3, 6 all land on Œµ, spacing r=3
...
------------------------------------------------------------------------
-- ¬ß4  The reading, stated: the fibre-law's two bindings ARE the crypto
--     asymmetry.  ¬ß2 is Abhijnana's ‡‡‡ø‡‡‡û‡æ‡®‡-‡Æ‡‡ï‡‡‡Æ‡ at f = powg (the
--     public value is free); ¬ß3 is the input-binding fibre being
--     non-contractible (the secret is undetermined).  Shor's period query
--     reads the r=3 spacing of ¬ß3's fibre; classically there is no such
