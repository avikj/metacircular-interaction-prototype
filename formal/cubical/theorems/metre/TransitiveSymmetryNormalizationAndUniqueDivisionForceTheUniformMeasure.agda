...
-- The bridge is `TheHalfTheoremIsTheFinTwoInstanceOnTheNose`.
--
...
--                 contractible — isContr(WeightRule).
--
------------------------------------------------------------------------

module TransitiveSymmetryNormalizationAndUniqueDivisionForceTheUniformMeasure where
