...
--     � ���-������   � unanimity for a gives a the unit weight �;
--     � ����-������  � unanimity for a gives every OTHER result �
--                      (ahis of assertion: no weight on the unasserted);
--     � �����-������ � any disagreement gives every result �
--                      (take nothing not unanimously given)
--   is determined COMPLETELY on nonempty contentions: any two such rules
--   agree at every result (��������-������), by the same decidable
...
module _ {A : Type ℓ} (disc : Discrete A) where
  ...
  -- A quantitative interior rule assigns weights that need not be {�,�}.
  -- The conjecture: under normalisation + additivity (ahis) +
  -- permutation invariance (aneknta) on a carrier rich enough to be
  -- amplitudes, any two such rules agree � Born uniqueness. It is a
  -- Type, so writing it costs nothing and asserts nothing until
  -- inhabited.
