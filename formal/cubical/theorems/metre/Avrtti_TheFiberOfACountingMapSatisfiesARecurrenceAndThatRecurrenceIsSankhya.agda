...
-- WHAT IS PROVED.
--
-- §१  the general recurrence, for ANY element type: the fiber of `length`
...
--     recurrence is the fiber's recurrence.  छन्दःशास्त्रम् ८.२४–२८
...
-- recurrence IS the fiber's recurrence** — the procedure and its ground,
...
-- charges 1 for लघु and 2 for गुरु, so its fiber over `n` decomposes as
-- the fiber over `n ∸ 1` plus the fiber over `n ∸ 2`, and each summand
...
--
-- The general shape: for `f : List X � �` with
...
-- The rung is above §� because the codomain splits, not because
