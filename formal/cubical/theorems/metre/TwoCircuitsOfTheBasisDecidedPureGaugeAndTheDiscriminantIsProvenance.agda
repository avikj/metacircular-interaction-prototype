...
-- TwoCircuitsOfTheBasisDecidedPureGaugeAndTheDiscriminantIsProvenance
--
...
module TwoCircuitsOfTheBasisDecidedPureGaugeAndTheDiscriminantIsProvenance where
...
open import TheAbsentRoundTripDoesNotEntailTheAbsentEquivalence
  using (ℕ≡CanWord ; Z2≃H2 ; Z2≡H4)
open import InflationVersusSubgroup using (Z2)
open import TheProposedInverseIsSpuriousAndInflationCarriesTheGroup
  using (H2≡H4)
