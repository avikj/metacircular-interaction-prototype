...
-- The wire is a term, and the instantiation is definitional — गुणः 1 y and y +ᵂ y
...
module TheHalfTheoremIsTheFinTwoInstanceOnTheNose where
...
open import TheSymmetricTwoOutcomeBornWeightIsForcedToHalfExactlyOverAUniquelyHalvingCarrier
  using (द्विमात्रिन्)
