...
-- exhibiting the archetype; the note's level-‡© side (`fibre ‡‡®‡∞‡‡‡‡Æ‡
...
--
-- ~~This is what ‡µ‡ø‡ï‡≤‡æ‡¶‡‡ could not say.  ‡µ‡ø‡ï‡≤‡æ‡¶‡‡ says the fibre has two
...
--
-- ¬ß‡® of THIS file is untouched and still true: every fibre of `‚à_‚à‚` is
...
-- is the level-‡© side: that a level-‡© collapse's fibre is a PROPER part,
...
-- all; and the level-‡© half quoted here ‚î a proper fibre, with something
