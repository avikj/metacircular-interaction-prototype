...
module OneNoRetractionLemmaFourCheckedFacesTheGapTheRouteTheScheduleAndTheCountAreOneCoin where
...
open import TheQuotientByAnExplanationIsLosslessForEveryExactEvaluatorAndKillsTheDepthClass
  using (Explained ; identified)
open import TheMobiusCountIsSwapBlindWhileTheInteractionCarrierHoldsAFreeOrbitOutsideTheComparisonImage
  using (P ; p ; q ; p≢q)
