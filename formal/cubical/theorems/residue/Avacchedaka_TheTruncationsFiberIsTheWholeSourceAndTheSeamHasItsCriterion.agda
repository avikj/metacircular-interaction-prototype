...
--
-- NOT CLAIMED: that "fiber ‚â whole source" is THE criterion
...
--
-- ¬ß‡® of THIS file holds: every fiber of `‚à_‚à‚` is
...
-- all; and the level-‡© half of the scale ‚î a proper fiber, with something
