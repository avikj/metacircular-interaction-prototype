...
module FiveCollapsesOneTheoremAndEachTraditionSaysItInItsOwnWords where
...
open import TheLaterRulesFibreIsExactlyWhatTheEarlierRuleCannotSeeAndTheBlindnessIsForcedByCollapse
