...
------------------------------------------------------------------------
-- ������� � expansion.  THE PADDING LEMMA: A BEHAVIOR HAS UNBOUNDEDLY
...
--
--   `padding-lemma`      � hence an INJECTION prog : � � Code, all of
--     whose values run identically: the visible behavior map from
--     codes to runs has a fibre with unboundedly many points.
--
-- Read against Uniqueness: the lossless completion of a map is unique �
...
-- THE THEOREM.  For every bounded machine there is an injection of �
