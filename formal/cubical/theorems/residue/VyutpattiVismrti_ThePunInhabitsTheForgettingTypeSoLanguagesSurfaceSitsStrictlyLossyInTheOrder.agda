...
------------------------------------------------------------------------
-- �����������-�������� � the pun inhabits the forgetting type, so the
-- surface of language sits strictly lossy in the loss order.
--
-- Joins two modules landed hours apart tonight:
--
--   Vyapti_TheLossOrder�  defines ��������� Φ for a FLOW Φ : A � A �
--     �[ a ] �[ a' ] (Φ a ≡ Φ a') � � (a ≡ a') � and proves a
--     reversible flow forgets nothing (������-�-���������).
--
--   Vyutpatti_TheSurfaceForm�  proves language's surface map collides
--     (the lea: two derivations, one spelling) and admits no faithful
--     reader.
--
-- This module is the one-term bridge: the erasure type generalizes
-- verbatim from flows to arbitrary maps f : A � B (same �, codomain
...
-- plays as lea, the loss order books as �������� � one object,
...
-- the forgetting type, freed from the endomap: Vyapti §�'s � with the
...
-- an equivalence forgets nothing � Vyapti ���, transposed verbatim.
...
-- distinct � the lea as a point of the forgetting type.
