...
module TheLosslessMachinePaperInOneModuleEveryClaimOneTerm where
...
open import TheTraceComposesTheCompletedRunRunsBackwardsByReflAndWhenTheMachineHaltsIsAProposition
open import LosslessnessIsAPropertyTheCompletionsOfAMapFormAContractibleTypeAndTheMachinesIsUnique
open import AVerifiedProgramTheSuccessorMachineAddsOneStrokeAndItsCertificateIsAFibrePoint
open import ThePaddingLemmaABehaviorHasUnboundedlyManyProgramsSoTheCodeIsNotDeterminedByTheRun
open import TheVisibleStepDestroysInformationAndTheCompletedStepCannotByConstruction
open import ProgramsComposeTheSequencedTableRunsItsFirstPhaseThenHandsTheTapeToTheSecondAtTheRetireState
open import TheComposedSuccessorAddsTwoTheCertificatesConcatenateAndTheStepCountsAdd
open import TheMachineHasExactlyOneExecutionDeterminismIsContractibilityOfTheStream
open import TheBehaviorIsASetQuotientOfTheCodeItsFibreIsInfiniteAndTheLosslessTraceIsAPoint
open import TheDiagonalConfigurationMapThatNoProgramStepsSoUniversalityDemandsAChangeOfRepresentation
open import TheMachinesStepsAreAllUnitaryWhenCompletedAndStillDoNotExchange
open import TheMachineIsItsCompletedSelfAsAnIdentificationInTheUniverseAndTheIdentificationComputes
open import EachStepIsATransportOrASilenceWithItsWitnessAndTheLimitIsNoThirdRoad
open import TheFirstHaltingTimeComesBackFromTheTruncationBecauseMinimalityMakesItCanonical
open import TheRelationalProgramWithUniqueAnswersIsTheMapSoAllThreePresentationsCollapseOntoOneFunction
open import TheInteractiveMachineStrictlyContainsTheTuringMachineAndDeterminismIsExactlyTheCollapse
open import ReceiptedAnswersCollapseEveryQuestionAlphabetSoFreedomLivesOnlyInTheUnwitnessedEvent
