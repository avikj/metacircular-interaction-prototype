...
module TheTruncationsFibreIsTheWholeSourceAndTheSeamHasItsCriterion where
...
-- `TheLossLevelIsNotAPropertyOfTheMapAloneAndTheFibreCriterionFailsOnItsOwnArchetype`.
