...
module TheReturnAndTheCutDecomposeTheSamePairAndSetubandhaNamedTheGap where

open import Cubical.Foundations.Equiv using (_≃_ ; invEquiv ; compEquiv ; fiber)
open import Cubical.Data.Nat using (ℕ)
open import Cubical.Data.Sigma using (Σ-syntax ; _×_)

open import TheHandProofWasUnnecessaryAndTransportGivesIt
  using (Carrier ; योग ; Carrier≃)
open import TheCutsBoundaryIsTheBaseAndMemoryIsTheFibreFailingToBeContractible
  using (अवच्छेदः)
