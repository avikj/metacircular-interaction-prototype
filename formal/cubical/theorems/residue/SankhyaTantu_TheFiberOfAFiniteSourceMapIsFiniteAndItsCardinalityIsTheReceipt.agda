...
------------------------------------------------------------------------
-- ‡‡ô‡‡ñ‡‡Ø‡æ-‡‡®‡‡‡‡ ‚î the fiber of a finite-source map is finite, and its
...
--
-- For any map f : A ‚í B between FINITE SETS, every fiber is a finite set
...
-- itself the ‡‡‡ø‡‡‡û‡æ‡® (the untruncated identification `fiber ‚â Fin k`),
...
module _ (A B : FinSet ‚Ñì) (f : A .fst ‚Üí B .fst) where
  ...
  ------------------------------------------------------------------------
  -- ‡ß ¬ the fiber is a finite set ‚î the library's isFinSetFiber, named
  ...
  ------------------------------------------------------------------------
  -- ‡® ¬ ‡‡ô‡‡ñ‡‡Ø‡æ ‚î the cardinality of the fiber, the count receipt.
