...
module TheTwoRemainderRecordsAreOnePairAndThereforeEachOther where

open import Cubical.Foundations.Prelude using (_≡_ ; sym ; _∙_)

import TheRemainderIsLawfulAndTheNetBeats as R
import TheQualifierIsCarriedAsAFieldSoTheEquivalenceIsReal as U
