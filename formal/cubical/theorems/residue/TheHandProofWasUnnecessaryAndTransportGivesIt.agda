...
--
-- WHAT THIS IS.  `TheRemainderIsLawfulAndTheNetBeats.agda`
...
module TheHandProofWasUnnecessaryAndTransportGivesIt where
...
import TheRemainderIsLawfulAndTheNetBeats as V
