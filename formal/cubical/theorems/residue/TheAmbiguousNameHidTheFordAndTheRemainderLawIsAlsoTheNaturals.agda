...
module TheAmbiguousNameHidTheFordAndTheRemainderLawIsAlsoTheNaturals where
...
open import TheRemainderIsLawfulAndTheNetBeats
  using (विवेक-प्रमाण ; isoℕ×ℕ-विवेक-प्रमाण)
open import TheSeamFordJoinsTheValliToPingalaAndVivekaIsTheNaturalNumbers
  using (युग्म≃ℕ)
