...
--   y          the identity,
--   apart      na-catuka∞: the fourth power is NOT the identity
--              (the quarter turn has order exactly four on the pair),
--   proj       reading at depth k,
--   together   adha-sthira, four times: below the crossing the two
...
module TheRopeJoinsTheCoinAFaceAtEveryHorizonWhereTheQuarterPowerIsApartFromTheIdentityYetReadsIdentically where
...
open import OneNoRetractionLemmaFourCheckedFacesTheGapTheRouteTheScheduleAndTheCountAreOneCoin
