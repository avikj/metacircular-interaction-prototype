...
------------------------------------------------------------------------
-- TheMixedStrataArePairwiseDisjointAndOrdered
--
...
--
-- COVERAGE is in `TheMixedStratificationTerminatesAndCovers`.
--
-- NO NOVELTY.  Standard properties of iterated non-dominated sorting
-- (Goldberg 1989; Deb et al. 2002).
------------------------------------------------------------------------

module TheMixedStrataArePairwiseDisjointAndOrdered where
