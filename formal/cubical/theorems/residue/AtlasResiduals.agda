...
-- AtlasResiduals
--
-- Two statements of the atlas note, machine-checked:
--
...
--    A2 is separately universe-polymorphic in the target.
--
--  * The note's Theorem
...
-- A2.  A definitional instance of A2∞
...
-- B5.  THE STATEMENT: the univalence half of Theorem 3.2.
