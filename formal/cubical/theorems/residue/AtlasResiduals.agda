...
--    Its `isContrOrdTotal� : isContr (�[ X ∈ BS� ] LinOrd� ⟨X⟩)` is
...
--    is a field of `Alg`) ... Initiality of � among (1+X)-algebras on
...
--     to `�≡Prop`), so removing it costs nothing and §3's
