...
------------------------------------------------------------------------
-- ������� � the relation.  THE RELATIONAL PROGRAM WITH UNIQUE ANSWERS
...
-- that it stands in the relation: an element of � b. R a b.  The
-- deterministic case is the contractible-output case:
--
--     Fun R  =  � a. isContr (� b. R a b).
--
