...
-- forgets — here, nothing, which is Uniqueness's theorem.  The visible
...
module TheMachineIsItsCompletedSelfAsAnIdentificationInTheUniverseAndTheIdentificationComputes where
...
-- is the projection Uniqueness forces it to be.
