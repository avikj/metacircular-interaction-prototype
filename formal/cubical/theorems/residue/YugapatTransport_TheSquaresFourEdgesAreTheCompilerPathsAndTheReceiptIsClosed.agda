...
-- variables (A B C D : Type �), which 2.6.3 generalizes at separate
-- levels (A.� ≠ B.�), refusing every composite signature.  The port
-- replaces them with explicit {� : Level} binders per signature.  NO
