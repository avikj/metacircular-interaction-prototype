...
module ThePunInhabitsTheForgettingTypeSoLanguagesSurfaceSitsStrictlyLossyInTheOrder where
...
open import TheSurfaceFormIsALossyProjectionOfDerivationAndMeaningRidesTheDerivation
