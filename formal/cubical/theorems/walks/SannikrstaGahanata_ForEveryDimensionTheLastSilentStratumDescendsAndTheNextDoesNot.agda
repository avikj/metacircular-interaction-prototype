...
------------------------------------------------------------------------
-- ������������-������ � for every dimension, the last silent stratum descends
...
-- Verified green (������ ������, no goals, five types returned) under Agda
...
-- header: the indexed S� rung and the adjacent truncation refinement.
...
-- contractible.  `AnantaraArpana.��������` identifies that loop space with �,
