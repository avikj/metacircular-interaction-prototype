...
-- (a,b,c) case of Tao�Tervinen, Forum Math. Sigma 7 (2019) e33,
...
open import Window5Walsh
  ...
  -- p1234 � p1245, formOf, signed, eq�, eq�, nonNeg�, pos�, eqPat,
  -- allB, anyB, countB, sum�, atom, flipped � all kernel-checked there.
...
-- the four claimed maximisers (�a/3, �b/3, 1/3) the ten zeros split as
-- class A: 2, class B: 4, class C: 4, class D: 0, exactly as the hand
-- proof requires.  (m96� �a �b is Window5Walsh's vertex mass.)
------------------------------------------------------------------------
