...
--
-- THE THEOREM.  The
-- finite theorem g_!(f_!w) ≡ (g∘f)_!w — Fubini as transport,
...
-- SankramanaSesa §3 under the name
...
module ThePushforwardComposesOnTheTypeCarrierAndFiniteFubiniIsItsShadow where
...
open import EveryTransportOwesItsResidual
