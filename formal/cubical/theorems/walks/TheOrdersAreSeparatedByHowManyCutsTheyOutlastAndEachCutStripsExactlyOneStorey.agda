...
module TheOrdersAreSeparatedByHowManyCutsTheyOutlastAndEachCutStripsExactlyOneStorey where
...
open import TheAscendingGeneratorNeverReturnsAndTheDescendingOneExhausts
