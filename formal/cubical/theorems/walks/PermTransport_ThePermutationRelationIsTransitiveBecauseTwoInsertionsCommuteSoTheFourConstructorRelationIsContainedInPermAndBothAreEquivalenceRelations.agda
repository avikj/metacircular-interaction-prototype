...
-- insertions commute.  Nothing about the element type is assumed � no
-- decidable equality, no set-ness.
--
--   �  insert-comm : Insert y vs ws � Insert x us vs
--                    � � ts. Insert x ts ws � Insert y us ts
--   �  exchange    : Insert x ys zs � Perm zs ws
--                    � � ws'. Insert x ws' ws � Perm ys ws'
--   �  perm-trans  : Perm xs ys � Perm ys zs � Perm xs zs
--   �  ≈�Perm      : the four-constructor relation is contained in Perm,
...
module _ {A : Type} where
  ...
  -- � � an insertion moves past a Perm
  ...
  -- � � the four-constructor relation is contained in Perm
