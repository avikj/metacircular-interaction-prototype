...
-- of magnitude � �������� / ��������� / �����, each graded ������ / ����� /
-- ����������� � as a nine-element ordered set, without the
-- exact salk operations.
-- `Ardhaccheda.agda` carries the operations themselves � ���������, the
-- count of halvings, and �����������, the halving of THAT � but as
...
-- MANY TIMES THE INSTRUMENT CAN CUT IT, and §� says each cut removes one
-- storey and no more, so the count is exact rather than a bound.
--
-- WHAT IS SETTLED HERE, in one line each:
--
--   §� ���-����      k cuts of a tower of height k+j leave a tower of
--                    height j � exactly one storey per cut.
--   §� �������       hence k cuts return a height-k tower to its base;
--                    Ardhaccheda's ���������� and ������-���������� are the k=1
--                    and k=2 cases, recovered here by refl, not restated.
--   §� ���������     and k cuts do NOT reach the base of a height-(k+1)
...
--   §� ��������������  every cut in the tower � ���������, �����������, and each
--                    ������- and higher ������ � is DESCENDING in the sense of
--                    `Vrddhiksaya_�`.���������, strictly below its argument
...
------------------------------------------------------------------------
-- � � ������� and ���� � the tower, and the cut applied k times.
--
--     ������� k n is the tower of k twos over n: ������� 0 n = n and each
--     storey doubles the exponent.  ���� k is ��������� applied k times.
--     ���� 1 IS ��������� and ���� 2 IS �����������, definitionally � the
...
------------------------------------------------------------------------
-- � � ���-���� � EACH CUT STRIPS EXACTLY ONE STOREY.  k cuts of a tower of
--     height k+j leave the tower of height j standing.  The proof is the
--     one law Ardhaccheda already has � ���������(2^y) ≡ y � applied once
...
------------------------------------------------------------------------
-- � � ������� � so k cuts return a height-k tower to its base exactly.
--     Ardhaccheda's ���������� is k = 1 and its ������-���������� is k = 2; both
...
------------------------------------------------------------------------
-- � � ��������� � AND k CUTS DO NOT REACH THE BASE OF THE NEXT STOREY UP.
--     Spend every one of the k cuts on a tower of height k+1 and what is
--     left is ����-���� n, still strictly above n.  So the height index is
--     not a description of the tower, it is a separation of it: no fixed
--     number of alk collapses the order above.
--
--     ����-����-������� (n < 2�, strictly) is the whole content; Ardhaccheda
--     has only the non-strict n � 2�, which is not enough to separate
...
------------------------------------------------------------------------
-- � � �������������� � EVERY ALK IS OF THE DESCENDING KIND.
--
--     `Vrddhiksaya_�` splits self-maps of � by direction and names
--     ��������� and ����������� as the descending examples, but proves the
...
------------------------------------------------------------------------
-- � � � ������������ � and therefore no alk ascends.  Read with §� this is
