...
-- §2b refutes the only candidate.  The catukoi is exhausted here,
...
-- ────────────────────────────────────────────────────────────────────
--
-- It is tempting to read §1 as answering the Naiyyika regress
...
-- table with a primary-text audit (`Tarkasagraha` §§57, 80).
--
