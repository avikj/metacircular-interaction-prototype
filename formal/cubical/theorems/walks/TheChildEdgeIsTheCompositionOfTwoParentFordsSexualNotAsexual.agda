...
module TheChildEdgeIsTheCompositionOfTwoParentFordsSexualNotAsexual where

open import Cubical.Foundations.Equiv using (_≃_ ; compEquiv ; fiber)
open import Cubical.Data.Nat using (ℕ)
open import Cubical.Data.Sigma using (Σ-syntax)

open import TheRemainderIsLawfulAndTheNetBeats using (विवेक-प्रमाण)
open import TheHandProofWasUnnecessaryAndTransportGivesIt using (योग ; विवेक≃वाहकः)
open import TheReturnAndTheCutDecomposeTheSamePairAndSetubandhaNamedTheGap using (सेतुः)
