...
------------------------------------------------------------------------
-- ������-����������� � the organism's top join candidate is a WALL, and the
...
--
--     4796 ≈ join [436 nodes @ ⟨lib⟩.Bool] � [11 nodes @ Saptabhangi.�����������]
--
-- It is impossible, and the proof is `Saptabhangi.�������` � the module's
-- own checked pigeonhole: ANY two-valued verdict on the sevenfold
-- identifies two distinct of the three seeds.  An equivalence
-- ����������� � Bool would BE a two-valued verdict that is injective.  So
...
-- durnaya, mechanized," and "������������ as network topology."
--
...
-- fords into ����������� � Bool.
--
-- ������-����������� is built here, 2026-08-23; the load-bearing theorem is
...
------------------------------------------------------------------------
-- � � injectivity of an equivalence (as in �������, restated locally)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � the three seeds are pairwise distinct: a discriminating map to �.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � ������� � the wall.  An equivalence would be an injective two-valued
-- verdict; ������� says no two-valued verdict is injective on the seeds.
------------------------------------------------------------------------
