...
--       ‡‡‡ ‚î two distinct points of a fibre ‚î IS NOT ENOUGH.  Exhibited:
...
--
--   `Fiberjala_‚¶`            ‡‡‡ as one of three fibre verdicts.  ¬ß‡
...
-- and `r (f tt) ‚â° tt` is refl).  Its fibre over `base` is `Œ[Unit] Œ©S¬`,
