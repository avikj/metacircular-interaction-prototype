...
--
-- W5: THE ADVANTAGE OF PROOF IS THE QUANTIFIER (§�).  The sentence is
...
-- endpoint at once � a function (n : �) � Evolve zero n, built by one
...
--
-- W6: THE MERGED STATE IS ONE EME (§�).  NKSUnivalence_* merged the
...
--
-- W7: PURPOSE RANKS NOTHING INSIDE THE ENSEMBLE (§�).  Take the
...
------------------------------------------------------------------------
-- � � W5: the advantage of proof is the quantifier.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � W6: the merged state is one eme, and still has no section.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � W7: purpose ranks nothing inside the ensemble.
------------------------------------------------------------------------
