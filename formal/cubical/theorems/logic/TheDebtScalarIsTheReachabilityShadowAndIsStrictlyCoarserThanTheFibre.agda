...
--
-- नय-आवरणम्: each standpoint conflates a pair the
-- other separates.  समाचरण-नित्यम्: a transitive verdict
...
--     — what a loop carries, what an observation cannot
--     see into.
--
...
module TheDebtScalarIsTheReachabilityShadowAndIsStrictlyCoarserThanTheFibre where
