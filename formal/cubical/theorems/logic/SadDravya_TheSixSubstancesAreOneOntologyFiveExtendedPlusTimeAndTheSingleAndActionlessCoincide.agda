...
------------------------------------------------------------------------
-- ��������� � the six substances are one ontology: five extended plus time,
-- and the single and the actionless coincide.  The whole arena, one type.
--
-- SOURCE.  Umsvti, *Tattvrthastra*, adhyya 5 (~2nd�5th c.):
--   5.1  ajvaky dharmdharmkapudgal � the ajva KYAS (extended
--        non-souls) are dharma, adharma, ka, pudgala.
--   5.2  dravyi jv ca � and jvas too are dravyas.  (kla is added as
--        the sixth in the Digambara reading of 5.39, kla cety eke.)
--   5.3  nityvasthitny arpi � [they are] permanent (NITYA), fixed,
--        non-corporeal;  5.4  rpia pudgal � EXCEPT pudgala, corporeal.
--   5.5   kd ekadravyi � up to ka (i.e. dharma, adharma, ka)
--        they are each a SINGLE substance;
--   5.6  nikriyi ca � and [those same three are] ACTIONLESS.
--   5.1  the five extended substances are the ASTIKYAS (kya = having
--        pradeas); kla, being point-instantaneous, is the one dravya
--        that is NOT an astikya.
--
-- WHAT IS PROVED, as the whole arena in one enumerated type, classified
-- exactly as the stras classify it � and PURELY: every classification is
...
--
--   §2  ������������ � there are exactly SIX dravyas (the enumeration has
--       length 6; every constructor appears).
--   §3  ���������������� � exactly FIVE are astikya: kla is not extended,
--       the other five are.  (pacstikya + kla = adravya.)
--   §4  ���� ���� � exactly ONE is corporeal (pudgala); the five are arp.
--   §5  ������� �������������� � ���� � 5.5 and 5.6 pick out the SAME three
--       (dharma, adharma, ka): the single substances and the actionless
--       ones COINCIDE, as predicates � proved pointwise.
--   §6  ����� ������� � all six are nitya (5.3): permanent.  This is
--       dhrauvya (`Anekanta`, TS 5.29) at the level of the substances �
--       every dravya persists; that persistence is what each substance's
--       conservation law (`Pudgala.������-�������`, `DharmaAdharma`,
--       `Kala`) instantiates.
--
...
-- astikya: extended (has pradeas) � all but kla (5.1)
अस्तिकायत्वम् : द्रव्य → Type
अस्तिकायत्वम् काल = ⊥
अस्तिकायत्वम् _   = Unit

-- rp: corporeal � only pudgala (5.4)
रूपित्वम् : द्रव्य → Type
रूपित्वम् पुद्गल = Unit
रूपित्वम् _     = ⊥

-- eka: a single substance � dharma, adharma, ka (5.5)
एकत्वम् : द्रव्य → Type
एकत्वम् धर्म  = Unit
एकत्वम् अधर्म = Unit
एकत्वम् आकाश  = Unit
...
-- nikriya: actionless � dharma, adharma, ka (5.6)
...
------------------------------------------------------------------------
-- §3  ���������������� � five are extended, kla is not.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- §5  ������� �������������� � ���� � 5.5 and 5.6 name the same three:
...
------------------------------------------------------------------------
-- §6  ����� ������� � every dravya is permanent (dhrauvya at the level of
