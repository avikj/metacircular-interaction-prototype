...
--  target — not two points of the fiber; and the circle is not an
--  instance of it.)
--
-- ────────────────────────────────────────────────────────────────────
...
--
--   §२  the law   : two points of one fiber WITH DISTINCT SOURCES kill
...
--
-- `GhataFiber` exhibits 0 and 3 over ε.  Their sources are 0 and 3, and
