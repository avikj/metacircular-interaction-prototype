...
--
--   §�  NO FUNCTION of the observational distribution computes the
...
--
--   §�  NO FUNCTION of the interventional distributions computes the
...
--
--   §�  and the positive half, so the negative ones are not the whole
...
-- function into �, unnormalised.  Every statement below either compares
...
------------------------------------------------------------------------
-- � � distributions on the two-element exogenous space.
------------------------------------------------------------------------
