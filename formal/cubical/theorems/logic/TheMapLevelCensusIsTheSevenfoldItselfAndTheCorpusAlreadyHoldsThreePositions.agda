...
module TheMapLevelCensusIsTheSevenfoldItselfAndTheCorpusAlreadyHoldsThreePositions where
...
open import TheIndicatorsFullCensusPricesTheBusiestUnpricedEdge
