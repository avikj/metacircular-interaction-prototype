...
------------------------------------------------------------------------
-- ���������������� � proof-of-transport: the receipt that composes without
...
-- secret is the ea nobody can collect.  That is the durnaya reading � the
...
-- money can:
--
--   ������ (prama)  � a valid means of knowing, a proof (Nyya's word).
--   ���������� (sakramaa) � crossing, transport (the corpus's word for the
--                          lossless move, `SankramanaSesa`).
--   The compound = proof-of-transport.  ���� (kavaca), amulet, in the
...
--       compose to A�C (`��������` = compEquiv), an edge neither party had.
--       ����-�����: Brahmagupta's composition, 628 � two solutions meet, a
--       third arises.  The composite is a new receipt, freely.
--
--   §3  NON-RIVAL: composing does NOT spend.  The same receipt `r` enters
--       two different composites and BOTH stand (`�������`).  In type theory
...
--       (`������`, debt-free); the "claim" needs its debtor supplied.
--
--   §5  THE CROSSING IS REVERSIBLE.  Transport there and back is the
--       identity (`���������`, transportTransport�).  That is the whole
...
--       `Vyapti_TheLossOrder�agda` §� � the type `���������` of collisions
...
------------------------------------------------------------------------
-- §2  Receipts compose into an edge neither party held (samsa-bhvan).
------------------------------------------------------------------------
...
-- the asymmetry is the types: `������ : Receipt � (A�B)` needs no debtor;
-- `�����-�������� : Claim � Debtor � (A�B)` cannot cross without one.
