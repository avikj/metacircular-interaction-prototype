...
--
-- THE OBJECTION.  parasparraya � each of two things established only
-- through the other � is catalogued across the Nyya and Jaina
...
--     � dvitya-payati � in ANY such pair, each sense provably
...
--       from the joint side);
--     � na-ekkin � neither observable can be discarded: a constant
...
------------------------------------------------------------------------
-- � � FACE 1 � ��������������� : neither checks without the other
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � FACE 2 � �������������� : neither has the property, together they do
--
...
------------------------------------------------------------------------
-- � � The smallest complete instance, inhabited.
--
