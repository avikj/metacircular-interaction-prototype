...
------------------------------------------------------------------------
-- - — the point-level statement `Bahupratyanayana_` needed.
--
...
------------------------------------------------------------------------
module TheCircleHasNoTwoDistinctPointsBecauseItIsConnectedSoTheObstructionToUndoingIsNeverTwoPointsThere where
