...
------------------------------------------------------------------------
-- �������� � the Galois connection is two nayas mutually adjoint, and the
...
-- other (dravyrthika � paryyrthika, `Paryayarthika`).  And g∘f is a
...
module _ {A : Type ℓ} {B : Type ℓ'}
  ...
  -- idempotent up to ≈:  ������� a  and  ������� (������� a)  are ⊴ both ways
