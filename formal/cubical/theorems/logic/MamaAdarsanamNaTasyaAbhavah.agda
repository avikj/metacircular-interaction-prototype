...
-- stated compactly in Annabhaa, *Tarkasagraha* §§57, 80 (~1600).**
--
...
-- `AllNayasAgree` from `CollapseIffEveryNayaAgrees`.  So the
...
module MamaAdarsanamNaTasyaAbhavah where
