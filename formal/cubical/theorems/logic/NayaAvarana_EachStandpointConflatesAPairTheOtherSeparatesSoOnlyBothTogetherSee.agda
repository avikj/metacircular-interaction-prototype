...
-- � Ω S� �� � � (OrderSaha) is not contractible (��������); � Ω Unit �� is.
------------------------------------------------------------------------
...
-- agreeing on �� and �� at the basepoint; the tower continues upward, and
-- so, by ������-������'s restratification, does the sevenfold).  What is
