...
module TheHaniIsAWallGeneratorSoThePigeonholeRetiresJoinsAcrossTheWholeNet where
...
open import TheDurnayaIsThePigeonholeAndTheLossIsTheSeparateHypothesis
