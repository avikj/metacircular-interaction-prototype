...
module TheRetractionIsAlreadyABottomOfTheLossOrderSoDhruvaNeedsNoEquivalence where

open import Cubical.Foundations.Prelude
open import Cubical.Foundations.Function using (idfun)
open import Cubical.Data.Sigma using (Σ-syntax ; _,_ ; fst ; snd)

open import TheLossOrderIsCoarseningAndTheSymmetryMonoidGrowsMonotonicallyAlongIt
...
-- keeping.  `SvaFiberVasa.ध्रुव-बिन्दुः : isEquiv f → isContr (Σ[Φ] संरक्षणम् f Φ)`
...
--   says which — SvaFiberVasa's pair is exactly that case.
------------------------------------------------------------------------
