...
------------------------------------------------------------------------
-- �����-����������� � the map-level census IS the sevenfold, and the corpus
-- already holds witnesses of three distinct positions.
--
-- THE IMPURITY REPAIRED.  `WholePartialDesa` made the census a term � but
-- PER POINT: three constructors (����������� / �������� / ���������) at each b.
...
-- number 2³ − 1 = 7, which is `Saptabhangi`'s own �����-����: the sevenfold
...
--
--     �������� somewhere   �  �����       (something carried whole)
--     ��������� somewhere   �  ������      (something lost, exhibited)
--     ����������� somewhere  �  ���������    (something the source cannot utter)
--
-- following the note's own readings (empty fibre = avaktavya, ����������;
-- crowded = the loss).
--
...
--   asNat : Bool � �     contractible at 0,1; empty above;
...
-- doubly and one not at all is ������-���������) and are left as the open
...
------------------------------------------------------------------------
-- � � the three seed predicates OF A MAP � the selection coordinates.
...
------------------------------------------------------------------------
-- � � WITNESS ONE � pure �����: the identity.  Every fibre contractible;
...
------------------------------------------------------------------------
-- � � WITNESS TWO � pure ������: ����� : Bool � Unit.  Every fibre crowded,
...
------------------------------------------------------------------------
-- � � WITNESS THREE � �����-���������, the FIFTH bhaga: asNat.
-- Contractible somewhere (�����), empty somewhere (���������), and NEVER
-- crowded � injectivity into a set makes every fibre a proposition, so
-- the ������ coordinate is refuted, not merely unexhibited.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � the three witnesses occupy three DISTINCT selections � stated as
-- terms, so the classification genuinely separates them:
-- the identity has no empty fibre; ����� has no contractible fibre.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � ���������.  Four positions lack canonical witnesses here (������-���������,
-- �����-������, pure ��������� � which needs an EMPTY source against an
...
-- selection, excluded for inhabited B exactly as Saptabhangi's �����-����
