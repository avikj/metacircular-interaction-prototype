...
------------------------------------------------------------------------
-- ��������� � the kernel accomplishes by induction the frontier lemmas the
...
-- `interactive/library.terms`) discovers true equations over � by enumeration
...
-- theory".  Those are its ea.  This module supplies the kernel proof of
...
-- verifies them (prama=the checked term).  This is the propose�dispose
...
------------------------------------------------------------------------
-- §7  the two max demands (SesaPariksa's third and fourth ea).
------------------------------------------------------------------------
