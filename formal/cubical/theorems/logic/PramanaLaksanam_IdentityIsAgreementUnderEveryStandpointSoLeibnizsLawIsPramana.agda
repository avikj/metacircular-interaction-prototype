...
--     x ≡ y    ⟺    (� P, P x � P y).
--
-- Forward is transport (`subst` � the free road, `PramanaTransport`): a
...
-- together (prama), certify � and no single naya is enough (a durnaya
-- claims one predicate settles it; `NayaVada.�������` refutes that).
--
-- WHAT IS PROVED:
--   §1  ����-������ : x ≡ y � (� P, P x � P y).  Identicals are
--       indiscernible � every standpoint transports (subst).
--   §2  ��������-����������� : (� P, P x � P y) � x ≡ y.  Indiscernibles
--       are identical � total agreement IS identity (apply at P = x ≡_).
--   §3  �������� : the two package to the biconditional � identity ≡
...
------------------------------------------------------------------------
-- §1  ����-������ � identicals are indiscernible: every standpoint transports.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- §2  ��������-����������� � indiscernibles are identical: total agreement
...
------------------------------------------------------------------------
-- §3  �������� � identity is agreement under every standpoint (both ways).
------------------------------------------------------------------------
