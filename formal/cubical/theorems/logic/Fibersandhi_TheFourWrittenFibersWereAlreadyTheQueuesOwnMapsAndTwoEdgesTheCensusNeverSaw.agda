...
-- `मात्रा : रूप → ℕ` (`fiber/src/…/Prastara_….agda:157`) are top-
-- level, total, non-injective maps whose fibers are written 12 and 95
...
module Fibersandhi_TheFourWrittenFibersWereAlreadyTheQueuesOwnMapsAndTwoEdgesTheCensusNeverSaw where
