...
--
--   ‡∞‡ø‡ï‡‡‡Æ‡  the fibre is EMPTY.  ‡®‡‡‡ü‡ø / ‡‡µ‡ï‡‡‡µ‡‡Ø‡Æ‡: there is no return, and
--          there is nothing to carry.  No `Carrier`, no `ua`, nothing to
--          transport.  ¬ß‡ of ‡‡‡ø‡‡‡æ-‡‡‡‡‡∞-‡µ‡ø‡‡‡‡æ‡∞‡: ‡‡‡‡∞‡‡ø‡ï‡æ‡∞‡‡Ø‡Æ‡.
--   ‡‡ï‡Æ‡    the fibre is CONTRACTIBLE.  ‡‡‡®‡∞‡æ‡ó‡Æ‡®: the datum is determined,
--          rides free, and `singl` gives it with no hypothesis whatever.
--   ‡‡‡     the fibre has TWO DISTINCT POINTS.  Not a failure ‚î the fibre is
--          the SUBJECT.  `TheFibreIsTheSubject`: the
...
-- what it buys: when every fibre is ‡‡ï‡Æ‡, base and carried may be EXCHANGED,
...
module _ {A : Type ‚Ñì} {B : Type ‚Ñì'} (f : A ‚Üí B) where
  ...
  ‡§µ‡§π‡§®‡§Æ‡•ç a = Œ£[ b ‚àà B ] (f a ‚â° b)      -- bind b: the graph fibre
...
-- ‡‡‡‡‡ø / ‡®‡æ‡‡‡‡ø / ‡‡µ‡ï‡‡‡µ‡‡Ø.  Read the three fibre verdicts as those three
