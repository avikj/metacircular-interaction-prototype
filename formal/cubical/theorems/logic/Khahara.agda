...
-- correcting Brahmagupta: n0 (n≠0) is not zero but khahara, an infinite
-- quantity UNCHANGED by adding or subtracting a finite amount.  And the
-- fine distinction with Shunya: n0 (n≠0) = khahara (determinate infinite),
...
--  §5 there defines avaktavyam as the case
...
--  See
--  AnuktaAvaktavya.agda §6, where 00's defect is checked.
--
--  Using one third
