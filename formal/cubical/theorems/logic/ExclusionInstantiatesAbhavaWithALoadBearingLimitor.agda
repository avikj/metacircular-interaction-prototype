...
-- THE CHECK
--
-- Â§6.3's critique is of a limitor carried as an *optional field* with no
...
exclusionAbhava .pratiyogin Î± _ = obs Î± true â‰¡ obs Î± false
...
exclusionLimitorLoadBearing :
  ...
  Ã— (Â¬ (holds exclusionAbhava true))
exclusionLimitorLoadBearing =
    (Î» _ p â†’ trueâ‰¢false p)
  , (Î» h â†’ h tt refl)
