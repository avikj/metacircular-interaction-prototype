...
--
-- returned exactly two lines, BOTH prose, NEITHER formal ‚î
...
-- example in
-- ¬ß3 is MINE ‚î a two-point locus, not a tradition example ‚î and it is
...
--
-- What it does NOT close is ¬ß3.3's recommendation, which was about the
