...
module AtArityThreeEveryProperSubfamilyIsBlindAndOnlyTheWholeFamilyIsFaithful where
...
open import TheFamilyRecordEveryBlindnessIsJointlySeenAndNoMemberAloneIsFaithful
  using (Kula)
