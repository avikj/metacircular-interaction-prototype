...
-- checks it.
--
-- THE STEP (from Vishvamachine): for ANY evaluator f : A � B,
--
--     lossless :  A � � B (fiber f)          a � (f a , a , refl)
--
...
--                        � B (fiber f) IS just B: the fibre carries
...
------------------------------------------------------------------------
-- §1  The lossless step.  A � � B (fiber f), the codec.  Invertible, so
...
-- contractible, � B (fiber f) � B: the residue holds no information, the
