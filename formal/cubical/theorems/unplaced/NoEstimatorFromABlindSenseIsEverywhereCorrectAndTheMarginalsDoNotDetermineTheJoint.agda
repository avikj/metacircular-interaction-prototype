...
module NoEstimatorFromABlindSenseIsEverywhereCorrectAndTheMarginalsDoNotDetermineTheJoint where
...
open import IntensityIsBlindToPhaseAndPhaseToMagnitudeAndTheAmplitudeIsTheirInterdependentPair
