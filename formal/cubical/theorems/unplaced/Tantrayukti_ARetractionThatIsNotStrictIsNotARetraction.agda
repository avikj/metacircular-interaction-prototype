...
--
-- SOURCE.  ������������� � the devices of stric exposition.  Two lists
...
-- redaction by roughly the 2nd�3rd c. CE; the Caraka Sahit's
-- Dhabala redaction is c. 4th�5th c. CE over an older core.
--
...
--
--   ����������   the objection, stated by the author of the thesis
--   �����������   the answer to it
--   �����      the exception that restricts a general statement
--   ������      the settled conclusion, after both
--
-- ��������������������������������������������������������������������
...
-- corrects (`using (������� ; �����)`) � it must, since refuting a claim
-- about ������� requires MY ������� and not a copy.  So:
--
...
-- to.  stra has exactly that: ���������� is a slot, and the author of
...
--
--   �����    "stronger" � the wide claim implies the narrow one, so N is
--            what W was reaching for and not a change of subject
--   ��������   the ����������, discharged: W is refuted
--   �������   the ������: N stands
--
...
--
-- `������ W �` is inhabited whenever `� W` is: retract to the trivially
...
-- question about prama � what is established, and by what means � and
-- the tantrayukti list keeps ������ (the settled conclusion) as a device
...
--
-- Stated so that no later reader mistakes an inhabited `������` for a
...
--
-- `AnuktaAvaktavya` §4, §5 and §8 call ������� and ����� "dual shapes",
...
open import SamayikaAndNityaAreIndependent
...
-- The survivor, written out rather than inferred.  An inferred � leaves
