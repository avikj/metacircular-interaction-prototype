...
open import FiniteNonabelianHolonomy using (Fin3)
open import AbstractSpinNetworkKinematics using (Intertwiner)
open Intertwiner
open import S3FiniteSpinNetwork using (terminalVertex)
