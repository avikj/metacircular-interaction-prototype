...
-- choice axiom: completeness IS the type.  That is what the univalent
-- construction buys over the
-- classical one, and it needs nothing beyond what --safe admits.
--
------------------------------------------------------------------------

module TheContinuumBuiltFromTheAxiomsWithItsLimitsAsConstructors where
