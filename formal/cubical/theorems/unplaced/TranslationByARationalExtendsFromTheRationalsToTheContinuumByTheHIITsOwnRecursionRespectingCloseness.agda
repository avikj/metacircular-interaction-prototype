...
module TranslationByARationalExtendsFromTheRationalsToTheContinuumByTheHIITsOwnRecursionRespectingCloseness where
...
import TheContinuumBuiltFromTheAxiomsWithItsLimitsAsConstructors as S
open S using (ℝ ; rat ; lim ; eq ; _∼⟨_⟩_ ; ∼rat-rat ; ∼rat-lim ; ∼lim-rat ; ∼lim-lim ; ∼squash)
open S.ℚ using (num ; den)
open S.ℚ⁺ using (num⁺ ; den⁺)
open import TheContinuumModulesOwnIntegersAreReflectedIntoTheLibrarysWithAdditionMultiplicationAndOrderSoClosenessIsAnOrderStatement
open import ClosenessOfRationalsIsInvariantUnderTranslationByARationalSoTranslationWillExtendToTheContinuum
