...
-- rectangles" into "at least k rectangles" is a COUNTING step: it
-- needs `I` finite with k elements and a pigeonhole over the cover.
-- What is proved is the part that carries the content — the
-- injectivity — and the counting step is standard and separate.
--
