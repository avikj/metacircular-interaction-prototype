...
module TheFourthCornerCannotLiveOverAnEnumerableDecidableInstanceSet where
...
open import TheFourthCornerIsRefutedUnderPointwiseStability
...
------------------------------------------------------------------------
-- ON THE NAME.  `TheFourthCornerIWasNamingIsTheSequentialPosition`
