...
--
--   §1  A FILE is a line-indexed content function � � �; a PATCH is a
...
------------------------------------------------------------------------
-- � � Blame.  Histories as write lists, applied in order.
------------------------------------------------------------------------
