...
module TheCubeSurfaceIsEmptyBecauseEverySolutionDescendsAndNoNaturalFallsForeverSoFermatsCubeIsOneEisensteinStep where
...
open import TheTaxicabNumberBothRepresentationsByReflAndMinimalityByBoundedReflection
  using (cube ; S²)
open import TheCubeGateBelowThirteenIsSignedAndBothNearMissesAreItsTightness
  using (FLT₃)
