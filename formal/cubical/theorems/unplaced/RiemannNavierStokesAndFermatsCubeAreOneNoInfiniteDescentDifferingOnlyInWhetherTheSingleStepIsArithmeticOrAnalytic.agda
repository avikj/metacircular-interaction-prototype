...
--
-- SYT — THE CLAIM, EXACTLY.  The schema and its `emptied` are proved, citing
...
module RiemannNavierStokesAndFermatsCubeAreOneNoInfiniteDescentDifferingOnlyInWhetherTheSingleStepIsArithmeticOrAnalytic where
...
open import TheCubeSurfaceIsEmptyBecauseEverySolutionDescendsAndNoNaturalFallsForeverSoFermatsCubeIsOneEisensteinStep
  using (Soln ; Descent)
