...
--
-- SYT � THE CLAIM, EXACTLY.  §§1�3 for any ring with involution, for
...
module Vyatiorder_TheCommutatorOfASelfAdjointWithASkewAdjointIsSelfAdjointSoTheCrossSectorCurrentIsARealPairing where
...
module _ (R : Ring ℓ) (†_ : ⟨ R ⟩ → ⟨ R ⟩) (inv : IsInvolution R †_) where
  ...
  ----------------------------------------------------------------------
  -- � � The two elementary consequences this file needs.  Restated from
  ...
  ----------------------------------------------------------------------
  -- � � CROSS PARITY: the commutator of a self-adjoint with a
  ...
  ----------------------------------------------------------------------
  -- � � THE PARENT'S PARITY: both self-adjoint, commutator SKEW.
  ...
  ----------------------------------------------------------------------
  -- � � AND THE COMPANION: with `a` skew, the ANTIcommutator is
