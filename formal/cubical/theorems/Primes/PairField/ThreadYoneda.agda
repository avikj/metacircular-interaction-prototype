...
-- prime-pair net of `Primes.PairField.RootedNet`, with the naturality condition
-- written out rather than inherited.
--
-- THE PREREQUISITE, and why it was not free.  `Primes.PairField.RootedNet.Thread` is
...
module Primes.PairField.ThreadYoneda where
