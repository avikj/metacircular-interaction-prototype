...
-- and the concrete form of it in `interactive/MathMachine.hs` is that a
...
module Primes.PairField.Tear where

open import Cubical.Foundations.Prelude
open import Cubical.Data.Nat
open import Cubical.Data.Nat.Properties
open import Cubical.Relation.Nullary
open import Primes.PairField.RootedNet
open import Primes.PairField.ThreadYoneda
...
-- subtraction enters, the discipline `Primes.PairField.PairConic` fixed for this net.
------------------------------------------------------------------------
