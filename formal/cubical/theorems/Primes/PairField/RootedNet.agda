...
-- geometry only, exactly as `Primes.PairField.PairConic` carries the conic only.  The
...
module Primes.PairField.RootedNet where
...
-- the discipline `Primes.PairField.PairConic` §1 already fixed for this conic.
------------------------------------------------------------------------
