...
--
-- THE SETTING.  `TheValliIsFiniteForEveryPair`
...
-- over ℕ, and both are checked.
------------------------------------------------------------------------

module TheValliOfConsecutiveVirahankaNumbersIsTheLongestAndEveryValliIsShorterThanTheVirahankaInverse where
...
open import TheValliIsFiniteForEveryPair
