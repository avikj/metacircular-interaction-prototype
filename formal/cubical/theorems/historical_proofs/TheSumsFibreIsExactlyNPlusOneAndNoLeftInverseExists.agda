...
module TheSumsFibreIsExactlyNPlusOneAndNoLeftInverseExists where
...
open import TheHandProofWasUnnecessaryAndTransportGivesIt using (योग)
import TheCutsBoundaryIsTheBaseAndMemoryIsTheFibreFailingToBeContractible as अव
