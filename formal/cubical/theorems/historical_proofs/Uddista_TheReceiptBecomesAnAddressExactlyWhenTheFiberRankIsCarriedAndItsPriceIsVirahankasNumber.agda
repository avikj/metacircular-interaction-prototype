...
--  together with the rank inside its own fiber is one — and the number
...
--                 — carrying the whole fiber is ALWAYS an address, for
...
--                 — and the fiber may be replaced by a NUMBER below
...
-- level.
--
-- NOT CLAIMED.  Not that Piṅgala, Virahāṅka or Halāyudha stated a fiber,
...
-- grades by; and that the family graded by मात्रा at total n is the fiber
...
------------------------------------------------------------------------
-- २ · समष्टिः — THE TOTAL SPACE.  Carrying the whole fiber is always an
...
--     hinge — the defect of a receipt is measured by its fiber and by
--     nothing else.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- ३ · मात्रोद्दिष्टम् — the fiber replaced by a rank below Virahāṅka's
...
--         receipt is completed to an address by its own fiber — is true
