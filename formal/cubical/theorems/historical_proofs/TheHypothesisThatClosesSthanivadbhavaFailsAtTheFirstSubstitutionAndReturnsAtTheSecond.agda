...
-- `adesa` of `TheSubstituteInheritsDesignationsNotForm`,
...
module TheHypothesisThatClosesSthanivadbhavaFailsAtTheFirstSubstitutionAndReturnsAtTheSecond where

open import Cubical.Foundations.Prelude
open import Cubical.Relation.Nullary using (¬_)

open import TheSubstituteInheritsDesignationsNotForm
  using (Rupa ; Varna ; mk ; adesa ; AnalVidhi ; anal-blind)
open TheSubstituteInheritsDesignationsNotForm.Varna
