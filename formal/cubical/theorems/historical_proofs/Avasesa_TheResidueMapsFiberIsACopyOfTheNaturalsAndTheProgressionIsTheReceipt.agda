...
------------------------------------------------------------------------
-- १ · श्रेढी — the progression, and that it lands in the fiber.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
  ...
  अवशेष-तन्तुः = isoToEquiv (iso भागः श्रेढी-तन्तौ पुनरागमनम् प्रत्यागमनम्)
    ...
    -- m ≡ r + K·(m/K), because the remainder IS r by the fiber's own witness
...
-- so nothing maps to an r ≥ K.  Below it the fiber is a full copy of ℕ.
