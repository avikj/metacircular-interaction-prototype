...
--
-- ����������� � construal as a single utterance.  In Prva-Mms, ekavkyat
...
-- there is none to appear: `�����������` below assumes only the congruence.
--
...
-- an approximation.  `�����������` has no confluence premise in its statement
-- or its proof.
