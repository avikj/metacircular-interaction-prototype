...
module TheLaterRulesFibreIsExactlyWhatTheEarlierRuleCannotSeeAndTheBlindnessIsForcedByCollapse where
...
import TheCompositesRemainderIsTheSecondRemainderSummedOverTheFirstAndTheAreasAdd as Sesa
