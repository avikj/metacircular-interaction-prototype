...
--
-- ¬ß‡ß-¬ß‡ reach the fibre by composing against a FUNDAMENTAL ROW, and that
...
-- ‡ï‡‡‡‡ fibre is `singl`, CONTRACTIBLE -- every pair has a ‡ï‡‡‡‡, so the
-- datum rides free.  There the ‡‡æ‡ó‡‡æ‡∞ fibre is a PROPOSITION AND NOT IN
...
------------------------------------------------------------------------
-- ‡ß ¬ ‡‡µ‡ø‡ï‡æ‡∞‡ ‚î THE STEP DOES NOT LEAVE THE FIBRE.
--
--     (a,b) ‚¶ (3a+4b , 2a+3b)
--
...
-- k¬1 = k and the fibre is preserved.  Proved here directly in ‚ï rather
...
------------------------------------------------------------------------
-- ‡© ¬ ‡‡ô‡‡ï‡‡‡ø ‚î THE SEQUENCE, and it lands IN the fibre by ¬ß‡ß.
------------------------------------------------------------------------
