...
-- weighted-count fiber in `Virahanka_…` — written over `List Bool` with
-- `V.छन्दः` — is THE SAME OBJECT as the मात्रा-count fiber over Piṅgala's
...
------------------------------------------------------------------------
-- ३ · the identification of the fibers.  Both witness families land in ℕ,
-- a set, so the fiber condition is a proposition and Σ≡Prop closes each
