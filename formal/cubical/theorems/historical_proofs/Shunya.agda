...
-- The identification of 00 with �����������,
-- the saptabhag's fourth position, does not hold — and it fails by
...
------------------------------------------------------------------------
-- The header separates two defects — expressibility (avaktavyam) versus
