...
-- state a type, a fiber, an equivalence, or a contractibility.  What is
...
-- the data of `isEquiv`, hence exactly "the fiber is एकम् at every
...
-- there is no map to take a fiber of.  `Tantujala` §७ says why that is
