...
------------------------------------------------------------------------
-- �����-������ � the segment and the accumulated whole.
--
-- ������� (source of the TERMS): the Kerala school's sine-table vocabulary �
-- ��������� the segment-sine, ��������� the accumulated sine (Nlakaha,
-- Tantrasagraha 1501, ch. 2; Jyehadeva, Yuktibh c. 1530, ch. 7 �
...
--     ����������� r (m + n)  ≡  ����������� r m  +  ���� r m � ����������� r n
--
-- with the carrier law ���� r (m + n) ≡ ���� r m � ���� r n.  This is the
...
--
-- ���������� (scope, per the naming rule): the TERMS khaa/pia are the
...
-- ���� and ����������� are IMPORTED from Madhava.agda � the chapter composes;
-- it does not redefine (prattyasamutpda; no eighth Term).
--
-- Written in conversation with the warm kernel through ����: each ring
...
------------------------------------------------------------------------
-- �����-�����-������: the accumulated whole is its segments scaled into
