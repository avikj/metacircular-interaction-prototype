...
module EveryElementOfAFiniteGroupIsAnnihilatedByTheGroupsCardinalitySoEulersHypothesisIsDischargedWithoutTheCyclicAssumption where
...
open import TheRSAPrivateKeyIsThePulverizersWitnessAndDecryptionIsPingalasExponentiation
