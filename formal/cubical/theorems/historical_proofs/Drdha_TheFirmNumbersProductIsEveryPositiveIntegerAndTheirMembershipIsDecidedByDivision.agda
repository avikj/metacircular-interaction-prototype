...
-- ARITHMETIC half, and it is carried out multiplicatively over �: no
...
-- WHAT IS PROVED HERE.
--
--   §�  ����? � divisibility by a positive number is DECIDABLE (via mod).
--   §�  ��������� � bounded search: either a nontrivial divisor below a
--       bound, or the proof that there is none below it.
--   §�  �������� � EXISTENCE.  Every n � 1 is the product of a finite
--       list of firm numbers.  By well-founded recursion on n.
--   §�  ��������-�������� � a firm number dividing a product divides one of
--       the factors.  Proved from the library's `gcd`, not assumed.
--   §�  ���������� � a firm p divides the product of a list of firm
--       numbers exactly when p is IN the list.  Hence:
--   §�  �����-������� � the SUPPORT of the factorisation is determined by
--       n alone: for firm p, p � n � p occurs in the list §� produced.
--   §�  ������� � the bridge to `Sarvasthana`'s �������: the map
--       D � � p^e from exponent-lists to � has an INHABITED fibre over
--       every n � 1.
--
-- ��������������������������������������������������������������������
--
--   � UNIQUENESS IS NOT PROVED.  §� produces *a* list; nothing here says
--     two such lists are permutations of each other.  §� proves the
...
--   � §�'s fibre is shown INHABITED, not contractible.  Contractibility
...
--     (Contrast `Sarvasthana` §�, where the fibre of the conservation
--     observable over zero is *everything* � proved there, and a fact of
--     a different kind: blindness, not rigidity.)
--   � NOTHING about ��, negatives, valuations on a field, or the product
--     formula.  This module never leaves �.
--   � The finite places of `Sarvasthana` are still not identified with
--     the firm numbers here; that module's � index remains an index.
--     What this module supplies is the fact that WOULD justify such an
--     identification for the finite half � nothing more.
--
--
-- ��� � dha � "firm, solid, that which stands after abrasion".  In the
-- kuaka the dividend (�����) and divisor (�����) are first divided by
-- their common measure � the ������� � and the pair that remains is
-- called ���, because no further reduction is possible on it.
--   ryabhaa, *ryabhaya*, Gaitapda 2.32�33 (499) for the kuaka
--   the reduction serves; the vall and the reduction step worked out in
--   Bhskara I, *ryabhayabhya* (629); ������� stated in Brahmagupta,
--   *Brhmasphuasiddhnta* 18 (628) and in Bhskara II, *Bjagaita*
--   (1150), whose kuaka rule directs the reduction to ��� before the
--   vall is begun.
--
-- **Syt � the claim, exactly of ���.**  In those texts ��� is a property of a
...
--
-- **§� is Greek and is named so.**  The lemma "a prime dividing a product
...
-- kuaka is � which is a remark about the substrate, not a priority
-- claim about VII.30.
--
...
------------------------------------------------------------------------
-- � � ����� � the firm number: bigger than one, and no reduction on it
...
------------------------------------------------------------------------
-- � � ���, �����, ������ � the product of a list, "every entry has", and
...
------------------------------------------------------------------------
-- � � ����? � division by a POSITIVE number is decidable.
--
--     The decision is `n mod d ≟ 0`, and both directions come out of the
--     library's remainder-quotient identity.  This is what makes §�'s
...
------------------------------------------------------------------------
-- � � ��������� � bounded search for a nontrivial divisor.
--
...
------------------------------------------------------------------------
-- � � �������� � EXISTENCE OF A FIRM FACTORISATION.
--
--     �������� first: a number above one with no nontrivial divisor below
...
------------------------------------------------------------------------
-- � � ��������-�������� � Euclid, *Elements* VII.30 (c. 300 BCE).  Named for
...
------------------------------------------------------------------------
-- � � ���������� � a firm number divides the product of a list of firm
...
------------------------------------------------------------------------
-- � � �����-������� � THE SUPPORT IS DETERMINED BY n.
--
--     For the list §� produced from n, and for any firm p:
...
--     between it and `Sarvasthana` §� � where the fibre is *everything* �
...
------------------------------------------------------------------------
-- �� � �������� � the search is a PROGRAM, and these are its runs.
--
--     Not evidence for the theorem � §� is the evidence for the theorem.
