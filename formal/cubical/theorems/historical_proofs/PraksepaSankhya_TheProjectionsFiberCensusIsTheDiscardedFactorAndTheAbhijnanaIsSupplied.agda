...
------------------------------------------------------------------------
-- ‡‡‡∞‡ï‡‡‡‡-‡‡ô‡‡ñ‡‡Ø‡æ ‚î the census of a projection's fiber IS the discarded
...
--       ‚î the fiber's cardinality, `card (fiber f b)` ‚î but states, in
--       its own header and on purpose, that it does NOT deliver the
--       ‡‡‡ø‡‡‡û‡æ‡®, the untruncated identification `fiber ‚â Fin k`:
...
-- for `fiber fst a`; `PraksepaTantu.‡µ‡æ‡Æ-‡‡®‡‡‡‡-‚â` says that fiber IS `B`.
...
import PraksepaTantu_TheFiberOfAProjectionIsTheDiscardedFactor as ‡§™‡•ç‡§∞
import SankhyaTantu_TheFiberOfAFiniteSourceMapIsFiniteAndItsCardinalityIsTheReceipt as ‡§∏
...
module _ (A B : FinSet ‚Ñì) where
  ...
  ------------------------------------------------------------------------
  -- ‡ß ¬ ‡µ‡æ‡Æ-‡‡ô‡‡ñ‡‡Ø‡æ ‚î the census of fst's fiber is card B.
  --
  ...
  ------------------------------------------------------------------------
  -- ‡® ¬ ‡¶‡ï‡‡‡ø‡-‡‡ô‡‡ñ‡‡Ø‡æ ‚î the census of snd's fiber is card A.
  ------------------------------------------------------------------------
