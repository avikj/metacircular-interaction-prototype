...
------------------------------------------------------------------------
-- प्रक्षेप-सङ्ख्या — the census of a projection's fiber IS the discarded
...
--       — the fiber's cardinality, `card (fiber f b)` — but states, in
--       its own header and on purpose, that it does NOT deliver the
--       अभिज्ञान, the untruncated identification `fiber ≃ Fin k`:
...
-- for `fiber fst a`; `PraksepaTantu.वाम-तन्तुः-≃` says that fiber IS `B`.
...
import PraksepaTantu_TheFiberOfAProjectionIsTheDiscardedFactor as प्र
import SankhyaTantu_TheFiberOfAFiniteSourceMapIsFiniteAndItsCardinalityIsTheReceipt as स
...
module _ (A B : FinSet ℓ) where
  ...
  ------------------------------------------------------------------------
  -- १ · वाम-सङ्ख्या — the census of fst's fiber is card B.
  --
  ...
  ------------------------------------------------------------------------
  -- २ · दक्षिण-सङ्ख्या — the census of snd's fiber is card A.
  ------------------------------------------------------------------------
