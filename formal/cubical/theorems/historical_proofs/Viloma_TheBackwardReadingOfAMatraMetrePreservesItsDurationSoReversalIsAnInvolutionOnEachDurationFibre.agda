...
-- splits `fiber ����� (2+n)` into two smaller fibres; it never touches the
...
------------------------------------------------------------------------
-- � � THE FIBRE EQUIVALENCE (A � A, inhabited by reversal, not identity).
-- Because ����� is a set-map, each duration-fibre's witness is a
...
-- Applying ������ twice is the identity on each fibre (rev-rev), so ������ is
