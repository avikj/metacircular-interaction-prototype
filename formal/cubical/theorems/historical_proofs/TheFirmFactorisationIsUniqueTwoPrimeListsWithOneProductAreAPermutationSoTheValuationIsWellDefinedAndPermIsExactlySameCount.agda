...
------------------------------------------------------------------------
--  — the uniqueness half of the firm factorisation.
--
...
------------------------------------------------------------------------
module TheFirmFactorisationIsUniqueTwoPrimeListsWithOneProductAreAPermutationSoTheValuationIsWellDefinedAndPermIsExactlySameCount where
