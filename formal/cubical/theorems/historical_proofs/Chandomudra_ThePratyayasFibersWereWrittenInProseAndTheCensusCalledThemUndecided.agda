...
-- reports 1045 of them UNDECIDED ‚î no syntactic rule names a fiber.
...
-- So the fiber of the mtr-count satisfies VIRAHKA'S RECURRENCE ‚î the
...
------------------------------------------------------------------------
-- ‡ß ¬ ‡Æ‡æ‡‡‡∞‡æ‡µ‡‡‡‡‡Æ‡ ‚î a metre IS the fiber of the mtr-count.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- ‡® ¬ ‡µ‡∞‡‡‡µ‡‡‡‡‡Æ‡ ‚î and a syllable-metre is the fiber of the syllable count.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- ‡© ¬ The joint fiber, which is NOT definitional.
--
-- `Chosen n k = Œ[ p ] ((varna p ‚â° n) ó (guruOf p ‚â° k))` ‚î a PAIR OF
-- EQUATIONS.  The fiber of the paired map is `Œ[ p ] ((varna p , guruOf p)
