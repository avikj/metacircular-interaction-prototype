...
------------------------------------------------------------------------
-- Dvipha � the antichain bound on anubandhas is not tight, and what
...
-- is a *pha*, a recitation, and one sound in it is recited TWICE � ha,
-- in stra 5 (ha ya va ra ) and again in stra 14 (ha L) � which is why
...
module Dvihpatha_TheAntichainBoundIsAttainedOnlyIfASoundMayBeListedTwice where
...
------------------------------------------------------------------------
-- §1  Sounds, markers, and the pratyhra extractor.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- §5  Recited once, three anubandhas do.  So the cost without dvipha
