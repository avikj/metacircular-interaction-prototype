...
module TheConditionalFibreIsWhatTheSecondCountStillCostsOnceTheFirstIsKnown where
...
import ThePratyayasFibresWereWrittenInProseAndTheCensusCalledThemUndecided as CM
