...
--  together with the rank inside its own fibre is one ‚î and the number
...
--                 ‚î carrying the whole fibre is ALWAYS an address, for
...
--                 ‚î and the fibre may be replaced by a NUMBER below
...
------------------------------------------------------------------------
-- ‡® ¬ ‡‡Æ‡‡‡ü‡ø‡ ‚î THE TOTAL SPACE.  Carrying the whole fibre is always an
...
--     hinge ‚î the defect of a receipt is measured by its fibre and by
--     nothing else.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- ‡© ¬ ‡Æ‡æ‡‡‡∞‡ã‡¶‡‡¶‡ø‡‡‡ü‡Æ‡ ‚î the fibre replaced by a rank below Virahka's
...
--         receipt is completed to an address by its own fibre ‚î is true
