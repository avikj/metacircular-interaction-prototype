...
--
-- SCOPE.  A statement with a real-valued logarithm � there is
...
-- over �, and both are checked; nothing sharper is claimed.  Nothing here
-- touches the ����� section or the cakravla, which stay as the earlier
-- module leaves them.
------------------------------------------------------------------------
