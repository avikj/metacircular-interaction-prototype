...
------------------------------------------------------------------------
-- ������� at the level of the vocabulary, and what it costs.
--
...
-- gains nothing, and only avipka � deliberate, before its time � is a
...
-- engine steered by ����� can never take the step.  Only ���� removes a
...
--   translation is cofinal in � and no licensed move goes from cheap to
--   expensive; ��������� is the only move non-increasing in all three
...
--   behaviour acts off its �������; extent does not determine price.
--
-- ATTESTED, used as the source uses them: �������, ����, �������/�������;
-- ������, ������, ������, ���������; ���������, ����������, �����, ���������,
-- ����������, �����, �������; ����/����� as Pigala's pair; ������ as the
-- grammarians' unit of ����� (����������������� ������������ ��������
-- ����������� � Ngea, Paribhenduekhara ~1700; Patajali ~150 BCE).
