...
------------------------------------------------------------------------
-- Prvatrsiddham � the tripd as a tower of maps, and the fiber as the
...
--   `���������`.  So the fiber is not a metaphor for the invisible part �
...
-- already removed it; that is not assumed, it is `��������-�-��` below.
--
...
-- and the reason, isolated: the condition is not constant on the fiber.
...
--     are what make §� content: the obstruction is the fiber and nothing
--     else.
------------------------------------------------------------------------
