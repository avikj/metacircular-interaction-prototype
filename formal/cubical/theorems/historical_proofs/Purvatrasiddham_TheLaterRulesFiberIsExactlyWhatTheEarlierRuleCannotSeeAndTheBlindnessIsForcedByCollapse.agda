...
------------------------------------------------------------------------
-- Pūrvatrāsiddham — the tripādī as a tower of maps, and the fiber as the
...
-- three operational sūtras.  He proves no theorem below.  The fiber-
...
-- non-contractible fiber — are mine, and they are a reading of what
...
-- SummedOverTheFirstAndTheAreasAdd.शेष` decomposes the fiber of a
...
--   `तन्तुभेदः`.  So the fiber is not a metaphor for the invisible part —
...
-- identified as the fiber and localised to a named sūtra.  If that is
...
------------------------------------------------------------------------
-- ४.  THE FIBER.  Two forms that 8.2.39 tells apart and the later rules
...
------------------------------------------------------------------------
-- ६.  THE CONVERSE, in general.  Fiber-constancy plus a section is enough
--     to descend, and contractible fibers are enough on their own.  These
--     are what make §५ content: the obstruction is the fiber and nothing
--     else.
------------------------------------------------------------------------
