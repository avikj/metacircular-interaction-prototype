...
--       — the fibre's cardinality, `card (fiber f b)` — but not the
...
module TheProjectionsFibreCensusIsTheDiscardedFactorAndTheAbhijnanaIsSupplied where
...
import TheFibreOfAProjectionIsTheDiscardedFactor as प्र
import TheFibreOfAFiniteSourceMapIsFiniteAndItsCardinalityIsTheReceipt as स
