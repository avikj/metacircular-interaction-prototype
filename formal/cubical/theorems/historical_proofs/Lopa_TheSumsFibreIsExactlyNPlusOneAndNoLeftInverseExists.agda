...
-- element conditioned.  ¬ß‡© below is that recording, as a fibre.
--
-- ‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î‚î
...
--  ¬ß‡©  The three verdicts of `Avaccheda_‚¶` / `Tantujala_‚¶`, all three
...
import Avaccheda_TheCutsBoundaryIsTheBaseAndMemoryIsTheFibreFailingToBeContractible as ‡§Ö‡§µ

------------------------------------------------------------------------
-- ‡ß ¬ ‡‡æ‡¶‡æ‡‡‡Æ‡‡Ø‡Æ‡ ‚î the fibre of the sum IS the antidiagonal.
--
