...
-- विरहाङ्क's; the naming honours whose fiber and whose count each half is.
...
-- fibers, and hence the count for विरहाङ्क's encoding.
--
...
------------------------------------------------------------------------
-- §३  The bridge of fibers.  The witness of each fiber is a proposition
...
--     (matraCount, transported, not re-proved) to give विरहाङ्क's fiber
