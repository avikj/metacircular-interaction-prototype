...
--
-- (The stra states, in §6, that in transport the structure is carried and
...
--       `TheRetractionTypeIsTheHLevelHypothesis.agda`.
...
--   ShabdeJivahVartante.agda — §४, §५, §६ of the सूत्र-विस्तार.
--   TheRetractionTypeIsTheHLevelHypothesis.agda and
...
module TransportCarriesStructureAndTruncationIsTransportExactlyWhenNothingWasThereToLose where
...
open import ShabdeJivahVartante
...
--
--     TheRetractionTypeIsTheHLevelHypothesis.agda §3–§4
--
