...
-- `TheCompositionOfVerdicts.agda`, and
...
module ThePositionsCarryTheirNayasAndTheResidueSeedsTheNext where
...
open import CollapseIffEveryNayaAgrees
  using (AllNayasAgree)
...
-- `CollapseIffEveryNayaAgrees`, collapse is
...
-- §7  The price, checked.
--
-- क्रम-विनिमयः (`TheCompositionOfVerdicts.agda`, and
