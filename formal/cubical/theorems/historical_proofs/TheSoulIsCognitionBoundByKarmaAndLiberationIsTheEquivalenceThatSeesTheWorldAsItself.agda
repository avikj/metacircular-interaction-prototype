...
module TheSoulIsCognitionBoundByKarmaAndLiberationIsTheEquivalenceThatSeesTheWorldAsItself where
...
import ThePureMindLosesNothingAndMissesNothingWhichIsTheEquivalence as K
