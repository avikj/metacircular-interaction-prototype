...
module TheSharedSecretIsPingalasPowerCommutingWithItselfAndItsSecrecyIsTheInverseShorBreaks where
...
--     inverse is Shor's territory (Bijamula §4).
--
