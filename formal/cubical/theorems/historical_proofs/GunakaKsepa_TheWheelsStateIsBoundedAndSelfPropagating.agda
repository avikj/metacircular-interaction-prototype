...
--     not name which, and the next ������ is then not a function of the
...
--     import uses the v0.5 name `solve` where v0.9 has `solve�!`.  That
...
--   * §5 is over �, and the reactor divides by |k| and then takes
