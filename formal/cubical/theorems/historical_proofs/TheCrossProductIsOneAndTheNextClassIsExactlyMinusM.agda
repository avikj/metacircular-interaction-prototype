...
-- label, introduced by
-- `TheWheelsStateIsBoundedAndSelfPropagating`, not a source term.
--
-- No pulverizer run is
-- needed: gcd(b', k') = 1 is a CONSEQUENCE of the step's own three exact
-- divisions, with both Bézout coefficients written out of a, b, a', b'.
--
...
module TheCrossProductIsOneAndTheNextClassIsExactlyMinusM where
...
open import TheWheelsStateIsBoundedAndSelfPropagating
