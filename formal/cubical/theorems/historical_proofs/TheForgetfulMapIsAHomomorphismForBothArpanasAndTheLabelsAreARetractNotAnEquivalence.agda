...
--
--   `Saptabhangi.agda` + `TheCompositionOfVerdicts.agda`
...
module TheForgetfulMapIsAHomomorphismForBothArpanasAndTheLabelsAreARetractNotAnEquivalence where
...
import TheCompositionOfVerdicts as LA
import ThePositionsCarryTheirNayasAndTheResidueSeedsTheNext as G
