...
-- as the grammarians' metalanguage (~500 BCE).  The word is taken for what it names — a thing that keeps holding
-- once it holds.
--
...
module AnObserverSeesALawExactlyWhenItsClassIsACongruenceAndThenItCarriesForward where
