...
-- `TheExactDivisionCarriesItsWitnessAndSixTurnsReachOneAtSixtyOne
...
module ThePellFibreIsInfiniteAndBrahmaguptasCompositionIsTheWitness where
...
open import TheCompositionOrbitStrictlyGrowsSoItNeverReturnsAndThatIsTheGenerativity
