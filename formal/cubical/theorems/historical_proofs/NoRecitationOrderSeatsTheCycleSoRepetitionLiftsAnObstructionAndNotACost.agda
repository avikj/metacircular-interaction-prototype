...
--     `TheAttestedTrioForcesATwiceRecitedSoundAndPaninisChoiceIsHa`.
--
-- Every claim is `refl`.
------------------------------------------------------------------------

module NoRecitationOrderSeatsTheCycleSoRepetitionLiftsAnObstructionAndNotACost where
...
-- `OneAnubandhaCarriesEveryFreshStartSuffixSoAChainCostsOneMarker`:
