...
--     PairComposition.interchange           (Brahmagupta's bhāvanā, split legs)
--
--   (a + b) + (c + d) ≡ (a + c) + (b + d)
...
-- independently: सङ्घातः at (ℕ,·) IS PairComposition.prod, ⊛ IS its
...
--   · PairComposition enters from भावना, where the medial step is used
