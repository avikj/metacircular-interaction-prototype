...
module TheDoubledSoundCouldHaveBeenAnyOfThreeAndTheFullClassesRestrictItToHaAlone where
...
open import TheAttestedTrioForcesATwiceRecitedSoundAndPaninisChoiceIsHa
