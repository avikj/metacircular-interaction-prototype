...
module TheGeneralSeriesAtOneAndOneIsTheSankalitaAndTheExampleWasStandingForIt where
...
open import AryabhatasSeriesSumsAndTheCubeSumIsTheSquareOfTheSum using (∑ ; द्विगुण-सङ्कलितम्)
