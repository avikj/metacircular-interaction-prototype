...
-- , used here for the slice: "over B".  संरक्षक, प्रवाह, गण, समूह,
...
-- The compound आत्मसमता-उपरि is BUILT HERE; no source states
-- anything below.
------------------------------------------------------------------------

module TheStoredInverseIsExactlyInvertibilityAndTheSymmetryGroupIsAutOverB where
...
open import TheSymmetryLivesInTheFibreAndWithoutALossThereIsNoSymmetry
  using (संरक्षणम्)
open import TheZeroDivisorEdgeIsPricedAtItsWholeDomainAndTotalLossIsExactlyTotalSymmetry
  using (सर्व-नाशः)
open import TheOrbitRelationIsAlreadyAnEquivalenceWithoutAnInverseAndTheChargeDescendsToTheQuotient
  using (व्युत्क्रम-संरक्षणम्)
open import TheConservingFlowsOfAnyObservableAreTheSectionsOfItsOwnFibres
  using (ध्रुव-बिन्दुः)
open import TheConservingFlowsFormAGanaAndTheSectionIdentificationPreservesItByRefl
  using (प्रवाहः ; _∘प्र_ ; एकः ; module गणे)
open import TheInvertibleConservingFlowsAreTheSymmetryGroupAndTotalLossMakesItAllOfAut
  using (module समूहे)
open import TheConservingFlowsAreAMonoidNotAGroupSoNoethersFirstTheoremDoesNotTransfer
  using (अन्ध ; चूर्ण)
