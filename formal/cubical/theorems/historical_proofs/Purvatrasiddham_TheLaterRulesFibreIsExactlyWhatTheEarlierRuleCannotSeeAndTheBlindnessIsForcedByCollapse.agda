...
------------------------------------------------------------------------
-- Prvatrsiddham � the tripd as a tower of maps, and the fibre as the
...
--
--   8.2.1   ����������������  prvatrsiddham � from this stra to the end of
...
--           backwards.
--   8.2.30  ���� ����  co ku � cU becomes kU at pada-end.
--   8.2.39  ���� ���������  jhal jao 'nte � jhaL becomes ja at pada-end.
--   8.4.56  ��������  v'vasne � jhaL becomes caR in pause.
--
...
--
--   A rule earlier in the tripd is applied to the form as it stood when
...
--   there.  `������������` proves that: there is NO Bool-valued function on
...
--   `���������`.  So the fibre is not a metaphor for the invisible part �
...
--   content rather than an accident: `�������������` shows that if every
--   fibre is contractible then EVERY predicate descends, so asiddhatva
--   would be doing nothing.  Hence `��������������`: the necessity of 8.2.1
...
-- identified as the fibre and localised to a named stra.  If that is
...
------------------------------------------------------------------------
-- �.  The carrier and its separation.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- �.  THE FIBRE.  Two forms that 8.2.39 tells apart and the later rules
...
------------------------------------------------------------------------
-- �.  THE CONVERSE, in general.  Fibre-constancy plus a section is enough
--     to descend, and contractible fibres are enough on their own.  These
--     are what make §� content: the obstruction is the fibre and nothing
--     else.
------------------------------------------------------------------------
...
--     rule collapses.  This is derived; it is not a restatement of §�.
------------------------------------------------------------------------
...
--
-- It does not say 8.2.1 is derivable from the collapse.  §� gives one
...
--
-- It does not model 6.4.22 ����������������, the simultaneous regime.  That
