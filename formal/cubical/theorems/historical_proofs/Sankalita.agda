...
------------------------------------------------------------------------
-- Sankalita — the Kerala vārasaṅkalita engine (root Sankalita_… is Āryabhaṭa's series sums)
--
...
-- small n.  The reason the natural encoding does not close it is worth
-- recording so the next attempt does not repeat it.
--
