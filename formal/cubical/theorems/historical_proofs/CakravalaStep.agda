...
-- ────────────────────────────────────────────────────────────────────
--
-- Those are the substance of the method and none of them is a ring
-- identity. This file proves the invariant is preserved by one step,
-- which is the part that is algebra, and says so.
--
