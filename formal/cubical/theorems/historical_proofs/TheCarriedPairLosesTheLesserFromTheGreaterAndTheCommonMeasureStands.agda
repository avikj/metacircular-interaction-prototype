...
-- and `TheValliIsFiniteForEveryPair` (termination, and the
...
--    machine executes them.  `TheValliIsFiniteForEveryPair`
...
module TheCarriedPairLosesTheLesserFromTheGreaterAndTheCommonMeasureStands where
