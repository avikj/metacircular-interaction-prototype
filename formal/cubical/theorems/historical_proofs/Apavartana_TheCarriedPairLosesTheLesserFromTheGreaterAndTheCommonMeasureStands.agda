...
-- worked in BHSKARA II, *����������* (1150 CE).  This citation is taken from
...
--    and says nothing about which n reaches ��.  §5's two runs are `refl` � the
...
--
-- The name is a compound BUILT HERE (�����, difference, + ����, making); it is
