...
--     over `List Bool` weighted ������(true)=1, ������(false)=2, and
...
-- through, not re-proved � supplies exactly the count ���������� declined:
--     fiber ����� n � Fin (matra n).
--
...
module MatraSetu_TheVirahankaFibreCountsAsFinByBridgingToPingalasMetre where
...
open import Virahanka_TheMatraFibreSatisfiesTheTwoStepRecurrence using (छन्दः)
...
------------------------------------------------------------------------
-- §�  The bridge of fibres.  The witness of each fibre is a proposition
...
--     (matraCount, transported, not re-proved) to give ����������'s fibre
