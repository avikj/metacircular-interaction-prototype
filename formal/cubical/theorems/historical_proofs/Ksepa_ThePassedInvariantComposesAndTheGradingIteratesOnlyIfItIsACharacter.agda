...
--
-- SOURCE AND DATE.  ������ (kepa, "the thrown-in", the additive) is
-- Brahmagupta's own term for the k in x² − N y² = k, and �����
-- (bhvan, "production, bringing-into-being") is his name for the
-- composition that multiplies it: ���������������������� ��.�����, 628 CE.
-- The identity itself is checked over a commutative ring in
-- `Composition.agda` and subtraction-free over � in `CompositionSemiring.agda`;
-- it is NOT re-proved here.  The descent that ITERATES it is the
-- cakravla � Jayadeva ~950 CE, Bhskara II, ��������, 1150 CE.
--
...
-- part.  Fix a commutative monoid of frequencies (M, ⊕, �) and a
...
--
--   ������-�  the input halves always split off (middle-four; no hypothesis)
--   ������-�  "g x ⊗ g y depends only on x ⊕ y"  �  g is a character
--            twisted by g �
--   ������-�  �and conversely, so the two are one condition
--   ������-�  that condition MAKES the four-fold kernel iterate: it becomes
--            the product of two two-fold kernels times a factor of the
--            total frequency alone � which is what cakravla consumes
--   ������-�  and, under cancellation, iteration FORCES it back.
--
-- So iteration holds exactly when the grading is a character.  Brahmagupta
-- sits at g ≡ �, where the condition is free � and that freedom is the
