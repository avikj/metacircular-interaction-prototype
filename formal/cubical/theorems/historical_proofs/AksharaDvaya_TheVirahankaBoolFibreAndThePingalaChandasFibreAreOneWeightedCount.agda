...
------------------------------------------------------------------------
-- ������-������ � ���� ������, ���� ����, ����������� �
-- (akara-dvaya: "the pair of syllables" � two carriers, one weight,
--  one fibre.)
--
-- THE TERM, ITS TEXT AND ITS DATE.  ������ (syllable) is Pigala's atom in
-- the *Chandastra* (~300 BCE): a metre is a row of ��������, each ����
-- (light, 1 ������) or ����� (heavy, 2 ������).  Virahka,
-- *Vttajtisamuccaya* (c. 600�800 CE), ch. 6, counts ������-����� � metres
-- of a fixed total DURATION � and states the two-step recurrence for that
-- count.  Both traditions weigh the same atom the same way (���� = 1,
-- ����� = 2); the two ways of writing the row down are the only difference.
--
-- Nothing here is re-proved that the corpus already proved: the recurrence
-- is `V.����������-��������`, transported, not restated.
--
-- ���������� : ���������, �������������� (~��� ��.��.) � ������, ����, �����, ������ �
--            �����������, ����������������� (~��� ��.) � ������-�����-�������� �
--
...
------------------------------------------------------------------------
-- � � the seam Bool � ������, laghu � true, guru � false.
------------------------------------------------------------------------
...
-- Bool row equals Pigala's ������ (Matramerus) on the translated ������.
-- (����/true both cost 1, �����/false both cost 2 � the whole content.)
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � the identification of the fibres.  Both witness families land in �,
-- a set, so the fibre condition is a proposition and �≡Prop closes each
...
------------------------------------------------------------------------
-- � � the payoff � the receipt is a channel.  Virahka's recurrence,
...
-- the recurrence is re-proved: V.����������-�������� is transported, not
-- restated.
------------------------------------------------------------------------
