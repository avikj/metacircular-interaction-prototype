...
--     on ONE item: that is vipratiedha.  That is the configuration §1 is
...
module TheBornStandpointDecidesAndAssertsOnlyWhatAllAsserted where
...
-- much alone: §1 alone is a tie-breaker in , and §2 alone is the
