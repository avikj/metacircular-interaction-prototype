...
--
--   NaturalMachine.ParitySeparator.sgn  : ℕ → Bool   (the sieve barrier)
--       sgn zero = true ; sgn (suc n) = not (sgn n)
--       group operation `_·_` : true · b = b ; false · b = not b
--
--   NaturalMachine.ChargeGrading.parity : ℕ → Bool   (the charge grading)
...
import NaturalMachine.ParitySeparator as PS
import NaturalMachine.ChargeGrading   as CG
