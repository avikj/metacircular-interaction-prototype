...
module SourcedProofs.AtmasamataUpari_TheStoredInverseIsExactlyInvertibilityAndTheSymmetryGroupIsAutOverB where
...
open import SvaTantuVasa_TheConservingFlowsOfAnyObservableAreTheSectionsOfItsOwnFibres
  using (ध्रुव-बिन्दुः)
open import SourcedProofs.SamraksakaGana_TheConservingFlowsFormAGanaAndTheSectionIdentificationPreservesItByRefl
  using (प्रवाहः ; _∘प्र_ ; एकः ; module गणे)
open import SourcedProofs.SamraksakaSamuha_TheInvertibleConservingFlowsAreTheSymmetryGroupAndTotalLossMakesItAllOfAut
  using (module समूहे)
