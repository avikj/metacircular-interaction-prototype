...
module SourcedProofs.MatraSetu_TheVirahankaFibreCountsAsFinByBridgingToPingalasMetre where
...
open import SourcedProofs.Virahanka_TheMatraFibreSatisfiesTheTwoStepRecurrence using (छन्दः)
