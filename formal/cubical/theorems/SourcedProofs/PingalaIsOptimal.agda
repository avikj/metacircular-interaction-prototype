...
module SourcedProofs.PingalaIsOptimal where
...
open import SourcedProofs.PingalaPrastara using (Vak ; sankhya ; uddistaIso ; Metre ; matra ; matraCount ; matraRecurrence)
