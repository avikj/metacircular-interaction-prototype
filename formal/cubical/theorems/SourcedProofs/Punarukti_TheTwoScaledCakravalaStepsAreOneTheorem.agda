...
module SourcedProofs.Punarukti_TheTwoScaledCakravalaStepsAreOneTheorem where
...
import SourcedProofs.Cakravala as NMC
...
module Bridge (CR : CommRing ℓ) where
  ...
  open SourcedProofs.Bhavana.Form CR using (R ; N)
  open SourcedProofs.CakravalaDescent.Descent CR using (cakravalaScaled)
