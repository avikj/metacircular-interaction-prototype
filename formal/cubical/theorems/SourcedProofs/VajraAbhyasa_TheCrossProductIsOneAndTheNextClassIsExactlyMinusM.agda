...
module SourcedProofs.VajraAbhyasa_TheCrossProductIsOneAndTheNextClassIsExactlyMinusM where
...
open import SourcedProofs.Bhavana using (module Form)
open import SourcedProofs.CakravalaDescent using (module Descent)
open import SourcedProofs.GunakaKsepa_TheWheelsStateIsBoundedAndSelfPropagating
