...
-- `SourcedProofs.Vyatyasa_…`, which states its own limits.  वर्ग · varga — square.
...
--
--   `Kernel.Ankapasa_…` §4 gives the kernel a univalent semantics and
...
--
--   `SourcedProofs.Vyatyasa_…` §4 proves σ² = id and `ua`-triviality of the doubled
...
module SourcedProofs.VyatyasaVarga_TheKernelsOwnCrossingSquaresToReflSoItsHolonomyGroupIsExactlyZModTwo where
...
open import Kernel.RewriteCertificate using (Tm ; var ; add)
