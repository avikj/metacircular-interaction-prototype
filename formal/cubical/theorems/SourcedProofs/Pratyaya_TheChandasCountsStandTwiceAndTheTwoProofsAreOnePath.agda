...
module SourcedProofs.Pratyaya_TheChandasCountsStandTwiceAndTheTwoProofsAreOnePath where
...
open import SourcedProofs.PingalaPrastara using (matra ; Pattern ; matraOf ; varna ; guruOf)
