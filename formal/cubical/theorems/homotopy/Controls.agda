...
--              the equivalence � � Word without canonicity.  It must
...
open import Endian k using (w01 ; w01-canonical ; v1 ; value-v1)
...
-- wording asserted `� � Word` itself is false, which C1 does not prove.)
------------------------------------------------------------------------
