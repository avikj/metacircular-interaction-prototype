...
--   standpoint-set the garbha ����������� has NO elements at all, while the
...
--     ������� and proves NOTHING about either.  Akalaka's krama/saha
...
--
--     `SaptabhangiGarbha_�.����������� P` is not a third
...
--   * That the garbha ����������� is NEVER seven.  For particular P it may
