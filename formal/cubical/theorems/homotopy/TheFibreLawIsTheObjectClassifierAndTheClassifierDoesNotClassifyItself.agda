...
--
-- `FiveCollapsesOneTheoremAndEachTraditionSaysItInItsOwnWords`
...
-- What is contributed here is the IDENTIFICATION — that the corpus's
...
-- corpus reads it (README §I): to refute descent it suffices to exhibit one
...
module TheFibreLawIsTheObjectClassifierAndTheClassifierDoesNotClassifyItself where
...
open import EveryMapIsTheSumOfItsFibresOverItsCodomainSoTheIsomorphismTheoremIsAnekanta
  using (सर्वविभागः)
