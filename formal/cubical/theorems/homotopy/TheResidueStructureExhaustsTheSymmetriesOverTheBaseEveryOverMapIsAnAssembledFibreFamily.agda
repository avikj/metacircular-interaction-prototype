...
--       the total space that is over the base BY REFL (-kriy,
--       rdhva-refl): residue structure acts above, for free.
--
--   §2  Every endomap over the base IS such an assembly, pointwise
--       (sarva): from the over-ness witness, the residue family is
--       extracted (pratyhra) and the original map is recovered at
...
module TheResidueStructureExhaustsTheSymmetriesOverTheBaseEveryOverMapIsAnAssembledFibreFamily where
