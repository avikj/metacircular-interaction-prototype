...
--
-- �������� � ����� � the Jaina enumerative tradition graded quantity into
-- three ������� (kinds): �������� (sakhyta, "numerable" � the finite counts),
-- ��������� (asakhyta, "innumerable"), and ����� (ananta, "endless").  The
-- taxonomy is set out in the **Anuyogadvra-stra** (���������� canon,
-- redaction c. 1st�5th c. CE) and the **Sthnga-stra**; the three-fold
-- kind-division underlies Umsvti's **Tattvrtha-stra** (c. 2nd�5th c. CE).
...
------------------------------------------------------------------------
-- §�  ���-���������� � the one absorption step: a single unit adjoined to
-- the countably-infinite � returns �.  ��(the adjoined unit), (n+1)�n.
...
------------------------------------------------------------------------
-- §�  ��������-������ � k numerable units prepended to a type.  `��� k �`
-- is exactly `Fin k � �` written without importing Fin: the finite,
...
------------------------------------------------------------------------
-- §�  �����-������ � ananta is undiminished: adjoining ANY numerable k
-- to the countably-infinite � returns �.  Induction on k, base = idIso,
-- step = (�Iso on the tail) then the one absorption step of §�.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- §�  the single-unit instance is the special case k = 1, so §� is not a
