...
-- formalised in `ArityOfRepair`, which imports this module's A∞ for
-- the "escapes Theorem A" half. * §4.2's refutation of nilpotence is
-- formalised in its ABSTRACT form only (3 above: finite branching does
-- not bound length). The note gives no space-level counterexample
-- beyond the citation that spheres are nilpotent with non-terminating
-- Postnikov towers, and that is not formalisable here.
------------------------------------------------------------------------
