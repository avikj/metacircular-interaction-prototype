...
------------------------------------------------------------------------
-- ������� � THE HOUSE ROBBER DYNAMIC PROGRAM IS OPTIMAL: ATTAINED AND
-- UNBEATABLE.
--
...
--   � attain (� s , value s ≡ rob xs)         � the program's number is
...
-- the library's �-based `_�_`, so transitivity and monotonicity are the
