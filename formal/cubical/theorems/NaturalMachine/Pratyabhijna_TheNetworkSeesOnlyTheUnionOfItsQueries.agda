...
------------------------------------------------------------------------
-- NaturalMachine.Pratyabhijna_TheNetworkSeesOnlyTheUnionOfItsQueries
--
...
--
-- §1  POOLING VALIDATORS ADDS NOTHING.  `NaturalMachine.QuotientFiberLaw`
...
module NaturalMachine.Pratyabhijna_TheNetworkSeesOnlyTheUnionOfItsQueries where
