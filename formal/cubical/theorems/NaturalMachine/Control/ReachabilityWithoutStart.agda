...
------------------------------------------------------------------------
-- NaturalMachine.Control.ReachabilityWithoutStart
--
...
-- `NaturalMachine.ReachableFromStart.closed-from-start` with its
...
module NaturalMachine.Control.ReachabilityWithoutStart where

open import Cubical.Foundations.Prelude
open import Cubical.Data.Bool using (Bool)
open import Cubical.Data.List using (List)

open import NaturalMachine.ReachableFromStart
