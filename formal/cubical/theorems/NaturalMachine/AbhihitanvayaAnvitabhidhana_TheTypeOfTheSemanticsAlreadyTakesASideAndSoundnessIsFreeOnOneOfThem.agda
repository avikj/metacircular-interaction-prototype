...
------------------------------------------------------------------------
-- NaturalMachine.AbhihitanvayaAnvitabhidhana_
...
module NaturalMachine.AbhihitanvayaAnvitabhidhana_TheTypeOfTheSemanticsAlreadyTakesASideAndSoundnessIsFreeOnOneOfThem where

open import Cubical.Foundations.Prelude
open import Cubical.Data.Sigma using (Σ-syntax ; _×_ ; _,_ ; fst ; snd)
open import Cubical.Relation.Nullary using (¬_)

open import NaturalMachine.FullAbstractionIsAConditionOnTheContextFamilyAndCurvatureIsWitnessedInIt
