...
module NaturalMachine.TheTwoSidedCutNeedsNoInfinityBecauseTheEmptyMeetIsZero where
...
open import NaturalMachine.TheTwoSidedProfileCutNeedsTheBurdensAsAProfile
  using (dnV ; goFwdV ; goBwdV ; maxP ; maxP-⊑ˡ ; maxP-⊑ʳ ; maxP-least
        ; Rows ; UpP)
open import NaturalMachine.TheTwoSidedCutExistsOverANonEmptyResidualIndex
  using (_≼p_)
