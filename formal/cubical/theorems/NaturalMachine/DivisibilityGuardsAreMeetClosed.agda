...
------------------------------------------------------------------------
-- NaturalMachine.DivisibilityGuardsAreMeetClosed
--
...
-- `NaturalMachine.PermanentUnsaidIsStableAndTemporaryIsASearch`, met
...
module NaturalMachine.DivisibilityGuardsAreMeetClosed where
