...
module NaturalMachine.TheTower where
...
open import NaturalMachine.Laghava using (laghava-collision)
open import NaturalMachine.Anuvrtti using (anuvrtti-collision)
open import NaturalMachine.Pratyahara using (no-order-makes-all-intervals)
