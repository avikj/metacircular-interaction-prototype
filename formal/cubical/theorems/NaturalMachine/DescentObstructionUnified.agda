...
------------------------------------------------------------------------
-- NaturalMachine.DescentObstructionUnified
--
...
-- `ProjectionChargeAudit` and `NaturalMachine.SieveFiber`, since §2.3
-- instantiates against them.  `--safe`, no postulates, no holes.
------------------------------------------------------------------------

module NaturalMachine.DescentObstructionUnified where
