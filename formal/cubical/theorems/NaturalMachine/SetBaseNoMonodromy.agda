...
------------------------------------------------------------------------
-- NaturalMachine.SetBaseNoMonodromy
--
...
--
-- `NaturalMachine.PerspectiveCore` supplies the type to inhabit,
--
...
module NaturalMachine.SetBaseNoMonodromy where
...
open import NaturalMachine.SieveFiber using (Vis ; isSetVis ; Sieve)
