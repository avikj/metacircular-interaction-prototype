...
--
-- `NaturalMachine.Durnaya_CollapseIffEveryNayaAgrees` replaced the struck
-- exhaustiveness gloss of `NaturalMachine.Anekanta` §5 with
--
...
module NaturalMachine.Durnaya_TheProhibitionHasContentOnlyOffThePropositionalWorld where
