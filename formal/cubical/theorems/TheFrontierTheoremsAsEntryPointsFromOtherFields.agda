...
------------------------------------------------------------------------
-- TheFrontierTheoremsAsEntryPointsFromOtherFields
--
...
module TheFrontierTheoremsAsEntryPointsFromOtherFields where

-- cryptography & economics
open import TheReceiptIsSpentAtGenerationAndTheReplayNeedsNone
  using (replay-needs-no-receipt ; replay-is-sound) public
open import ProofOfTransportIsTheReceiptThatComposesWithoutBeingSpentAndOwesNoCounterparty
  using (Receipt ; सन्धानम् ; अक्षयः ; अनृणम् ; व्ययरहितः) public

-- quantum computing
open import TheSwapHasNoSquareRootOnTheSetSoTheQubitIsForced
  using (√NOT-does-not-exist ; ff-true) public
open import TheThreeStrandBraidIsNonAbelianAndSatisfiesTheBraidRelation
  using (braids-dont-commute ; yang-baxter) public
open import TheFibonacciAnyonFusionDimensionIsVirahankasMetreCount
...
open import TheOrbGateIsTheAchromaticLosslessSquareRootOfNot
  using (√NOT-EXISTS-here ; full-turn ; achromatic) public
open import TheAxisQuarterWavesAreQuaternionsNonAbelianAndTheQubitIsASpinor
  using (ij≢ji ; full-turn-is-minus-one ; double-turn-returns) public
open import TheEntanglingGateIsLosslessButDoesNotFactorIntoSingleQubitGates
...
open import TheNonabelianHolonomyS3IsABraidRepAndTheOrbWindingIsTheCircuit
