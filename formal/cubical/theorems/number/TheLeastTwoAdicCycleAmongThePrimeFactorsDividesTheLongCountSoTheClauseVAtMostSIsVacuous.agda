...
------------------------------------------------------------------------
-- TheLeastTwoAdicCycleAmongThePrimeFactorsDividesTheLongCountSoTheClauseVAtMostSIsVacuous
--
...
module TheLeastTwoAdicCycleAmongThePrimeFactorsDividesTheLongCountSoTheClauseVAtMostSIsVacuous where
...
open import TheFirmFactorisationIsUniqueTwoPrimeListsWithOneProductAreAPermutationSoTheValuationIsWellDefinedAndPermIsExactlySameCount
  using (मानम्)
open import EveryPositiveIntegerIsAPrimePowerTimesAPrimeFreeRestTheExponentIsTheValuationAndTheValuationAddsOverProducts
