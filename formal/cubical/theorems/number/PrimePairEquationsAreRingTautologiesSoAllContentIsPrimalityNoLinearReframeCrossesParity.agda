...
--   diff-recovers      and invertible over �[½] � sum and difference of
...
--
-- SYT � THE CLAIM, EXACTLY.  The four ring identities, for all w, r.
...
-- The centering basis is linear and invertible (over �[½]): the walls'
