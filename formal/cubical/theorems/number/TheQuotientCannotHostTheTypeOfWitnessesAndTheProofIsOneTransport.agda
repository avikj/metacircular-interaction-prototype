...
-- built here.
--
-- The "dependent novelty" generalization अवतरण-भङ्ग-सामान्यम् — the
...
module TheQuotientCannotHostTheTypeOfWitnessesAndTheProofIsOneTransport where
...
import TheLawOfSuccessionDoesNotFactorThroughTheCarrier as K
