...
--
-- That is a statement about cost, and the corpus's cost results live
-- in theorems/cost; this file supplies the arithmetic the reduction
-- needs and nothing about the price of running it.
--
