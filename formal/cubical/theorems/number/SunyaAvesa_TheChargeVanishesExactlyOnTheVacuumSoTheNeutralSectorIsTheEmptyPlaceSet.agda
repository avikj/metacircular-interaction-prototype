...
--
-- �����-����� � the charge is zero.  Written with holes and composed in
...
--
--   ������-������    λ² = 1 � the parity character squares to the unit, so it
--                   is never zero and multiplying by it is invertible
--   ����-��������   charge � λ = − Ω � the parity cancels and the magnitude
--                   is the active-place count, on the nose
--   �����-����� /   the charge is zero EXACTLY on the empty place set, both
--   ����-������     directions
--
...
--
-- HOW.  Written with holes, loaded warm through ����, the kernel naming its
-- ��������; each filler proposed with `give` and accepted live before it was
