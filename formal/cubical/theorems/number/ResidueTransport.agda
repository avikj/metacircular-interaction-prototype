...
------------------------------------------------------------------------
-- Residue observations are capabilities above the atomic � core.
--
-- This file deliberately contains no second arithmetic engine.  Any already
-- established residue/CRT observation is just a map out of �.  Compilation
-- along the existing � � CanWord chart makes it executable on generated digit
-- words; replay reduces to the already-proved odometer round trip.
------------------------------------------------------------------------

open import Cubical.Data.Nat using (ℕ)

module ResidueTransport (k : ℕ) where
...
-- needs a cost-annotated evaluation judgment (Eval : Observation A � � � A �
