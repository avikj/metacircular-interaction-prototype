...
-- WHAT IS NOT: the multi-index case B_n = �_i V_{�_i} of the note's §1.
...
-- pair are naturals.  The reindexing {κ : κ � �} � {(κ,d) : κ+d = �} is
...
--
-- The multi-index module B_n = k[ξ�,�,ξ_m]/(ξ_i^{�_i+1}) = �_i V_{�_i}
