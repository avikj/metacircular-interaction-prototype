...
--
-- THE QUESTION:
-- classify ALL cone-preserving involutions of the pair
...
module TheConeStabiliserInTheFullLegGroupIsExactlyTheExchangeSoNoSymmetryCarriesGoldbachToTwins where
