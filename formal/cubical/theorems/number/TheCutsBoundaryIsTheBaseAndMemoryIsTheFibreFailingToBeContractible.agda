...
--
--  §२  "No memory" is `isEquiv f`, i.e. every fibre contractible.  Then
...
--      MEMORY IS THE FIBRE FAILING TO BE CONTRACTIBLE — and the failure
...
module TheCutsBoundaryIsTheBaseAndMemoryIsTheFibreFailingToBeContractible where
...
-- रिक्तम् : a profile no history induces.  ⊥ → Unit has empty fibre at tt.
