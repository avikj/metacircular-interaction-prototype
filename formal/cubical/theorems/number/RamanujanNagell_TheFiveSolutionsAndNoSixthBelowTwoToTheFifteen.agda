...
------------------------------------------------------------------------
-- ����������������� � THE FIVE SOLUTIONS, AND NO SIXTH BELOW 2��.
--
-- Ramanujan asked (J. Indian Math. Soc., 1913): when is 2� − 7 a
-- perfect square?  He listed n = 3, 4, 5, 7, 15 � squares 1, 9, 25,
-- 121, 32761 � and conjectured there are no others.  Nagell proved
-- the full conjecture in 1948 in �[�−2]; that argument is beyond
...
--     (x² + 7 ≡ 2�), each by refl; the famous 181² + 7 ≡ 32768
--     among them.
--
--   `ramanujan-nagell-below-15` � THERE IS NO SIXTH SOLUTION with
--     n � 15: every pair (n, x) with x² + 7 ≡ 2� and n � 15 is one
...
-- Every solution of x² + 7 = 2� with n � 15 is one of Ramanujan's
