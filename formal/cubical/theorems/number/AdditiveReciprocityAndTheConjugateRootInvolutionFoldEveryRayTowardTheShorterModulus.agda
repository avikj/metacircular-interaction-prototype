...
--     fenced).
--
-- Analytic consequence (a reading, needs ℝ): the causal
...
module AdditiveReciprocityAndTheConjugateRootInvolutionFoldEveryRayTowardTheShorterModulus where
...
open import TheWallOrientationsAreSquareRootsOfOneBuiltFromFactorizationsByTheKloostermanReciprocal
