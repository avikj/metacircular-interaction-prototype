...
------------------------------------------------------------------------
-- ADivisorOfAUnitInTheIntegersIsPlusOrMinusOneSoTheStandardConvergentsAreInLowestTerms
--
-- The classification of units of ℤ (a divisor of ±1 is ±1), and its
...
module ADivisorOfAUnitInTheIntegersIsPlusOrMinusOneSoTheStandardConvergentsAreInLowestTerms where
