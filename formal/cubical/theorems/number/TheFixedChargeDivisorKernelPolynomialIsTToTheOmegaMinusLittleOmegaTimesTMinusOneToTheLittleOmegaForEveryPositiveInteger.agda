...
------------------------------------------------------------------------
-- TheFixedChargeDivisorKernelPolynomialIsTToTheOmegaMinusLittleOmegaTimesTMinusOneToTheLittleOmegaForEveryPositiveInteger
--
...
module TheFixedChargeDivisorKernelPolynomialIsTToTheOmegaMinusLittleOmegaTimesTMinusOneToTheLittleOmegaForEveryPositiveInteger where
...
open import TheDivisorSumOfMobiusTimesCofactorIsEulersTotientForEveryPositiveInteger
  using (eqb-dec ; eqb-refl ; eqb-≢ ; leb-dec ; leb-≤ ; if-true ; if-false
        ...
        ; if-and ; addN≡+ ; pos-if)
open import TheFirmNumbersProductIsEveryPositiveIntegerAndTheirMembershipIsDecidedByDivision
  using (दृढम् ; वधः ; सर्वे ; विभाजनम् ; युक्लिड-वाक्यम् ; वध-++ ; सर्वे-++)
open import TheFirmFactorisationIsUniqueTwoPrimeListsWithOneProductAreAPermutationSoTheValuationIsWellDefinedAndPermIsExactlySameCount
