...
--
--     TheEngineNeverTouchesTheMeaning.eqℕ-sound
--     Obstruction.eqℕ→≡
--
...
module TheThirdTesterWasFoundByCensusAndTheChannelPaysReflexivityAndCompleteness where
...
import TheEngineNeverTouchesTheMeaning as A
