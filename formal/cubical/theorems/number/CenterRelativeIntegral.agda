...
--
--
--  * **No valuations, no places, no adeles.**  §17.8's `s_�`/`d_�` are
--    the motivation and are NOT constructed here.  This file is about a
--    commutative ring; that the ring is `�` and the elements are
--    `v_�(p), v_�(q)` is a reading, not a term.  Program 17.23
--    (adelic formulation) is untouched.
--
--  * **T17.13 is not proved as stated.**  Delta 17 states an equivalence
--    of `�_{�0}²` with the cone `{(s,d) : s � |d|, s ≡ d mod 2}`.  The
...
-- `image-parity-diff`, `Q`, `�-preserves-Q`, `J�-negates-Q`) all exist
-- and match their header descriptions, and the "SYT � THE CLAIM, EXACTLY"
