...
--
-- ON THE NAME.  स्फटिक — crystal, rock-crystal — ordinary ,
...
module TheLocalCrystalIsDecidableTheWallsMergeExactlyWhenTwiceTheCenterVanishesAndTheCensusHoldsEitherWay where
...
open import TheTwoWallsElideTwoResiduesAndTheSurvivorsAreExactlyCounted
...
-- स्फटिकः decides by discreteFin on the WALLS; deciding on
