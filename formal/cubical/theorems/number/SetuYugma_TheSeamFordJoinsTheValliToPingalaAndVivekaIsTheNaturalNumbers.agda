...
--
--     ⟨lib⟩.�            component 5   (������, CanWord, Tally, Word, ��FinSet)
--     ⟨lib⟩.� � ⟨lib⟩.�   component 2   (������, ������-������, Carrier, �����-fibre)
--     ⟨lib⟩.Bool         component 1
--     ⟨lib⟩.Unit         component 6
--
-- So `LosslessReturn.������≡������` � the crown of the seed file � could not
-- reach � itself.  This ford joins components 2 and 5: +42 free crossings
-- from one classical bijection, which is ryabhaa's vall meeting
-- Pigala's metre.  A receipt's worth is m�n, not 1.
--
...
-- The compound ����-������ is built here, 2026-08-22.
--
