...
-- The induction ALONG the walk: WalkStream's single
...
--     (� over n gives plain reachability) but no reflexive-transitive
...
open import WalkStream using (installStream; 2≤→0<)
