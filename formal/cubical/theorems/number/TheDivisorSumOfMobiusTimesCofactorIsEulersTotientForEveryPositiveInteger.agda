...
------------------------------------------------------------------------
-- TheDivisorSumOfMobiusTimesCofactorIsEulersTotientForEveryPositiveInteger
--
-- The identification of the Möbius divisor sum with Euler's totient,
-- for every n ≥ 1, in the definitions of `TransmissionRefutations.agda`
...
module TheDivisorSumOfMobiusTimesCofactorIsEulersTotientForEveryPositiveInteger where
