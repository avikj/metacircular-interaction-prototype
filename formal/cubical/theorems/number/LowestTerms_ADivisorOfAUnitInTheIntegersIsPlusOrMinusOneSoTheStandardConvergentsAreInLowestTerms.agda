...
--
--   "SYĀT — THE CLAIM, EXACTLY.  The convergents being in lowest terms
--    needs "a divisor of ±1 in ℤ is ±1", a classification of units.  §2
--    stops exactly where the algebra stops: the common divisor divides a
--    unit."
--
-- WHAT IS PROVED HERE.
--
...
--
-- SCOPE.  "Lowest terms" here means precisely: every common divisor
