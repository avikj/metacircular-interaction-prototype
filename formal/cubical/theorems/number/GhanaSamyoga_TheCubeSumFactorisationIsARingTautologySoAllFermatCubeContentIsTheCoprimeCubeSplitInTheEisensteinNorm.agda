...
------------------------------------------------------------------------
-- ���������� � THE CUBE-SUM FACTORISATION IS A RING TAUTOLOGY, SO ALL THE
...
-- Eisenstein integers �[ω], ω a primitive cube root of unity, whose norm
...
-- norm multiplicative (Brahmagupta�Bhvan, at T=−1,C=−1).  So `Avatarana`'s
-- one debt `Descent` factors, precisely, as:
--
--   the tautological cube-sum split      (here, composition)
--   ∘ the coprimality of the two factors  (�/� gcd machinery, present)
--   ∘ CUBE-SPLIT in �[ω]                  (the one genuinely absent lemma)
...
--
-- SYT � THE CLAIM, EXACTLY.  One ring identity, for all x,y, over any
