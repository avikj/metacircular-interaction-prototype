...
------------------------------------------------------------------------
-- ���������, ������ � THE FIVE THRESHOLDS HOLD TO 50, AND EACH
-- MINIMALITY IS ONE REFUTATION.
--
-- Ramanujan's proof of Bertrand's postulate (1919) ends with a
-- sharpening Hardy called characteristic: �(x) − �(x/2) � 1, 2, 3,
...
-- Once x reaches R, demand �(half x) + k � �(x); before R, vacuous.
