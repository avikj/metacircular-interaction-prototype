...
-- ω² = −ω − 1; `TraceCompositionOverN` already proves this
...
module TheCubeSumFactorisationIsARingTautologySoAllFermatCubeContentIsTheCoprimeCubeSplitInTheEisensteinNorm where
