...
module ThePaperInOneModuleEveryClaimOneTerm where
...
open import TheTaxicabNumberBothRepresentationsByReflAndMinimalityByBoundedReflection
open import TheHouseIs204Of288TheBalanceIsThePellConditionAndTheMachineTurnedTheWheel
open import TheFiveSolutionsAndNoSixthBelowTwoToTheFifteen
open import OneHundredTwentyIsHighlyCompositeAndTheMemoirsColumnChecks
open import TheCongruenceInstancesWithCofactorsInHandAndTheGeneralTheoremNamed
open import TheQuadruplesAndTheNearMissesOfFermatByRefl
open import TheFiveThresholdsHoldTo50AndEachMinimalityIsOneRefutation
open import TheTauCongruenceInstancesWithTauDefinedByTheDeltaProductItself
open import TheEisensteinConvolutionIdentityInstancesByRefl
open import TheKernelScansBelowSevenTwentyOnceAndCachesTheVerdict
  using (Q ; Rep ; exc ; In17)
open import BelowSevenTwentyTheOddExceptionsAreExactlyHisSeventeenTowardTheOpenList
  using (listed-not-represented)
open import TheKernelScansBelowSevenTwentyOnceAndCachesTheVerdict
  using (represented-or-listed)
open import TheUniversalClaimIsATypeTheGateRestrictsItAndNoTermRunsBackwards
  using (RamanujanAssertion ; Gate720 ; the-gate-holds ;
         rep-decidable-below-720 ; exc18)
  renaming (restrict to restrict-ternary)
open import TheCountingFieldIsTheObjectTheBooleanIsItsSupportAndTheCollapseForgets
  using (rC ; the-boolean-is-the-support ; the-collapse-forgets)
open import TheSoundnessHalfOfTheOpenAssertionIsKernelSignedEntire
  using (the-eighteen-are-exceptions ; no-2719)
open import TheQuestionIsATypeTauIsTotalTheGateHoldsToSixteenAndNoConverseIsWritten
