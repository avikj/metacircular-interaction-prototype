...
--
-- This file is the step's IDENTITY, not the step's bookkeeping, and the
-- bookkeeping is where the signs live.  Termination and Bhskara's
-- minimality rule are `CakravalaDescent.agda`'s.
------------------------------------------------------------------------
