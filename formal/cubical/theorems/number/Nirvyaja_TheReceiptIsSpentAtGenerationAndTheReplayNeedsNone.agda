...
--
-- WHAT THIS CONTINUES.  `Interaction_‚¶` ¬ß1 built the first non-trivial
...
-- witness, an oracle token.  `Interaction_‚¶` ¬ß2 closed the learning loop:
...
-- (Interaction ¬ß0).  So the operation the machine LEARNS from a demanded turn is
...
-- here is asserted about markets; ¬ß2 is three lines and they typecheck.
--
