...
--
-- एकभार is built here; each face's instrument is its own
-- module's, imported, never copied.
------------------------------------------------------------------------

module TheWindingTheHolonomyTheCommutatorImageTheHiddenChargeAndTheParityTangentAreOneGenerator where
...
open import TheLossCanHideInTheLoopsAndTheSetLevelCensusCannotSeeIt
  using (गुह्य-भारः)
open import TheOrderOfStandpointsIsTheChargeItself
  using (क्रमः-लूप-प्रथमम्)
open import ThePrimeChargeIsTheTangentOfTheParityCharacterAndTheJetIsMultiplicative
  using (κ)
