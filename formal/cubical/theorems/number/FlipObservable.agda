...
--   ported read of the hidden payload.  mod/gcd/vall composition can
...
--   because ��� � {�1} � (1 + 4��) � the SIGN of a 2-adic unit is
...
------------------------------------------------------------------------
-- §2  The adic ladder of ports: h mod 2^w, Euclidean mod on �
------------------------------------------------------------------------

-- Euclidean remainder on � with modulus c : � (canonical residue in
...
-- sign of a 2-adic unit is its second bit (��� � {�1} � (1 + 4��))
...
------------------------------------------------------------------------
-- §3  The machine's term grammar (entry/mod/gcd/vall), as syntax
------------------------------------------------------------------------
