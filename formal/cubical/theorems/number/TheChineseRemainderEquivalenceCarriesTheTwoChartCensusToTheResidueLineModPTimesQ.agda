...
module TheChineseRemainderEquivalenceCarriesTheTwoChartCensusToTheResidueLineModPTimesQ where
...
open import TheTwoChartSurvivorCensusIsTheProductPMinusTwoTimesQMinusTwo
