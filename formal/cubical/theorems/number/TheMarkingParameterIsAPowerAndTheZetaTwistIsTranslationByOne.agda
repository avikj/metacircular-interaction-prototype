...
-- an individual prime.
module TheMarkingParameterIsAPowerAndTheZetaTwistIsTranslationByOne where
...
open import TheSquarefreeChargeIsTheActivePlaceCountTimesTheParityCharacter
  using (चिह्नम्; सक्रियम्; ओजः; पर्यायः; आवेशः)
open import TheWholeChargeIsTheFirstOrderTermOfOneRankOneProduct
  using (घातः; विवृत्तिः)
open import TheZetaTwistSendsTheMarkedChargeTowerToTheOmegaStratification
  using (निष्क्रियम्)
