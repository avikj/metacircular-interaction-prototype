...
--
-- �������-��������� � the tower under the light of �.
--
-- WHAT IS ASKED.  `EkaGhataVivrtti_...` defined ��������� bs k, the k-marked
...
--
-- The arithmetic's own duality at each place is the local � transform � the
...
--
--     �������  (the Mbius sign: −1 active, +1 inactive)  �  ������������ (1 inactive, 0 active)
--     ���������  (1 active, 0 inactive)                    �  ��������� (unchanged)
--
-- and therefore it sends level k of the tower to the INDICATOR that exactly
-- k places are active.  So:
--
--     the Mbius-signed k-marked prime charge is, under �, exactly the
...
--
-- Level 1 of the right-hand side is `��-������� (���� bs) 1` � one active
...
-- the �-dual of "exactly one prime divides", and level k is the �-dual of
...
--
-- The one place a reader could over-read: `��������` is the LOCAL twist, one
-- place at a time.  That it lifts along a product is used implicitly in the
-- shape of `�������-���������`'s recursion � the twisted tower is DEFINED with
