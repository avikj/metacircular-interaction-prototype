...
------------------------------------------------------------------------
-- ���������� � both wall fields are one after centering, and the two walls
...
--
-- ON THE NAME.  �������� (kendra) is the siddhntas' own technical term for
-- the anomaly � the angular coordinate measured FROM THE CENTER (a Greek
-- loan, κ�ν��ον, fully absorbed: Sryasiddhnta; Brahmagupta's
...
--
-- ���������, scope.  Exact and local: the affine normalization and the
-- wall dichotomy, over � with divisibility as data (�, untruncated).
...
------------------------------------------------------------------------
-- � � divisibility as data, and the universal two-wall field.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � �����-��������������� � Goldbach's two walls at N = m + m, centered.
...
------------------------------------------------------------------------
-- � � ���-��������������� � the twin walls n � 0, −2, centered at y = n + 1.
...
------------------------------------------------------------------------
-- � � the dichotomy: the walls coincide for every y iff p � a + a.
------------------------------------------------------------------------
