...
module SuccessorIsNotTropical where
...
open import WalkJumps using (IsPrime ; prime-¬∣1)
...
--
-- `PythagoreanTransition` keeps the ring and changes the
