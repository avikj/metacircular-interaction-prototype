...
open import Cubical.Data.FinSet using (FinSet ; card ; isFinSetâ†’isSet)
open import Cubical.Data.FinSet.Cardinality using (cardâ†ªInequality')
...
lossless-needs-room :
  (n : â„•) (Y : FinSet â„“-zero) (obs : Fin (suc n) â†’ Y .fst)
  â†’ Injective obs
  â†’ card (Inputs n) â‰¤ card Y
lossless-needs-room n Y obs inj =
  cardâ†ªInequality' (Inputs n) Y obs
