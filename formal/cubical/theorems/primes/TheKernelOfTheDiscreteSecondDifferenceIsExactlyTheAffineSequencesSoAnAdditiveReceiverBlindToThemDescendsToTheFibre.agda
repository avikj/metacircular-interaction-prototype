...
--
-- WHAT IS CARRIED IN §6.  That the receiver annihilates the affine
-- directions is a hypothesis of §6.  What is proved is that
...
module TheKernelOfTheDiscreteSecondDifferenceIsExactlyTheAffineSequencesSoAnAdditiveReceiverBlindToThemDescendsToTheFibre where
