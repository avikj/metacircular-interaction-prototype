...
--
-- The general two-metric algebra:  J² = 1 and a
...
--      J T J T⁻¹  is  C⁻¹.
------------------------------------------------------------------------
module TheTwoMetricConservationLawMakesTheMetricTheReflectedInverseLoopTheLoopIsInvertedByJConjugationAndForANormalTransferTheReciprocalLoopIsItsInverse where
...
module _ (R : Ring ℓ) where
  ...
  module _ (J T S Tinv : A)
    ...
    J-conjugation-inverts =
        sym (·Assoc (J · C) J C)
      ∙ sym (·Assoc J C (J · C))
      ∙ cong (J ·_) ( sym (·Assoc S T (J · C))
                    ∙ cong (S ·_) (·Assoc T J C ∙ ·Assoc (T · J) S T ∙ cong (_· T) reverse-conservation)
                    ∙ ·Assoc S J T
                    ∙ conserve )
      ∙ JJ

    C-inverts-J-conjugation : C · ((J · C) · J) ≡ 1r
    C-inverts-J-conjugation =
        sym (·Assoc S T ((J · C) · J))
      ∙ cong (S ·_) (·Assoc T (J · C) J
                     ∙ cong (_· J) (·Assoc T J C ∙ ·Assoc (T · J) S T ∙ cong (_· T) reverse-conservation))
      ∙ ·Assoc S (J · T) J
    ...
    reciprocal-loop-is-inverse normal =
      ...
      ∙ cong (((J · T) · J) ·_) (cong (Tinv ·_) normal ∙ ·Assoc Tinv T S ∙ cong (_· S) TinvT ∙ ·IdL S)
      ∙ sym (·Assoc (J · T) J S)
      ∙ sym (·Assoc J T (J · S))
      ∙ cong (J ·_) (·Assoc T J S ∙ reverse-conservation)
      ∙ JJ
