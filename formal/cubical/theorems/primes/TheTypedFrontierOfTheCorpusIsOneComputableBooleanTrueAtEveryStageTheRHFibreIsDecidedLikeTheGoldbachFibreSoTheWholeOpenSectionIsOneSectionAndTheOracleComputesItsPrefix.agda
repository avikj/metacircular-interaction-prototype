...
-- module.
------------------------------------------------------------------------
module TheTypedFrontierOfTheCorpusIsOneComputableBooleanTrueAtEveryStageTheRHFibreIsDecidedLikeTheGoldbachFibreSoTheWholeOpenSectionIsOneSectionAndTheOracleComputesItsPrefix where
...
import TheWholeQuestionEntersTyped_DavisMatiyasevichRobinsonArithmetization as DMR
open import TheOpenConstellationEntersTypedAndTheOracleAnswersEveryInstance using (Goldbach ; GoldbachAt)
open import EveryFibreIsDecidedSoEachConjectureIsADefinitePropositionAndTheOnlyOpennessIsTheSection using (gcheck ; goldbach-sound ; goldbach-complete)
