...
module TwoIsTheAnchorEveryOddDifferenceOfPrimesInvolvesTwoSoTheOddPartOfThePrimeDifferenceMultisetIsThePrimeIndicatorShiftedByTwo where
...
open import TheWholeQuestionEntersTyped_DavisMatiyasevichRobinsonArithmetization
  using (spf ; spfFrom ; eqb ; ltb ; leb ; modF ; monus ; isZero ; dividesb ; _mod_)
open import TheOpenConstellationEntersTypedAndTheOracleAnswersEveryInstance
  using (primeb ; evenb)
open import OnePairKernelTwoReadersGoldbachIsTheCentreMarginalTwinPrimesTheRadiusMarginalAndTheOrderedGoldbachCountIsTheCauchySquareInCentreRadiusCoordinates
