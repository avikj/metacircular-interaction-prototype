...
-- दृढम्. The separator refutes every such property at once.
...
module TwoPrimesAboveTheThresholdMakeAnUnseenCompositeSoTheSquareRootIsForcedNoFiniteDivisibilityObserverDecidesPrimalityAndCentreRadiusIsVieta where
...
open import ProductOfTwoFactorsAtLeastTwoIsNeverPrimeSoNoComposedPairIsAPrimePair
  using (¬prime-product)
