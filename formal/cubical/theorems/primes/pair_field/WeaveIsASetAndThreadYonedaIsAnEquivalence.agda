...
------------------------------------------------------------------------
-- WeaveIsASetAndThreadYonedaIsAnEquivalence
--
-- Upgrades the Yoneda bijection of `ThreadYoneda` §4 to an equivalence:
...
module WeaveIsASetAndThreadYonedaIsAnEquivalence where
