...
------------------------------------------------------------------------
-- ProductOfTwoFactorsAtLeastTwoIsNeverPrimeSoNoComposedPairIsAPrimePair
--
-- The seed of PairComposition: for u₁,v₁,u₂,v₂ ≥ 2 every composed
-- leg is a product of two factors ≥ 2, hence composite; so no
-- composite of two ≥2-legged pairs is ever a prime pair.
--
-- WHAT IS PROVED.
--
...
module ProductOfTwoFactorsAtLeastTwoIsNeverPrimeSoNoComposedPairIsAPrimePair where
