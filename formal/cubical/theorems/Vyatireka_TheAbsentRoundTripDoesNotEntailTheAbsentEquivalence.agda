...
open import SourcedProofs.PingalaPrastara using (Syllable ; laghu ; guru ; aksara ; parity)
...
open import NaturalMachine.InflationVersusSubgroup using (H2 ; k0 ; kι ; H4)
...
------------------------------------------------------------------------
-- ३ · `NaturalMachine.Digits.digits ⇄ value` — the pair fails and the
...
------------------------------------------------------------------------
-- ४ · `NaturalMachine.SieveScaleTower.s₂₁ ⇄ π₂₁` — the pair fails and
