...
-- of �: membership in Γ�(q) is exactly two-sided stabilization, and
...
-- then cancels d� by integrality (isIntegral�) � the only
...
-- term, so this theorem holds over all of M�(�);  and for q ≠ 0 it is
...
module _ (a b c e d1 q ε : R)
  ...
  -- cancel d�: the one non-equational step, integrality of �
  diff0 : c - (- (ε · k21)) · q ≡ 0r
