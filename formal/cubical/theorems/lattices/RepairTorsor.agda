...
-- (Y , � : X � Y) solving the defect; morphisms: maps under X � the
...
-- Aut(�) = Aut(�) = Aut(�) = 1 and Aut(�/�) � �/2 (note Thm 6) need
...
-- rigidity result (�-algebra-Aut-trivial, swap01-�-id): that module
...
--     group of order two � WITHOUT any claim to be �/�.
------------------------------------------------------------------------
