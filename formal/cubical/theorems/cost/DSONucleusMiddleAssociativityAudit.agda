...
-- cases ~ 5e9 -- and every leaf is an � min/max/+/- from
-- `Cubical.Data.Int`, which are unary-recursive in the magnitude
-- (min (pos (suc n)) (pos (suc m)) = suc� (min (pos n) (pos m))), so each
...
module DSONucleusMiddleAssociativityAudit where

open import Cubical.Foundations.Prelude
open import Cubical.Data.Int using (ℤ)
import DSONucleusExecutionCalibration as E
open import DSONucleusMiddleProduct
