...
module TheChainOfThreeIsPricedAndTheLossesDoNotAddBecauseAnAbsenceSitsInTheMiddleFibre where
...
open import TheCompositesRemainderIsTheSecondRemainderSummedOverTheFirstAndTheAreasAdd
  using (शेष)
