...
------------------------------------------------------------------------
-- TheMixedLayerCoversAndBeatsTheMixedRemainder
--
...
--
-- ────────────────────────────────────────────────────────────────────
-- `TheWholeMixedStratificationIsTheFlippedOne` proved the two
-- stratifications equal.  The output properties are written out here,
-- at one step — and the three do NOT cost the same, which is why this
...
module TheMixedLayerCoversAndBeatsTheMixedRemainder where
