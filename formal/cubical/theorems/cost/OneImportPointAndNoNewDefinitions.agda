...
------------------------------------------------------------------------
-- OneImportPointAndNoNewDefinitions
--
...
module OneImportPointAndNoNewDefinitions where

open import TheFourthCornerCannotLiveOverAnEnumerableDecidableInstanceSet public
