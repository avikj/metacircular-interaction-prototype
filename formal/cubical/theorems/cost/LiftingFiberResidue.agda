...
--    finiteness `� A � Fin n ��` is NOT claimed to suffice: the search
...
--    uniqueness boundary, §4's `everySetIsAFibre` reduction pinning the
--    note's own sentence to that principle, and §5's identification of
