...
module CountedDigitsEdge where
...
import Digits
import Transport
import CountedExecution
import CountedDigits
import AcceptanceTest

module CE = CountedExecution
...
module Base (k : ℕ) where
  ...
  open Digits k public
  open Transport k using (sucC)

  module CD = CountedDigits k
  module AT = AcceptanceTest k
  ------------------------------------------------------------------------
