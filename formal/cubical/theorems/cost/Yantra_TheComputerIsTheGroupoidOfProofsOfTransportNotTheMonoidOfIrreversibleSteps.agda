...
--
-- This file answers WHAT THE COMPUTER IS as a checked term, and the answer
-- is one word with a proof: a GROUPOID.
--
...
--     ��������� Φ (`Vyapti_TheLossOrderIsCoarsening�` §�) is empty exactly
