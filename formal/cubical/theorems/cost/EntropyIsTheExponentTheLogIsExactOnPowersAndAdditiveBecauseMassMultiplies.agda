...
module EntropyIsTheExponentTheLogIsExactOnPowersAndAdditiveBecauseMassMultiplies where
...
open import MassIsConservedPermutedAndMultipliedThePreLogarithmicSecondLaw
