...
-- and valued in �.  These two demands cannot meet: an arrow that has
-- become invertible in ANY receiver of an additive �-valued cost has
...
--       h g + h g�� = h 0 = 0 in � forces h g = 0.  (In � a sum is
--       zero only when both summands are; there is the whole proof.)
--
--   §2  The receipt, stated as the impossibility it is: there is NO
--       triple (a receiver G, a hom � : � � G, a hom h : G � �) with
--       � 1 invertible and h ∘ � ≡ id.  For then 1 = h (� 1) = 0.
...
------------------------------------------------------------------------
-- � � In � a vanishing sum has vanishing summands.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � An invertible element admits no nonzero additive cost.
--
...
------------------------------------------------------------------------
-- � � Therefore no additive �-cost factors through any receiver that
...
-- factorization h ∘ � ≡ id on the generator 1.
