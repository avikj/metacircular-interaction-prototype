...
-- `Sesa_����` � fibre (g ∘ f) z � �[ p ∈ fibre g z ] fibre f (fst p) �
...
--   ������ (inr tt) = (true , true)
--
--  §�  the four fibres of ������, each named AS A TYPE, not as a count:
--         fibre ������ (b , false) � Unit   for both b
--         fibre ������ (true , true) � Unit
--         fibre ������ (false , true) � �   �� THE ABSENCE
--  §�  fibre �������� c � Bool, UNIFORMLY in c.  One bit, everywhere.
--  §�  fibre ������� tt � Bool.  One bit.
--  §�  the middle composite ����� = �������� ∘ ������:
--         fibre ����� false � Unit      (contractible � proved)
--         fibre ����� true  � Bool      (NOT contractible � proved)
--      so the composite's fibre is NOT uniform, and §�'s uniformity has
...
--  §�  the whole chain.  fibre ����� tt � Bool � Unit � THREE.  The
...
-- � � the four fibres of ������.
--
-- ������ is injective � three points into four � so every fibre is a
...
------------------------------------------------------------------------
-- � � the fibre of ��������, and it is UNIFORM.
--
...
------------------------------------------------------------------------
-- � � the fibre of �������.  One bit, and the only point of the base.
------------------------------------------------------------------------
...
-- Unit and � and ��������'s fibre is uniform.  Both halves proved: the
...
-- ������-fibre over the first is Unit and over the SECOND IS �.  So the
...
-- and ((true , true) , refl) � and §� says BOTH ������-fibres are Unit.
...
हस्त-शेष-सत्ये = isoToEquiv (iso to from ri li)
  ...
  -- every ������-fibre over a point of this base is a proposition:
...
--
-- The total fibre, by hand: ����� is constant, so its fibre over the
...
-- ������� costs one bit (§�).  Multiply the fibres � which is exactly
...
--
-- `Sesa_��������` � the clause under which the fibres multiply and the
-- logs add � has as its hypothesis that the first map has a UNIFORM
-- fibre: some Φ with fibre f y � Φ for every y.  ������ does not.  The
...
-- absence is limited to the fibre of �������� over `false`, and §�'s two
...
-- `fiber ������� tt` has two points and �������'s fibre over one of them
...
-- � and ��� says where the bit went: into a base point whose fibre is
...
--     that ������ would miss a point of ��������'s fibre over `false`.
