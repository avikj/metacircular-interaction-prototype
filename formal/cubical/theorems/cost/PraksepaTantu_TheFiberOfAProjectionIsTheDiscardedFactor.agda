...
------------------------------------------------------------------------
-- प्रक्षेप-तन्तुः — the fiber of a projection is exactly the discarded
...
-- what its fiber holds:
--
--     fiber fst a  ≃  B        (the discarded second factor)
--     fiber snd b  ≃  A        (the discarded first factor)
--
-- These are अभिज्ञान / σύμβολα: the identification of the fiber with a
...
-- in the corpus under any local name is a fiber of THIS shape exactly when
...
module _ {A : Type ℓ} {B : Type ℓ'} where
  ...
  ------------------------------------------------------------------------
  -- १ · वाम-प्रक्षेपः — fst forgets B, and its fiber IS B.
  ------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------
  -- २ · दक्षिण-प्रक्षेपः — snd forgets A, and its fiber IS A.
  ------------------------------------------------------------------------
