...
------------------------------------------------------------------------
-- ���������-������ � the fiber of a projection is exactly the discarded
...
--
-- These are ��������� / ��μβολ�: the identification of the fiber with a
...
module _ {A : Type ℓ} {B : Type ℓ'} where
  ...
  ------------------------------------------------------------------------
  -- � � ���-���������� � fst forgets B, and its fiber IS B.
  ------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------
  -- � � �������-���������� � snd forgets A, and its fiber IS A.
  ------------------------------------------------------------------------
