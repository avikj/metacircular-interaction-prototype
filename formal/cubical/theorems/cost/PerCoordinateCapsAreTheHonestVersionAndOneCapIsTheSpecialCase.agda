...
--
-- ────────────────────────────────────────────────────────────────────
-- `TheCostFlipIsFaithfulBelowTheCap` has one cap shared by all cost
...
module PerCoordinateCapsAreTheHonestVersionAndOneCapIsTheSpecialCase where
...
open import TheCostFlipIsFaithfulBelowTheCap
  using (capReflects)
