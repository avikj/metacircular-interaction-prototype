...
------------------------------------------------------------------------
-- TheStrongerFormIsUpstreamOfTheFlipAndOnlyItsImageWasPublished
--
...
--
-- ────────────────────────────────────────────────────────────────────
-- THE AUDIT.  Target: `TheMixedStratumIsExactlyTheFlippedStratum`,
-- an `IsExactly`.
--
...
module TheStrongerFormIsUpstreamOfTheFlipAndOnlyItsImageWasPublished where
