...
-- reading is built:
--
--   §1  The rigs exist: the counting rig (�, 0, 1, +, �) � bag/how-many
...
--       no additive section exists.  Any map � : Bool � � that
--       preserves addition and is inverted by the shadow dies on
--       idempotence: true or true = true forces � true ≡ � true + �
--       true, so � true = 0, so its shadow is false, not true.  The
...
------------------------------------------------------------------------
-- � � The shadow, and its homomorphism laws.
------------------------------------------------------------------------
...
------------------------------------------------------------------------
-- � � No additive section.  The two lemmas, then the theorem.
------------------------------------------------------------------------
...
-- THE THEOREM.  � preserves or/+ and is sectioned by the shadow � �.
