...
--   proves `¬ Œ[ n ] (P n ó ¬ P n)` and whose `order‚íyugapat-fails`
--   proves `¬ (Order ‚í Yugapat)`; the citation in an earlier draft of
...
--
-- WITHDRAWN: any reading of ¬ß1‚ì¬ß9 as carrying apoha's shape, including
...
-- the gloss.
--
-- NOT WITHDRAWN: ¬ß7's citation of the DISPUTE.  Naming Uddyotakara's and
...
-- located ‚î "this absence is itself the finding" ‚î so a module that
