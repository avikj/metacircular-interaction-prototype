...
-- research/rule30/yantra_answers.jsonl and the session's doṣa-lekha is
...
--   §5  the instances (P,D) = (16,64), (32,128), (64,256).
------------------------------------------------------------------------

module Apunaravrtti_TheColumnOfEveryRationalRepeatsWithinItsDenominatorByPigeonholeOnRemaindersAndRuleThirtysMiddleColumnRepeatsForNoDenominatorUpToSixtyFourSoItIsNotTheColumnOfAnyOfThoseRationals where
...
open Instance 256 64 nirṇaya₆₄ public renaming (rule30≠rational to rule30≠rational₆₄)
