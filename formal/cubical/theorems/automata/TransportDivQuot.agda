...
--
--   * Full Word  Word long division.  Only division by a � modulus is
...
--     `CanWord`.
--
--   * A �-level cost model for the library's `quotient _/_`.  Two bounds
...
module TransportDivQuot (k : ℕ) where
