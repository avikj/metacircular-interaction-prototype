...
--       equality: the smagr is a proof invariant, so propagate's
...
module TheReassociationMovesPreserveEveryAdditiveWeightSoTheAxiomMultisetIsAProofInvariant where
