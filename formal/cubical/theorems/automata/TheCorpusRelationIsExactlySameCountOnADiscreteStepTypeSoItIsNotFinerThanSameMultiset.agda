...
-- (walked both ways), `_≈_` gives equal counts (`Uniqueness`), equal counts
...
------------------------------------------------------------------------
module TheCorpusRelationIsExactlySameCountOnADiscreteStepTypeSoItIsNotFinerThanSameMultiset where
