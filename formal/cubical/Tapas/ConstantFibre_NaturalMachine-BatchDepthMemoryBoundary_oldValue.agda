-- LANDED BY तपस् on 2026-08-22T20:06:03Z.  Emitted from a template,
...
--       fiber oldValue false ≃ Old.  A constant map loses
--       EVERYTHING, and the fibre says so exactly: the elided datum is
--       the whole input.
--   §2  off the value the fibre is EMPTY: ¬ fiber oldValue true.
...
-- host's own theorems.  Old is imported, not re-proved.
------------------------------------------------------------------------

module Tapas.ConstantFibre_NaturalMachine-BatchDepthMemoryBoundary_oldValue where
