-- LANDED BY तपस् on 2026-08-23T21:38:16Z.  Emitted from a template,
...
--   ⟨lib⟩.Bool  ⟶  ⟨lib⟩.ℕ
--   « TotientFibreSymmetry.twoPrimes
--
...
over-false = (false , refl) , same where
  same : (y : fiber twoPrimes 2) → (false , refl) ≡ y
