-- LANDED BY तपस् on 2026-08-23T21:37:18Z.  Emitted from a template,
...
over-false = (false , refl) , same where
  same : (y : fiber asNat 0) → (false , refl) ≡ y
