-- LANDED BY तपस् on 2026-08-23T21:37:06Z.  Emitted from a template,
...
over-false = (false , refl) , same where
  same : (y : fiber b2n 0) → (false , refl) ≡ y
