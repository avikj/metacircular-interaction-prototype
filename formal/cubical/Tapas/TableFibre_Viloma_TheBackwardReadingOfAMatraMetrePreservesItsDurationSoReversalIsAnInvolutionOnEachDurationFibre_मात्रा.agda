-- LANDED BY तपस् on 2026-08-23T21:38:22Z.  Emitted from a template,
...
--   ⟨lib⟩.Bool  ⟶  ⟨lib⟩.ℕ
--   « Viloma_TheBackwardReadingOfAMatraMetrePreservesItsDurationSoReversalIsAnInvolutionOnEachDurationFibre.मात्रा
--
...
--   §2  off both values (witness 4) the fibre is EMPTY.
...
module Tapas.TableFibre_Viloma_TheBackwardReadingOfAMatraMetrePreservesItsDurationSoReversalIsAnInvolutionOnEachDurationFibre_मात्रा where
...
open import Viloma_TheBackwardReadingOfAMatraMetrePreservesItsDurationSoReversalIsAnInvolutionOnEachDurationFibre using (मात्रा)
