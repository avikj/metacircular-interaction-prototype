-- LANDED BY तपस् on 2026-08-23T21:38:24Z.  Emitted from a template,
...
--   ⟨lib⟩.Bool  ⟶  ⟨lib⟩.ℕ
--   « Virahanka_TheMatraFibreSatisfiesTheTwoStepRecurrence.मात्रा
--
...
module Tapas.TableFibre_Virahanka_TheMatraFibreSatisfiesTheTwoStepRecurrence_मात्रा where
...
open import Virahanka_TheMatraFibreSatisfiesTheTwoStepRecurrence using (मात्रा)
