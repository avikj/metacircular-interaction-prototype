...
module TheDiscreteLogsOneWaynessIsExactlyTheEmbeddingFactorFailingNotTheSurjectionFactor where
...
open import TheContractibleFibreSplitsAsEmbeddingTimesSurjectionInTheTransportLane
  using (भेदः ; छादनम् ; समता≃भेद×छादन)
open import NaturalMachine.EveryTransportOwesItsResidual using (शेष)
