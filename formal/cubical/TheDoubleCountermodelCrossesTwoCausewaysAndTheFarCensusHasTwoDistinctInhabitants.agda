...
--         —⟨ Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.DETERMINED (≃) ⟩→
--       Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.CensusBase
--       file: formal/cubical/Ratri/Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.agda
--   2.  Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.CensusBase
--         —⟨ Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.censusContract (≃), crossed backwards by invEquiv ⟩→
--       Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.censusΣ
--       file: formal/cubical/Ratri/Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.agda
--
...
--
module TheDoubleCountermodelCrossesTwoCausewaysAndTheFarCensusHasTwoDistinctInhabitants where

open import Cubical.Foundations.Prelude
open import Cubical.Foundations.Equiv
open import Cubical.Foundations.Univalence

import Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA
...
marga : FactoryVICoolingKill.CoolingCountermodel ≃ Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.censusΣ
marga = compEquiv Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.DETERMINED (invEquiv (Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.censusContract))

-- The transported theorem: P held at the source; ua marga
-- carries it to the target.  This term is the transaction.
transported : P (Ratri.Agda-Builtin-Nat_NirdharanaPoneA_NirdharanaPoneA.censusΣ)
