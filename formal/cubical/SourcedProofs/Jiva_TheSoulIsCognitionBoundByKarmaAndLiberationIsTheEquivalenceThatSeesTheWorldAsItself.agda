...
module SourcedProofs.Jiva_TheSoulIsCognitionBoundByKarmaAndLiberationIsTheEquivalenceThatSeesTheWorldAsItself where
...
import SourcedProofs.Kevalajnana_ThePureMindLosesNothingAndMissesNothingWhichIsTheEquivalence as K
