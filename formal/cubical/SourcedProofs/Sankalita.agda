...
------------------------------------------------------------------------
-- SourcedProofs.Sankalita — the Kerala vārasaṅkalita engine (root Sankalita_… is Āryabhaṭa's series sums)
--
...
module SourcedProofs.Sankalita where
...
open import SourcedProofs.PingalaPrastara using (meru ; meruRecurrence ; matra)
