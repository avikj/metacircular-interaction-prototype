...
module SourcedProofs.Lagakriya_TheConditionalFibreIsWhatTheSecondCountStillCostsOnceTheFirstIsKnown where
...
open import SourcedProofs.NastaUddista_TheRankUnrankAlgebraTheMachineRunsOn
  using (नयन ; युग्म ; अग्रिम ; पङ्क्ति)
import SourcedProofs.Chandomudra_ThePratyayasFibresWereWrittenInProseAndTheCensusCalledThemUndecided as CM
