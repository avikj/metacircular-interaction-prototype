...
--
-- WHAT IS NOT PROVED.  That seven is exhaustive — `SaptabhangiNaya` §6
...
module SourcedProofs.Sakaladesa_NoSingleUtteranceDenotesTheTotalStatementAndTheContentNonethelessFolds where
