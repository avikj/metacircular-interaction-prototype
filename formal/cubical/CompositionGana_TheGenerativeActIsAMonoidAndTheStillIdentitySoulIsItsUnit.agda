...
-- �������� � bhvan of cognitions is a monoid: associative, and the STILL
-- identity-soul (λ x � x, ������'s cognition) is its unit � the motionless one
-- is exactly what leaves every other soul unchanged. Stillness = the unit of
-- the generative act. (����-verified; composition monoid, all refl.)
