...
--
-- For each declaration: getType, NORMALISE (βδ� � unfold every definition
-- to normal form), then serialize the normal-form Term to a canonical
-- string. de Bruijn indices make the serialization �-invariant, and
...
-- the head off the UN-normalised type (normalise unfolds � into �), take
