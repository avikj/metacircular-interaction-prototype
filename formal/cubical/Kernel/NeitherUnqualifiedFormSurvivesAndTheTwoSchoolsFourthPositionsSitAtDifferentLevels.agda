...
-- PARYUDSA THE FOURTH CORNER IS A DIFFERENT FORMULA AND §2 DOES NOT
-- APPLY TO IT.
--
------------------------------------------------------------------------
-- PRIOR ART.
...
module Kernel.NeitherUnqualifiedFormSurvivesAndTheTwoSchoolsFourthPositionsSitAtDifferentLevels where
