...
--
-- AND THIS IS THE FIBRE LAW CHOOSING ITS BINDING.  `fibre/src/Loss/
...
module Kernel.Ekadhikarana_TheInstalledTheoremHasExactlyOneLocusSoCapabilityGrowsByOneNotByAClass where
