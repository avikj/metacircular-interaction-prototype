...
--
-- The question between them: whether the induction apparatus — the strongest
...
module Kernel.TheInductionCertificateDoesNotReachCommutativitySoTheHierarchyHasThreeStrictLevels where
...
open import Kernel.EvalIsOneStandpointAndASecondOneProvesTheInductionRuleIsStrictlyStrongerThanTheRewriteClosure
