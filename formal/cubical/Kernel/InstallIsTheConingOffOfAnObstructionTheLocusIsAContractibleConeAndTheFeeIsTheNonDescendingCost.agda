...
module Kernel.InstallIsTheConingOffOfAnObstructionTheLocusIsAContractibleConeAndTheFeeIsTheNonDescendingCost where
...
open import Kernel.TheLocalizationSequenceAsOneObjectMeaningDescendsAndCostDoesNot
