...
--       theorem re-read as its safety property.
...
module Kernel.TheKernelIsAnInteractiveSystemAndTheSessionRetiresIntoOneOperation where
...
-- oracle token, a session identity: anything at all.  It is a `Control`
-- carrying evidence strictly stronger than
