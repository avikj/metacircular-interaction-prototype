...
------------------------------------------------------------------------
--
--   Vyapti_‚¶    THE INSTALLED OPERATION HAS NO PERVASION.  What it
...
--
--   Samvada_‚¶   AND THEN WHAT IT IS FOR.
--               THE KERNEL
...
--         omission.
--     `Samvada_‚¶` supplies the corpus's first non-trivial `Control` and
--     closes the loop.
--
