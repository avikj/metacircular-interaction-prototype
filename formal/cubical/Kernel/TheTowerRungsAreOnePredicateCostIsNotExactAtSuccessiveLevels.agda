...
-- non-descending cost.  The ITERATION, that the
-- fee at level n is the carrier at level n+1, endlessly, is
-- the RUNG RELATION, as a term: it exhibits two consecutive
...
module Kernel.TheTowerRungsAreOnePredicateCostIsNotExactAtSuccessiveLevels where
...
open import TheValueOfATraceIsItsPairingWithAnEvaluatorPotentialsTelescopeAndADepthEvaluatorHasNonzeroCycleIntegral
