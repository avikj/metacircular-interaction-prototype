...
-- here (परिक्रमा, the walk around; अन्धता, blindness); not a
...
module EveryFibreMerelyAgreesEverywhereYetTheFamilyDoesNotDescendAndTheSectionedBaseDoesNotSaveIt where
