...
--       chosen.
--
--   §3  THE ANALYZERS ARE ALL THIS FOLD.  eval-as-motion
...
module TheKernelIsInitialEveryReadingIsItsUniqueFoldSoAllPathsThroughASystemAreEnumeratedByOneRecursor where
