...
module BlindnessHidesAtEveryDepthTheTruncatedFamilyDescendsAndTheWholeFamilyCannot where
...
open import TheStratumAboveSilenceCarriesTheWholeChargeForEverySphere
  using (अनन्तरम्)
