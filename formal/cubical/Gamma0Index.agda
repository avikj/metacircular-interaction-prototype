...
-- Companion note: notes/GAMMA0_FLAG_INDEX.md  (statement, proof, prior art).
--
-- R0036 (notes/FLAG_CONGRUENCE_SMITH_STABILIZER.md) named the two-sided Smith
-- stabilizer
--
--     Γ₀(D) = GLᵣ(ℤ) ∩ D·GLᵣ(ℤ)·D⁻¹ = { A : (dᵢ/dⱼ) ∣ Aᵢⱼ for i > j }
--
-- for a divisor chain D = diag(d₁ ∣ d₂ ∣ … ∣ dᵣ), and R0037
-- (notes/MIXED_RANK_SMITH_STABILIZER.md) extended it to mixed rank.  Neither
