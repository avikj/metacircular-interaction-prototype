...
module ThePriceReadoutAndTheSymmetryReadoutAreOneFunctionAndBothMergeTheFullyHeldWithTheNeverAsked where
...
open import TheSymmetryReadoutIsTwoValuedAndComputablyMergesGraspedWholeWithMissedEntirely
