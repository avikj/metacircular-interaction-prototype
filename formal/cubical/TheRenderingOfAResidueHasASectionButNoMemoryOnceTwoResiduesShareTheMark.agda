...
module TheRenderingOfAResidueHasASectionButNoMemoryOnceTwoResiduesShareTheMark where
...
open import TheTwoOccupancyEdgesArePricedTheirFibreSpectraComputedAtEveryTarget
  using (g)
