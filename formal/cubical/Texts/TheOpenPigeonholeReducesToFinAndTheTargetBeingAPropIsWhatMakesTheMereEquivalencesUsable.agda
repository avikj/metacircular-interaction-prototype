...
------------------------------------------------------------------------
-- NaturalMachine.TheOpenPigeonholeReducesToFinAndTheTargetBeingAPropIsWhatMakesTheMereEquivalencesUsable
--
...
module Texts.TheOpenPigeonholeReducesToFinAndTheTargetBeingAPropIsWhatMakesTheMereEquivalencesUsable where
...
open import Texts.OptimalObservation using (Injective ; Optimal)
open import Texts.TheCardinalityHalfOfOptimalIsExactlyAMereEquivalenceAndItSaysNothingAboutTheSchemeItself
