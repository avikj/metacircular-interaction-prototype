...
module Texts.Pratyaya_TheChandasCountsStandTwiceAndTheTwoProofsAreOnePath where
...
open import Texts.PingalaPrastara using (matra ; Pattern ; matraOf ; varna ; guruOf)
