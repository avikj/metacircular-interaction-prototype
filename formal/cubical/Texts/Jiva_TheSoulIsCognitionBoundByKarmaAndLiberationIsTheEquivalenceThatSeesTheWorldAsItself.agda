...
module Texts.Jiva_TheSoulIsCognitionBoundByKarmaAndLiberationIsTheEquivalenceThatSeesTheWorldAsItself where
...
import Texts.Kevalajnana_ThePureMindLosesNothingAndMissesNothingWhichIsTheEquivalence as K
