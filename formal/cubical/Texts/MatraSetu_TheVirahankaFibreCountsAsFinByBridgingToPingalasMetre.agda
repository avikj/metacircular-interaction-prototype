...
module Texts.MatraSetu_TheVirahankaFibreCountsAsFinByBridgingToPingalasMetre where
...
open import Texts.Virahanka_TheMatraFibreSatisfiesTheTwoStepRecurrence using (छन्दः)
