...
--
--     Texts.CakravalaDescent.Descent.cakravalaScaled
...
-- (`solve! R`) is likewise `Texts.Bhavana.Form.cakravalaCleared` again, and
...
module Texts.Punarukti_TheTwoScaledCakravalaStepsAreOneTheorem where
...
module Bridge (CR : CommRing ℓ) where
  ...
  open Texts.Bhavana.Form CR using (R ; N)
  open Texts.CakravalaDescent.Descent CR using (cakravalaScaled)
