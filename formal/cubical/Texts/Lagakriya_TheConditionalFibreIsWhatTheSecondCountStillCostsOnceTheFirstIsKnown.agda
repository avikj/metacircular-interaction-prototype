...
module Texts.Lagakriya_TheConditionalFibreIsWhatTheSecondCountStillCostsOnceTheFirstIsKnown where
...
open import Texts.NastaUddista_TheRankUnrankAlgebraTheMachineRunsOn
  using (नयन ; युग्म ; अग्रिम ; पङ्क्ति)
import Texts.Chandomudra_ThePratyayasFibresWereWrittenInProseAndTheCensusCalledThemUndecided as CM
