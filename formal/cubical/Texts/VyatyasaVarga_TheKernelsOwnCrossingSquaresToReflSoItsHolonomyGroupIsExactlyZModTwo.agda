...
-- `Texts.Vyatyasa_…`, which states its own limits.  वर्ग · varga — square.
...
--
--   `Texts.Vyatyasa_…` §4 proves σ² = id and `ua`-triviality of the doubled
...
module Texts.VyatyasaVarga_TheKernelsOwnCrossingSquaresToReflSoItsHolonomyGroupIsExactlyZModTwo where
