...
module Texts.DiagonalIsMatra where
...
open import Texts.PingalaPrastara using (Chosen ; meru ; meruCount ; Metre ; matra ; matraCount)
open import Texts.Sankalita using (AD ; antidiag)
