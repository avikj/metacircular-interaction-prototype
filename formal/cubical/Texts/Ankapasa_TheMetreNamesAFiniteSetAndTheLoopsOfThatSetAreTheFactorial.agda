...
module Texts.Ankapasa_TheMetreNamesAFiniteSetAndTheLoopsOfThatSetAreTheFactorial where
...
open import Texts.Pingala using (छन्दस् ; मूल्य ; अनुक्रम ; मूल्य-एकैकम् ; छन्दस्≃ℕ)
