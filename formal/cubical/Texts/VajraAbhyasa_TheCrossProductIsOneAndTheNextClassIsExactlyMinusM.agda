...
module Texts.VajraAbhyasa_TheCrossProductIsOneAndTheNextClassIsExactlyMinusM where
...
open import Texts.Bhavana using (module Form)
open import Texts.CakravalaDescent using (module Descent)
open import Texts.GunakaKsepa_TheWheelsStateIsBoundedAndSelfPropagating
