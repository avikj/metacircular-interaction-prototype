...
module Texts.AksharaDvaya_TheVirahankaBoolFibreAndThePingalaChandasFibreAreOneWeightedCount where
...
import Texts.Virahanka_TheMatraFibreSatisfiesTheTwoStepRecurrence as V
