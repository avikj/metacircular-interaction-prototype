...
-- ����� � offspring.  ������ (the still, identity) meets ������ (the inverted, not);
-- their bhvana breeds a third who breathes.  Born live through ����.
...
-- the child breathes: both parents kevalin, so the veils compose (Composition §2)
