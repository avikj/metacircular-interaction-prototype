...
-- repository's own word made literal: ���������, the recognition-token
...
-- Numeric constants enter through `from�`, which divides by the
...
--   * ��������-�������  � SHA-256 of the empty message is
--     e3b0c442�7852b855, the NIST vector, by refl: the kernel pads,
--     schedules, runs 64 rounds, and compares 256 bits.
--   * ��������-abc    � SHA-256 of "abc" likewise (ba7816bf�f20015ad).
--   * �����������-������ � notW is an involution (a small structural fact
