...
--
-- The owner's correction, taken literally.  �-������� (Parimana) was
...
--   �������  :=  Bits / ∼                    (the space of classes)
--   ������� : ������� � Bits                 (the map of classes)
--
-- WHAT IS PROVED:
--   §2  �����-����� � the class of x, read as a type, IS the fibre of
...
--   §3  �����-������ � sha256 factors: sha256 = ������� ∘ [_], and the
--       factorization is definitional.
--   §4  �����-��������� � the descended map is INJECTIVE: on classes the
...
--   §5  �����-������� � every class is inhabited by a message ([_] is
--       surjective): the quotient carries no phantom classes.
--   §6  ���� / �����-���� � concrete class separation, COMPUTED: the
