...
समता : (m n : ℕ) → Primes.PairField.ResidueGlue.eqℕ m n ≡ NaturalMachine.Obstruction.eqℕ m n
समता zero    zero    = refl
...
एकीभावः : Primes.PairField.ResidueGlue.eqℕ ≡ NaturalMachine.Obstruction.eqℕ
