...
------------------------------------------------------------------------
-- 7.  What the counterexample is.
--
-- §2.4 marks it ↳ inherited, and that mark stands.  One instance of
-- ⊙_L's non-associativity is exhibited, which is exactly what a
-- counterexample is, and §2.4's own conclusion is the negative
-- universal ("There is no universal compiler that records only
-- one-sided binary closure ... and still guarantees associative
-- semantic composition"), which this instance witnesses.
--
