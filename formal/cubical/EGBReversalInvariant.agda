...
module EGBReversalInvariant where
...
-- the �/2), which is the third character � equivariant of weight −1 �
...
-- check transport (λ i � revPath i � �) length ≡ length � the
