...
------------------------------------------------------------------------
-- प्रदक्षिणा — the circuit returns to the base point with the fibre
...
module Pradakshina_TheCircuitReturnsToTheBasePointWithTheFibreShiftedSoTheHolonomyIsInhabited where
...
------------------------------------------------------------------------
-- १ · the action of the circuit on the fibre over the base point.
------------------------------------------------------------------------
...
-- bundle returns every fibre element identically.  The curvature is a
