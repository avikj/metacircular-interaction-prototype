...
------------------------------------------------------------------------
-- ������ � what the computer is: the groupoid of proofs-of-transport, not
...
--
-- "Nothing is erased" is checked below (§2's inverse laws) and is a
...
-- of "erases nothing" is `Vyapti_TheLossOrderIsCoarsening�agda` §�: the
-- collision type `��������� Φ` is empty when `Φ` is an equivalence.
...
--
-- ������ (yantra) is the corpus's word for the machine (`Yantra_The-
...
--       ����������-������� / -���   inverse is two-sided (the run undoes)
--       ���������                composition is associative (sequencing)
--   §3  ������ : running a program IS transport along its path.
--       �����-������������� : every run has an inverse run � reversible.
--       ����-������ : composing programs, then running, = running each in
--       turn (the machine is a functor from the groupoid to functions).
--   §4  the contrast, as types: a MONOID interface has ∘ and id and no
--       inverse field; the groupoid adds ����������.  The added field is
--       the reversibility.  (NOT the heat � see above.)
--
...
--     a no-op and no inverse; the groupoid adds ���������� with its two
...
-- is populated by ����������, the field a MonoidMachine cannot fill.
