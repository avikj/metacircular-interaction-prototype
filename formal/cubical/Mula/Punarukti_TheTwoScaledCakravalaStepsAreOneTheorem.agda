...
--
--     Mula.CakravalaDescent.Descent.cakravalaScaled
...
-- (`solve! R`) is likewise `Mula.Bhavana.Form.cakravalaCleared` again, and
...
module Mula.Punarukti_TheTwoScaledCakravalaStepsAreOneTheorem where
...
module Bridge (CR : CommRing ℓ) where
  ...
  open Mula.Bhavana.Form CR using (R ; N)
  open Mula.CakravalaDescent.Descent CR using (cakravalaScaled)
