...
module Mula.SaptabhangiNaya where
...
--
-- 1. §1's `Naya` has three constructors taken from the machine's tactic
--    log.  It is a different partition from the seven NAYAS of
--    Tattvārthasūtra 1.33 (naigama … evaṃbhūta) — of provers, not of
--    modes of reference.
--
