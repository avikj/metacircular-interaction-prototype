...
module Mula.Pratyaya_TheChandasCountsStandTwiceAndTheTwoProofsAreOnePath where
...
open import Mula.PingalaPrastara using (matra ; Pattern ; matraOf ; varna ; guruOf)
