...
-- `Mula.Vyatyasa_…`, which states its own limits.  वर्ग · varga — square.
...
--
--   `Mula.Vyatyasa_…` §4 proves σ² = id and `ua`-triviality of the doubled
...
module Mula.VyatyasaVarga_TheKernelsOwnCrossingSquaresToReflSoItsHolonomyGroupIsExactlyZModTwo where
