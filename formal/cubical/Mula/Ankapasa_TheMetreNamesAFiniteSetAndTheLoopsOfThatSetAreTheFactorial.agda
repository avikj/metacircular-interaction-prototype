...
module Mula.Ankapasa_TheMetreNamesAFiniteSetAndTheLoopsOfThatSetAreTheFactorial where
...
open import Mula.Pingala using (छन्दस् ; मूल्य ; अनुक्रम ; मूल्य-एकैकम् ; छन्दस्≃ℕ)
