...
-- शेष in the sense this file uses — the remainder is kept and is
...
module Mula.TheKernelFillsTheMonoidStrictlyAndRefusesTheGroupoidSoTheRoundTripIsTheResidue where
...
open import Kernel.TheKernelIsAnInteractiveSystemAndTheSessionRetiresIntoOneOperation
  using (_⊕_)
open import Kernel.TheKernelIsAReversibleGroupoidWhoseJoinIsConflictFreeSoConsensusOnMeaningIsVacuous
  using (⊕-assoc ; ⊕-unitˡ ; ⊕-unitʳ)
open import Mula.TheComputerIsTheGroupoidOfProofsOfTransportNotTheMonoidOfIrreversibleSteps
  using (MonoidMachine)
