...
module Mula.TheConservingFlowsFormAGanaAndTheSectionIdentificationPreservesItByRefl where
...
open import Mula.TheZeroDivisorEdgeIsPricedAtItsWholeDomainAndTotalLossIsExactlyTotalSymmetry
  using (सर्व-नाशः)
