...
------------------------------------------------------------------------
-- Mula.Sankalita — the Kerala vārasaṅkalita engine (root Sankalita_… is Āryabhaṭa's series sums)
--
...
open import Mula.PingalaPrastara using (meru ; meruRecurrence ; matra)
