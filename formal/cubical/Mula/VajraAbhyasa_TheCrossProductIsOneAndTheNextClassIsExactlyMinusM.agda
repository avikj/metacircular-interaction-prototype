...
module Mula.VajraAbhyasa_TheCrossProductIsOneAndTheNextClassIsExactlyMinusM where
...
open import Mula.Bhavana using (module Form)
open import Mula.CakravalaDescent using (module Descent)
open import Mula.GunakaKsepa_TheWheelsStateIsBoundedAndSelfPropagating
