...
module Mula.DiagonalIsMatra where
...
open import Mula.PingalaPrastara using (Chosen ; meru ; meruCount ; Metre ; matra ; matraCount)
open import Mula.Sankalita using (AD ; antidiag)
