...
module Mula.Uddista_TheReceiptBecomesAnAddressExactlyWhenTheFibreRankIsCarriedAndItsPriceIsVirahankasNumber where
...
open import Mula.Pata_CarryingIsUnconditionalButAddressingNeedsTheMapToBeAnIdentification
