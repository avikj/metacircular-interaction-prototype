...
------------------------------------------------------------------------
-- ���-����� � the writing of the remainder.  Compound built here,
-- 2026-08-23 (���, remainder; ����, writing/record); it is not a source
...
--
--   the RENDERING  ����� : R � S � R � Unit  � keep the resolved cases,
--   reduce every residue to the bare mark that one exists �
--
--   §1  HAS A SECTION as soon as one residue is in hand (������): the
...
--       (������-����� / �-�����������): any map back forces the two to
...
-- �_�� is exactly an h-level hypothesis); Arpitanarpita_�agda proves
...
--
-- §3 instantiates it at the fibre: Mulyankana's ��� at 0 (three
...
------------------------------------------------------------------------
-- §3  The fibre instance: Mulyankana's ��� at 0.  Two of the three
