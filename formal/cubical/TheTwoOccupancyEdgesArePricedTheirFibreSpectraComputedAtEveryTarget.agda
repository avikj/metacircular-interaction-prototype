...
--
-- WHY THIS MODULE EXISTS.  Two Bool → ℕ edges live in
...
-- contractible nor ⊥ nor a truncation).
-- This module
...
module TheTwoOccupancyEdgesArePricedTheirFibreSpectraComputedAtEveryTarget where
