...
--
-- SCOPE.  This module supplies the term that `Machine.Prakasha` asserts in
...
--
-- TERM.  ���� / *chy*, shadow, is `Machine.Prakasha`'s own coinage in
...
module Machine.Chaya_TheShadowHasNoSectionThoughItHasAMap where

open import Machine.Prakriti using (IsPrime)
open import Machine.Vada using (primeDec)
