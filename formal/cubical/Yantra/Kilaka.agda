...
open import Machine.Vibhajana using (Prati; product; factor)
open import Machine.Bhajaka using (Mem; pdp)
open import Machine.Shodhita using (MemV; HasDup; decDup; μ̂)
