...
-- `notes/SamagraDarsana_�md` §� lists, as open:
--
--     "Whether `isContr`'s merging of *empty fibre* and *fibre with �2
--      points* is an instance of `Saptabhangi.�������`. The note
--      `WholePartialDesa_�` argues it is; the instantiation is not written."
--
-- `Fiberjala_�agda` §� takes the nearest available step and says so: it
-- re-exports `S.�������` under a fibre-flavoured name and asks the reader to
-- *read* ��������/�����/��� as ���������/�����/������ �
--
--     ������-��������-������ = S.�������
--
...
--      `b` the three verdicts exclude one another (`Fiberjala` §�).  For a
...
--
-- This is the line `SamagraDarsana` §� says is not written.  It is not a
-- new proof: it is `S.�������` applied to `V ∘ �������`, and the whole content
...
--
-- At a FIXED b the three verdicts are mutually exclusive (`Fiberjala` §�).
...
-- Fiberjala's ������ lemmas neither of the other two can occur.
...
--
-- `isEquiv f` is `�����` at every b at once (`Fiberjala.���������`), so it
