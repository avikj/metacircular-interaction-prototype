...
module TransitivityIsFreeTotalityIsNotAndTheHLevelDecidesUniquenessNotExistence where
...
open import AGaugeFreeShortestDescriptionWouldBeAFixedPointSoNoneExistsOnATorsor
  as J0

-- j-2's module, qualified only, so nothing of it is shadowed.
import TheLeastVarnaIsFixedByTheMatraCountAndNoLeastPatternIs
  as J2
