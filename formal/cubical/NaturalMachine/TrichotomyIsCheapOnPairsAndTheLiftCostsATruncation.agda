...
------------------------------------------------------------------------
-- NaturalMachine.TrichotomyIsCheapOnPairsAndTheLiftCostsATruncation
--
...
module NaturalMachine.TrichotomyIsCheapOnPairsAndTheLiftCostsATruncation where
...
open import NaturalMachine.WhichThresholdStatementsDescendToTheRate using (_≈_)
open import NaturalMachine.TheThresholdChainIsDenseAndTheMediantWitnessesIt
  using (_⊏_)
