...
------------------------------------------------------------------------
-- NaturalMachine.RatioIsTheInvariantAndLengthIsThePresentation
--
...
--
-- That is the same shape as `NaturalMachine.Laghava` (cost lives on the
...
module NaturalMachine.RatioIsTheInvariantAndLengthIsThePresentation where
