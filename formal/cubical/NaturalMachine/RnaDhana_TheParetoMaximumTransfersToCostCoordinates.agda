...
module NaturalMachine.RnaDhana_TheParetoMaximumTransfersToCostCoordinates where
...
open import NaturalMachine.EveryRemainderMemberIsStrictlyDominated
  using (anyToMember)
...
open import NaturalMachine.ANonEmptyArchiveHasANonEmptyStratum using (maximalExists)
open import NaturalMachine.FlippingACostCoordinateIsSoundButNotFaithful
  using (Vec ; Dom)
