...
module NaturalMachine.CountedDigitsEdge (k : ℕ) where
...
-- formal/cubical/BUILD.md (Agda 2.8.0, cubical v0.9), nor against the
-- v0.5 the rest of this lane's headers quote: three toolchain states are
-- live in this repository at once and this file has only seen one.
------------------------------------------------------------------------
