...
------------------------------------------------------------------------
-- एकतन्त्रम् — one loom.  Compound built here; not a source
-- term.
--
...
module NaturalMachine.TheSchedulerAndTheProverAreOneContentionStructureAndTheDifferenceIsAParameter where
...
------------------------------------------------------------------------
-- §2  The birth, and anavaka as a theorem.
------------------------------------------------------------------------
