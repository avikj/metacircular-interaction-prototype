...
------------------------------------------------------------------------
-- NaturalMachine.Moksha — the sealed organism
--
...
-- `NaturalMachine.agda`, which does not check under the current fallback
...
module NaturalMachine.Moksha where

open import NaturalMachine.NisvabhavaNet public
