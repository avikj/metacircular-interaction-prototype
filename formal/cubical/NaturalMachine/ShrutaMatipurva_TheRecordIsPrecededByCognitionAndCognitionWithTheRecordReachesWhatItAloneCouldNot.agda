...
------------------------------------------------------------------------
-- ������ ���������� � Umsvti, Tattvrthastra 1.20 (c. 2nd�5th c.
-- CE): ruta � the recorded, transmitted knowledge � is preceded by
...
-- Here the store's entries � each already carrying its ������� by
-- type � speak inside the ascent's step as unconditional voices,
-- through the certified matcher, at every instance (����).  ���
-- (�������-������) mints a rule; the rule becomes �����; and
-- ���-with-����� proves what ��� alone was silent on.
--
-- Demonstrated end to end on the frontier the previous module named
-- from inside: SvarthaAnumana's ���� exhibits by refl that
-- commutativity of ⊕ is beyond the bare exchange.  Here:
--
--   1. ��� proves (su x) ⊕ y = su (x ⊕ y) for itself � ��������, the
--      first entry, minted by �������-������, no carrier.
--   2. �������� enters the record.
--   3. ���-with-����� proves x ⊕ y = y ⊕ x � ������������������� �
...
------------------------------------------------------------------------
-- §3  ��� with �����: the same fueled inference-for-oneself, the
...
------------------------------------------------------------------------
-- §4  The loop runs.  ��� mints the first entry; the entry is �����;
--     ���-with-����� crosses the frontier ��� alone could not.
------------------------------------------------------------------------

-- 1. ��� alone: (su x) ⊕ y = su (x ⊕ y), proven for itself.
अग्रिमः : नियमः
अग्रिमः = niyama ((su (var 0)) ⊕ (var 1)) (su ((var 0) ⊕ (var 1)))
  (fromJust (स्वार्थ-साधनम् इन्धनम्
    ( (su (var 0)) ⊕ (var 1) , su ((var 0) ⊕ (var 1)) )) tt)

-- 2�3. ��� with that one entry of �����: commutativity � the exact
-- equation SvarthaAnumana's ���� held as beyond the bare exchange.
