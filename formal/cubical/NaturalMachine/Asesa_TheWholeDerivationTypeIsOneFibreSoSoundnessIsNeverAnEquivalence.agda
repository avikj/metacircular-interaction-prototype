...
--   Sesa_      RewriteCertificate.derivation-sound : D a b � eval a � ≡ eval b �
...
module NaturalMachine.Asesa_TheWholeDerivationTypeIsOneFibreSoSoundnessIsNeverAnEquivalence where
