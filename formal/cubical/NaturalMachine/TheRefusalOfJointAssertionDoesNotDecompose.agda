...
------------------------------------------------------------------------
-- NaturalMachine.TheRefusalOfJointAssertionDoesNotDecompose
--
...
module NaturalMachine.TheRefusalOfJointAssertionDoesNotDecompose where
...
-- `NaturalMachine.ThePositionsOverTwoAtomsAreAThreeStepChain`.  There is:
--
--   Krama = (¬ सामयिक) × (¬ नित्य)
