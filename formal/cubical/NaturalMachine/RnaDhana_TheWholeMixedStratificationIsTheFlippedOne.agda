...
------------------------------------------------------------------------
-- NaturalMachine.RnaDhana_TheWholeMixedStratificationIsTheFlippedOne
--
...
module NaturalMachine.RnaDhana_TheWholeMixedStratificationIsTheFlippedOne where
...
open import NaturalMachine.TheStratificationTerminatesOnItsOwnLength using (strata)
