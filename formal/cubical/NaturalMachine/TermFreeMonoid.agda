...
module NaturalMachine.TermFreeMonoid where
...
open import NaturalMachine.WitnessPolicy   using (size)
open import NaturalMachine.GenerativeLoop  using (delta ; deficit)
