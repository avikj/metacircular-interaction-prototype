...
------------------------------------------------------------------------
-- NaturalMachine.TheFourVerdictsAreNotAPartitionAndUndecidedIsExclusiveOnlyWithForms
--
...
--
-- ────────────────────────────────────────────────────────────────────
-- THE AUDIT.  Target: `NaturalMachine.VacuityVerdict`, whose header
-- says:
--
...
module NaturalMachine.TheFourVerdictsAreNotAPartitionAndUndecidedIsExclusiveOnlyWithForms where
