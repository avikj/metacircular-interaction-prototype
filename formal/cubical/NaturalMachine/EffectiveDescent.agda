...
------------------------------------------------------------------------
-- NaturalMachine.EffectiveDescent
--
...
-- WHAT THIS CLOSES
--
-- `NaturalMachine.DefectCalculus` §7 proves T15.40 in the direction that
...
--     ALREADY OWNED the tool: `NaturalMachine.FiniteInformation`
...
module NaturalMachine.EffectiveDescent where
...
-- drift apart.
open import NaturalMachine.DefectCalculus
