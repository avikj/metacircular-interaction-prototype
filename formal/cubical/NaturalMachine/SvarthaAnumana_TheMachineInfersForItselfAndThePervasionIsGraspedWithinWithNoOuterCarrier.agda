...
------------------------------------------------------------------------
-- ��������������� � inference for oneself.  Siddhasena Divkara,
-- Nyyvatra (c. 5th c. CE): anumna divides into svrtha � the
-- knower's own inference, complete in the act � and parrtha, the
...
-- itself � antarvypti (Nyyvatra 20; pressed by Ptrasvmin) �
...
-- through the SAME gate (�����) as everything else.  Its boundary is
-- part of the object: ���� exhibits by refl that commutativity of ⊕
-- is beyond the exchange (its step needs a lemma no hypothesis
-- supplies � the AC frontier, named from inside).
------------------------------------------------------------------------
...
--     conditional on p and s agreeing at � � it exists only inside
...
------------------------------------------------------------------------
-- §2  ��������������� � the step's pervasion, grasped within.
...
--     that otherwise goes out as ������ through the external
