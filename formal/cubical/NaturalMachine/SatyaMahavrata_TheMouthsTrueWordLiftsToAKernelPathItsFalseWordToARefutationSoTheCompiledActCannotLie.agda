...
------------------------------------------------------------------------
-- ������������� � the great vow of truth.
--
-- SOURCE.  Umsvti, *Tattvrthastra* 7.1 (c. 2nd�5th c. CE):
-- ����������������������������������� ������������� � the vow is abstention
...
-- nothing else � Umsvti proved no theorem about boolean tests.  The
...
-- test ��� decides and hands no path; here the knowledge-portion
-- supplies the path it was owed:
--
--     ��� a b ≡ true   �   a ≡ b          (the true word lifts)
--     a ≡ b            �   ��� a b ≡ true  (completeness)
--     ��� a b ≡ false  �   � (a ≡ b)      (the false word refutes)
--
-- and the corollary the binary was waiting for: the mouth's runtime
-- census counts a rule closed exactly when ��� (norm l) (norm r) comes
-- back true � ����-������ turns each such runtime "closes" into full
...
--     dismissed.  (The act's catch-all clause ��� _ _ = false reduces
...
--     when ��� (norm l) (norm r) returns true at runtime.  This is the
