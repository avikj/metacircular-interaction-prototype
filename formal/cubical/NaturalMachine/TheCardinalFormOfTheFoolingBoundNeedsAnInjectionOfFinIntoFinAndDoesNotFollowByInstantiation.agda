...
------------------------------------------------------------------------
-- NaturalMachine.TheCardinalFormOfTheFoolingBoundNeedsAnInjectionOfFinIntoFinAndDoesNotFollowByInstantiation
--
...
-- of.  `formal/` and `notes/` grepped for the terms first.
--
-- ────────────────────────────────────────────────────────────────────
...
module NaturalMachine.TheCardinalFormOfTheFoolingBoundNeedsAnInjectionOfFinIntoFinAndDoesNotFollowByInstantiation where
