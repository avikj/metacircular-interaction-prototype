...
------------------------------------------------------------------------
-- NaturalMachine.TheGapWasAUnitsError
--
...
module NaturalMachine.TheGapWasAUnitsError where
...
open import NaturalMachine.SumProductTorus using (Exp ; val ; primes4)
open import NaturalMachine.TheTrajectoryIsAChain using (capE)
