...
module NaturalMachine.Bhanga_ThePositionsOverTwoAtomsAreAThreeStepChain where
...
open import NaturalMachine.KramaAstiNasti_TheFourthCornerAtOneInstanceIsExactlyTheDoubleNegationShift
  using (one)
open import NaturalMachine.KramaSaha_TheFourthCornerIWasNamingIsTheSequentialPosition
  using (trivial ; firstAloneHolds ; secondFailsThere)
open import NaturalMachine.Yugapat_TheRefusalOfJointAssertionDoesNotDecompose
