...
--
-- §2.2 fixes, checked for internal consistency and separation. It is
-- formalised in `NaturalMachine.ArityOfRepair`, which imports this
-- module's A∞ for the "escapes Theorem A" half. * §4.2's refutation of
-- nilpotence is formalised in its ABSTRACT form only (3 above: finite
-- branching does not bound length). The note gives no space-level
-- counterexample beyond the citation that spheres are nilpotent with
-- non-terminating Postnikov towers, and that is not formalisable here.
------------------------------------------------------------------------
