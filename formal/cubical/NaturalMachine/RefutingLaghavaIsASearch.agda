...
------------------------------------------------------------------------
-- NaturalMachine.RefutingLaghavaIsASearch
--
...
-- which univalence discards.  `NaturalMachine.Laghava` proves the
-- instance (`size` does not factor through meaning) and
-- `NaturalMachine.Anuvrtti` proves another (`cost` is not a function of
...
-- beyond what `NaturalMachine.Laghava` already carries.
------------------------------------------------------------------------

module NaturalMachine.RefutingLaghavaIsASearch where
