...
------------------------------------------------------------------------
-- Mlya-sakrnti � the passage of value, from the total to the trace.
--
-- TERM.  �������������, passage / crossing over; attested for the sun's
-- passage between signs (makara-sakrnti).  �����, value or price, is the
...
--       restriction.  (`PramanaTransport_�`'s `�������`, restated at the
...
--       one � and it is NOT an inverse, because `Aresidue_�` proves soundness
...
--       `Residue_�`'s no-go says nothing in the teacher's outputs could have
--       told it otherwise.
--
...
-- `Visranti_�` and `Aresidue_�` are cited in §5, not imported: the recovery
