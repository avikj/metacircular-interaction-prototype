...
------------------------------------------------------------------------
-- NaturalMachine.BarrierIsTwoWitnesses
--
...
module NaturalMachine.BarrierIsTwoWitnesses where
...
open import NaturalMachine.WitnessNumberIsTwo using (Refutes ; refutes→absent)
open import NaturalMachine.WitnessNumberIsThePotential using (WitnessNumberIs)
open import NaturalMachine.WhyTheSitesAreTwo using (CollisionFree)
open import NaturalMachine.SiteAudit
  using (FullLaw ; full-singleton-never ; full-empty-never ; full-collision→refutes)
open import NaturalMachine.TheCeilingIsAboutReading using (tableZ-correct)
...
module Barrier
  ...
  no-pair-on-a-family dB c₀ cs cf ref =
    ...
    open import NaturalMachine.WitnessNumberIsTwo using (AllHold)
    open import Cubical.Data.Unit using (tt*)
    open import Cubical.Data.Sum using (inl ; inr)
    open import NaturalMachine.TheCeilingIsAboutReading using (tableZ)
