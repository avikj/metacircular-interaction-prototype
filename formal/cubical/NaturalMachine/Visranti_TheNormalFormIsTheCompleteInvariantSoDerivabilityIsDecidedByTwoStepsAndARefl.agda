...
------------------------------------------------------------------------
-- Virnti � coming to rest.
--
-- TERM.  ����������, rest / cessation of effort.  The compound is chosen
...
--                   (`Samkhyana_�`), so the �-theory is trivial and
...
--                   terms � is what `Residue_�` proves no semantic criterion
--                   can select.
--
