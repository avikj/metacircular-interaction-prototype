...
module NaturalMachine.TheDeflationaryTestIsVacuous where
...
open import NaturalMachine.TheUnstableGroundCannotBeExhibited
...
open import NaturalMachine.WitnessNumberIsTwo using (factorLaw)
