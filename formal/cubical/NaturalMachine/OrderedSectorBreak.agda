...
------------------------------------------------------------------------
-- NaturalMachine.OrderedSectorBreak
--
...
--
-- `NaturalMachine.CenterRelative` supplies the ambient equivalence
...
module NaturalMachine.OrderedSectorBreak where
...
open import NaturalMachine.PerspectiveCore
