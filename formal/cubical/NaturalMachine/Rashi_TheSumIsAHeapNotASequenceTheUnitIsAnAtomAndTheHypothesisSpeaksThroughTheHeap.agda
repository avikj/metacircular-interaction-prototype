...
------------------------------------------------------------------------
-- ����� � the heap, the quantity: the standard term of the
...
-- rewriting modulo the commutative monoid (�, +, 0) with successor
-- absorbed � the move completion theory knows is required, arrived at
-- here from the machine's own residue.
--
--   �����        the heap of a term (⊕ flattened, su a unit, ze gone)
--   ����-�������  the deep eye: every sum-cluster rebuilt from its
--                sorted heap, everything else by congruence
--   ���������     deletion of one atom, with the sum-path it owes
--   ��������     the surgery: hypothesis-heap out, other-face-heap in
--   ����-������  the examination with the deep eye and the surgical
