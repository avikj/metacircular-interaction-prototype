...
-- the jva.  The classification is his; the mathematics is not
...
module NaturalMachine.TheOperationIsTheMarkOfTheOrganismAndEveryEncounterIsObjectNotAuthor where
