...
------------------------------------------------------------------------
-- NaturalMachine.BoundedStateNeedsAGroup
--
...
module NaturalMachine.BoundedStateNeedsAGroup where
...
open import NaturalMachine.SumProductTorus using (Exp ; zeroE ; _⊕_ ; _⊔_ ; _⊔ℕ_ ; ⊔ℕ-comm)
open import NaturalMachine.DescentCostsTheIntegers
