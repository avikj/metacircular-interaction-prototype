...
module NaturalMachine.RnaDhana_PerCoordinateCapsAreTheHonestVersionAndOneCapIsTheSpecialCase where
...
open import NaturalMachine.RnaDhana_TheCostFlipIsFaithfulBelowTheCap
  using (capReflects)
