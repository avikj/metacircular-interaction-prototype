...
-- Chen's side) do not imply recurrence of the JOINT corner P_r P_c �,
...
--
--   Witness                a radius r : � together with a leg
--                          n : Number (ParitySeparator's factor
--                          multiset; Ω = length)
--   radiusOne, chargeOne   the two Boolean projectors: r ≡� 1 (by a
...
--
-- Radius one is tested by a decidable equality on �, defined by
