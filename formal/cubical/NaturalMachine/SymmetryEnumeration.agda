...
------------------------------------------------------------------------
-- NaturalMachine.SymmetryEnumeration
--
...
module NaturalMachine.SymmetryEnumeration where
...
open import NaturalMachine.SymmetryCardinality using (factorial≡!)
open import NaturalMachine.PathIsSymmetry using (finPathIsSymmetry)
