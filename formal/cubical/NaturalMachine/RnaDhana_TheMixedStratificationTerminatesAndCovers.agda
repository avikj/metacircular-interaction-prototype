...
------------------------------------------------------------------------
-- NaturalMachine.RnaDhana_TheMixedStratificationTerminatesAndCovers
--
...
module NaturalMachine.RnaDhana_TheMixedStratificationTerminatesAndCovers where
...
open import NaturalMachine.RnaDhana_TheMixedStrataArePairwiseDisjointAndOrdered
  using (MemSomeM)
