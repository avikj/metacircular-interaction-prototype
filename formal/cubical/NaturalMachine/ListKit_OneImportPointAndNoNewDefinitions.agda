...
------------------------------------------------------------------------
-- NaturalMachine.ListKit_OneImportPointAndNoNewDefinitions
--
...
module NaturalMachine.ListKit_OneImportPointAndNoNewDefinitions where

open import NaturalMachine.KramaAstiNasti_TheFourthCornerCannotLiveOverAnEnumerableDecidableInstanceSet public
  using (Any ; decAny ; memberToAny)
open import NaturalMachine.ANonEmptyArchiveHasANonEmptyStratum public
  using (anyMap)
open import NaturalMachine.EveryRemainderMemberIsStrictlyDominated public
  using (anyToMember)
open import NaturalMachine.OneStepCoverageAndDisjointnessOfTheLayer public
  using (Mem ; memberOfFilterSatisfies ; memberOfFilterOutFails
        ; memberSplits ; noMemberInBoth)
open import NaturalMachine.TheStratificationCoversAndItsStrataArePairwiseDisjoint public
  using (MemSome ; filterDecSubset ; filterOutSubset)
open import NaturalMachine.EveryRemainderMemberIsBeatenByAStratumMember public
  using (memberIntoFilter)
open import NaturalMachine.TheStratumRankExistsAndDominationStrictlyLowersIt public
  using (memberIntoFilterOut)
open import NaturalMachine.TheParetoStratumIsDecidableAndTheFilterIsExact public
  using (filterDec ; filterDecOnlyKeepsSatisfiers ; filterDecKeepsEverySatisfier)
open import NaturalMachine.TheRemainderIsStrictlyShorterSoTheStratificationHasAMeasure public
