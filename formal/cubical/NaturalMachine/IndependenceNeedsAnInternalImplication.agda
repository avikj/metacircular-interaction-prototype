...
module NaturalMachine.IndependenceNeedsAnInternalImplication where
...
------------------------------------------------------------------------
-- NaturalMachine.IndependenceNeedsAnInternalImplication
--
...
-- (`NaturalMachine.TheUniformFormIsNotRefuted`).  This is the other one.
--
-- ────────────────────────────────────────────────────────────────────
