...
------------------------------------------------------------------------
-- NaturalMachine.ConstructiveBornNormalization
--
...
module NaturalMachine.ConstructiveBornNormalization where
...
import NaturalMachine.ExactProjectivePhase as Proj
