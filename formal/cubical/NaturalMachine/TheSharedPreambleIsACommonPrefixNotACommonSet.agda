...
------------------------------------------------------------------------
-- NaturalMachine.TheSharedPreambleIsACommonPrefixNotACommonSet
--
...
--
-- ADJACENT AND NOT MERGED.  `NaturalMachine.Anuvrtti` proves that a
...
module NaturalMachine.TheSharedPreambleIsACommonPrefixNotACommonSet where
