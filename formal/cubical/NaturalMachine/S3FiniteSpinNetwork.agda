...
module NaturalMachine.S3FiniteSpinNetwork where
...
open Intertwiner
open import NaturalMachine.ParallelNetworkComposition
...
open import NaturalMachine.S3ConjugacyObservation using (mulApply)
