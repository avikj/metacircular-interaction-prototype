...
------------------------------------------------------------------------
-- NaturalMachine.QuotientFiberLaw
--
...
module NaturalMachine.QuotientFiberLaw where
...
open import NaturalMachine.ParitySeparator using
  (Signs ; Number ; Ω ; val ; flip ; sgn ; neutral-blind ; charged-separates)
open import NaturalMachine.ChargeCriterion using (σ₊ ; val-σ₊ ; val-σ₋)
