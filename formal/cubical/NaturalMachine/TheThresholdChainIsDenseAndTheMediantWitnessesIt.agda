...
module NaturalMachine.TheThresholdChainIsDenseAndTheMediantWitnessesIt where

open import Cubical.Foundations.Prelude
open import Cubical.Data.Nat
  using (ℕ ; zero ; suc ; _+_ ; _·_ ; +-suc ; ·-distribˡ ; ·-distribʳ)
open import Cubical.Data.Nat.Order using (_<_ ; _≤_ ; ≤-k+ ; ≤-+k ; <-weaken)
open import NaturalMachine.TheThresholdOrderIsTotalAndTheClaimIsAntitone using (_⊑_)
