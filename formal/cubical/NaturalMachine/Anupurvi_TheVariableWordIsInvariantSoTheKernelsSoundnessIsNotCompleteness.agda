...
------------------------------------------------------------------------
-- nuprv � the order of the series, and the fact that no rewrite in this
-- kernel disturbs it.
--
-- TERM.  ���������, succession / regular order.  The Jain canonical
...
-- transposition: commutativity at `add var var` is a loop that � is forced
...
-- the calculus towards its �-semantics, and it introduces the �/2 of
...
-- design, which is the point.  Nothing here says the �-theory of the
