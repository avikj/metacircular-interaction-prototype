...
-- running count is the position.  Ben Finney's 1976 Hkleʻa voyage
...
-- (NaturalMachine.TheGaugeStreamCostsZeroCarriedBitsAndInvisibilityIsWeakerThanGauge).
-- §§3 and 4
-- show that the
...
module NaturalMachine.TheDominationVerdictIsAFunctionOfTheDeclaredFamilyNotOfTheObject where
...
-- THE FALSE CLAIM.  Reading §2 as "the
