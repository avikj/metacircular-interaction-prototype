...
------------------------------------------------------------------------
-- NaturalMachine.SieveScaleTower
--
...
--
-- This file builds the tower for `NaturalMachine.SieveFiber`'s model
...
module NaturalMachine.SieveScaleTower where
...
open import NaturalMachine.PerspectiveCore using (MonodromyOf)
open import NaturalMachine.SetBaseNoMonodromy using (setNoMonodromy)
