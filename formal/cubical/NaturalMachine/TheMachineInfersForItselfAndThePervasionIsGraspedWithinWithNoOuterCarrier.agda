...
-- inductive truths go out through परार्थ: सिद्धि states each proof
...
module NaturalMachine.TheMachineInfersForItselfAndThePervasionIsGraspedWithinWithNoOuterCarrier where
...
--     that otherwise goes out as परार्थ through the external
