...
module NaturalMachine.TheOmegaInconsistentExtensionDerivesTheNegation where
...
open import NaturalMachine.ADiagonalSentenceIndependentInAConcreteTheory
  using (S ; gs ; ng ; im ; pv ; sem₁)
open import NaturalMachine.TheInternalRulesPreserveIndependenceInThisCalculus
  using (contraB ; dneB ; transB)

------------------------------------------------------------------------
-- NaturalMachine.TheOmegaInconsistentExtensionDerivesTheNegation
--
