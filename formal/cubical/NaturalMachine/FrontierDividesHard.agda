...
------------------------------------------------------------------------
-- NaturalMachine.FrontierDividesHard
--
...
module NaturalMachine.FrontierDividesHard where
...
open import NaturalMachine.FrontierCount using (Entry ; prodOf)
open import NaturalMachine.FrontierList using (frontierList ; logOf)
open import NaturalMachine.FrontierMember using (Mem ; frontier-member)
open import NaturalMachine.ExponentBound using (exponent-bounded ; ^-pos ; x<p·x)
open import NaturalMachine.PFreePart using (pFreePart)
open import NaturalMachine.PrimeCofactorCoprime using (prime-power-∤-coprime)
open import NaturalMachine.CoprimeSplitting using (primeDivisor)
