...
------------------------------------------------------------------------
-- ������������ ����� � Umsvti, Tattvrthastra 9.1 (c. 2nd�5th c.
...
-- an AC theory generates: ������ measured it outside (the naive
...
-- ��-������ (ArpitaAnarpita) decides reachability, so a mirror of a
...
-- rules (UtpadaVyayaDhrauvya, ������-��������); under the anarpita
