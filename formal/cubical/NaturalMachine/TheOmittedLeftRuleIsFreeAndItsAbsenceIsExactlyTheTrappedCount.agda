...
module NaturalMachine.TheOmittedLeftRuleIsFreeAndItsAbsenceIsExactlyTheTrappedCount where
...
open import NaturalMachine.TheTrappedSuccessorIsAThirdConservationLawAndItRefutesTheCompleteInvariantConjecture
  using (trapped)
