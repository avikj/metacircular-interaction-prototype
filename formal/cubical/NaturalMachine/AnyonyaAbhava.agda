...
--
-- `NaturalMachine.Abhava` builds ‡‡‡æ‡µ as a record carrying its
...
open import NaturalMachine.Abhava using (AbhƒÅva ; delimitor ; absent ; dec-collapses)
