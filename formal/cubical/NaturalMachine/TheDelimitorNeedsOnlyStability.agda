...
-- THE SITE
--
-- `NaturalMachine.AnyonyaAbhava` §5 assumes `Dec (Collision q t)` to
...
module NaturalMachine.TheDelimitorNeedsOnlyStability where
...
open import NaturalMachine.AnyonyaAbhava
