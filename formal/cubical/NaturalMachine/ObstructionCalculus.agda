...
------------------------------------------------------------------------
-- NaturalMachine.ObstructionCalculus
--
...
--     repository has none: see `NaturalMachine.CountedDigits`' cost boundary.
--     A ratio of two unmeasured rates is exactly the kind of number
--     `CLAUDE.md` forbids.
------------------------------------------------------------------------

module NaturalMachine.ObstructionCalculus where
...
open import NaturalMachine.SmithSignNormal using (absℤ ; absℤ-idem)
