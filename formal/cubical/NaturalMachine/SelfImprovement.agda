...
------------------------------------------------------------------------
-- NaturalMachine.SelfImprovement
--
...
--
-- Related checked work: `NaturalMachine.EvaluatorTransport` proves that
...
module NaturalMachine.SelfImprovement where
...
open import NaturalMachine.CostGeometry using (Presentation ; pres ; Edge ; edge)
open import NaturalMachine.Residual using (Bridge)
open import NaturalMachine.ChuAdvance using (Obs ; Agree)
