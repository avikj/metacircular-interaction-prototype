...
--            which the base cannot see at all (`NaturalMachine.Laghava`:
...
module NaturalMachine.YantraTantu_TheEngineLivesInTheFibreOfItsDenotation where
...
open import NaturalMachine.Alopa_TheEngineNeverTouchesTheMeaning
