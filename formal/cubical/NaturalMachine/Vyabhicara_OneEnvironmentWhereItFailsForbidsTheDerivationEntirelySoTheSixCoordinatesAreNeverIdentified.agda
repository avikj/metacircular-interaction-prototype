...
------------------------------------------------------------------------
-- NaturalMachine.Vyabhicara_OneEnvironmentWhereItFailsForbidsTheDerivation
...
--     and needs an invariant on `Step`, which is not here.
...
module NaturalMachine.Vyabhicara_OneEnvironmentWhereItFailsForbidsTheDerivationEntirelySoTheSixCoordinatesAreNeverIdentified where
