...
------------------------------------------------------------------------
-- NaturalMachine.WhatTheSubstrateArgumentCovers
--
-- Building on the one thing `NaturalMachine.DeflationaryTest` has that
...
module NaturalMachine.WhatTheSubstrateArgumentCovers where
...
open import NaturalMachine.DeflationaryTest using (sum→dec)
