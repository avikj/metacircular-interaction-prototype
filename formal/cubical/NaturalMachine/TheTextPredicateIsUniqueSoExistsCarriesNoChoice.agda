...
------------------------------------------------------------------------
-- NaturalMachine.TheTextPredicateIsUniqueSoExistsCarriesNoChoice
--
...
module NaturalMachine.TheTextPredicateIsUniqueSoExistsCarriesNoChoice where
...
open import NaturalMachine.ATextPredicateExistsExactlyWhenTheSemanticPropertyIsDecidable
  using (Correct)
