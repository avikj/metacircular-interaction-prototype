...
module NaturalMachine.ATruthFunctionalProvabilityFalsifiesTheDiagonalSentence where
...
open import NaturalMachine.ASmallTheoryWithAnIndependentSentence using (impB)

------------------------------------------------------------------------
-- NaturalMachine.ATruthFunctionalProvabilityFalsifiesTheDiagonalSentence
--
