...
------------------------------------------------------------------------
-- NaturalMachine.CarryClassNonzero
--
...
--
-- where H² is the group constructed in `NaturalMachine.GroupCohomologyH2`
...
module NaturalMachine.CarryClassNonzero where
...
open import NaturalMachine.GroupCohomologyH2 using (module CarryClass)
