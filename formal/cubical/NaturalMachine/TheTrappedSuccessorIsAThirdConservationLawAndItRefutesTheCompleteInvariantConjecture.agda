...
module NaturalMachine.TheTrappedSuccessorIsAThirdConservationLawAndItRefutesTheCompleteInvariantConjecture where
...
open import NaturalMachine.TheVariableWordIsInvariantSoTheKernelsSoundnessIsNotCompleteness
  using (VarName ; word ; step-preserves-word ; derivation-preserves-word)
open import NaturalMachine.TheCountingSemanticsIsTheAbelianisationOfTheWordAndSoundnessIsTwoConservationLaws
