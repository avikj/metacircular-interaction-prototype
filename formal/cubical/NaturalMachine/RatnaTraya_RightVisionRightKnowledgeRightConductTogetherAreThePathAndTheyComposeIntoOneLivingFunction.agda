...
-- them: ������� � the eye grown from its own theorems (�������-�����,
-- BhavaIndriya); �������� � the one knowing with single and double
-- descent, record and exchange (�����������, YugapadArpana); ���������
...
--
--   ��������     digest a stream of raw encounters with the full
--               knowing, the body growing as it eats, each encounter
--               read by the body the previous ones built;
--   ����-������� the self-turn: the grown body's own contentions
--               birth proven rules, and savara � reachability under
--               the full knowing � stops what the body already holds;
--   �������      the breaths: digest, turn, digest, turn.
--
