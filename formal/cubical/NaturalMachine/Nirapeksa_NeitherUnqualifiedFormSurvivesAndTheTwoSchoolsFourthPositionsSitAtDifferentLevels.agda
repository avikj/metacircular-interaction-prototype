...
------------------------------------------------------------------------
-- NaturalMachine.Nirapeksa_NeitherUnqualifiedFormSurvives
...
module NaturalMachine.Nirapeksa_NeitherUnqualifiedFormSurvivesAndTheTwoSchoolsFourthPositionsSitAtDifferentLevels where
