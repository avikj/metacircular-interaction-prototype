...
------------------------------------------------------------------------
-- NaturalMachine.PerspectiveCore
--
...
-- executable in the machine core.  `NaturalMachine.CenterRelative` does
...
module NaturalMachine.PerspectiveCore where
...
-- `NaturalMachine.SieveFiber` found that the sieve quotient DOES admit a
