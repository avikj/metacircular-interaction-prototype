...
------------------------------------------------------------------------
-- NaturalMachine.SieveRoughBridge
--
...
module NaturalMachine.SieveRoughBridge where
...
open import NaturalMachine.RoughSplit
  using (isqrt ; isqrt-30 ; isqrt-49 ; AllPrimeFactorsAbove ; roughSplitSqrt
        ; 49≢1 ; ¬prime49)
open import NaturalMachine.WalkJumps using (IsPrime ; 0<→≢0)
