...
module NaturalMachine.MokshaYantra where
...
open import NaturalMachine.NisvabhavaNet using (Jewel ; reflect)
open import NaturalMachine.PratityasamutpadaArising
