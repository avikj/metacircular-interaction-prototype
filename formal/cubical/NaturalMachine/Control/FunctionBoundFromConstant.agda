...
------------------------------------------------------------------------
-- NaturalMachine.Control.FunctionBoundFromConstant
--
-- *** THIS FILE MUST FAIL TO TYPE-CHECK. ***
--
-- Designed annihilation (collab/PROTOCOL.md §7), companion to
-- `NaturalMachine.ConstantBoundNotFunctionBound` (exit 0 under the pin).
--
...
module NaturalMachine.Control.FunctionBoundFromConstant where

open import Cubical.Foundations.Prelude
open import Cubical.Data.Nat using (ℕ)
open import Cubical.Data.Nat.Order using (_≤_)

open import NaturalMachine.ConstantBoundNotFunctionBound
