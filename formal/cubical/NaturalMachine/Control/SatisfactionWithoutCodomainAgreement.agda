...
------------------------------------------------------------------------
-- NaturalMachine.Control.SatisfactionWithoutCodomainAgreement
--
-- *** THIS FILE MUST FAIL TO TYPE-CHECK. ***
--
-- Designed annihilation (collab/PROTOCOL.md §7), companion to the
-- hypothesis-carrying module `NaturalMachine.AtomicSatisfaction`
...
module NaturalMachine.Control.SatisfactionWithoutCodomainAgreement where
