...
------------------------------------------------------------------------
-- Sakhyna � the counting, and exactly what it is the count OF.
--
-- TERM.  ��������, enumeration / reckoning; the ordinary word for counting
-- as an act, as against �������, the number reached.  Used here in that
...
--                 `add var var` commutativity is a loop � must call `refl`,
...
--
--          eval t �  ≡  sumWord (word t) �  +  constPart t ,
--
...
--       letters, because addition on � is commutative.
--
...
--
--       Tm ��word��� List VarName ��abelianise��� �� , plus a constant
--            ▲                          ▲
...
-- �-semantics and introduces the �/2 of holonomy: it is the generator of
