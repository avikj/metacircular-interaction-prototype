...
module NaturalMachine.TheBodyGrowsItsOwnEyesFromItsOwnRulesAndNoAgentBuildsOrgans where
...
open import NaturalMachine.TheFiveProversWereNayasOfOneKnowingAndEachIsAParameterSettingOfTheOnePramana
  using (दृक्)
open import NaturalMachine.TheOneKnowingCarriesEveryOrganAsAParameterAndTheWholeInheritanceCrossesInOneAct
