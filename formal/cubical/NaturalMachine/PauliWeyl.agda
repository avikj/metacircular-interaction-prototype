...
------------------------------------------------------------------------
-- NaturalMachine.PauliWeyl
--
-- THE PERES–MERMIN SIGN VECTOR, DERIVED.
--
-- `NaturalMachine.PMCokernel` says of itself:
--
...
module NaturalMachine.PauliWeyl where

open import Cubical.Foundations.Prelude
open import Cubical.Data.Bool using (Bool ; true ; false ; _⊕_ ; _and_)
open import Cubical.Data.Sigma using (_×_ ; _,_)

open import NaturalMachine.PMTorus    using (Ctx ; R0 ; R1 ; R2 ; C0 ; C1 ; C2)
open import NaturalMachine.PMCokernel using (s)
