...
module NaturalMachine.TheOpenPigeonholeReducesToFinAndTheTargetBeingAPropIsWhatMakesTheMereEquivalencesUsable where
...
open import NaturalMachine.OptimalObservation using (Injective ; Optimal)
