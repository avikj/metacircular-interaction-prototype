...
module NaturalMachine.HolonomyIsInvisibleExactlyToAnInvariantConsumerAndExactlyIsNowEarned where
...
open import NaturalMachine.HolonomyIsInvisibleExactlyToAnInvariantSemantics
