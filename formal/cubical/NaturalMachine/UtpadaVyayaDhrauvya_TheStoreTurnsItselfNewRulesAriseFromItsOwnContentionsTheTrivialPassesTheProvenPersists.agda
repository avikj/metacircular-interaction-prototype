...
-- critical pair is born already proven (�������).  Births the
-- normalizer already closes are discarded (����).  What is kept
-- carries its ������� by type and enters the store through the same
...
-- module minted (��������, �����-����� � themselves machine-proven).
...
------------------------------------------------------------------------
-- §2  �������� � the birth at the meeting.  The site arises from the
...
------------------------------------------------------------------------
-- §3  ����� � the passing.  A birth the normalizer already closes is
--     no new knowledge; it is let go.  ��������� is the type itself:
--     what remains is a �����, its proof a field, forever.
------------------------------------------------------------------------
...
--     proofs ride inside the ����� values by type.
------------------------------------------------------------------------
