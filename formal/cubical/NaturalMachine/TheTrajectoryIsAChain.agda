...
------------------------------------------------------------------------
-- NaturalMachine.TheTrajectoryIsAChain
--
...
module NaturalMachine.TheTrajectoryIsAChain where
...
open import SourcedProofs.IdempotenceForbidsDescent using (⊔-idem ; ⊔-assoc)
