...
-- ChuDefect — the quantitative form of NaturalMachine.ChuAdvance.
--
...
module NaturalMachine.ChuDefect where
...
open import NaturalMachine.ChuAdvance using (Obs ; Agree ; Separates)
