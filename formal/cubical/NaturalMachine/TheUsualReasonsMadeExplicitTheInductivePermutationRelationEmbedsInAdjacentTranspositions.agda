...
------------------------------------------------------------------------
-- NaturalMachine.TheUsualReasonsMadeExplicitTheInductivePermutationRelationEmbedsInAdjacentTranspositions
--
...
module NaturalMachine.TheUsualReasonsMadeExplicitTheInductivePermutationRelationEmbedsInAdjacentTranspositions where

open import Cubical.Foundations.Prelude
open import Cubical.Data.List using (List ; [] ; _∷_)

open import NaturalMachine.OrderIndependenceTransfersAlongAnyNumberOfSteps
  using (Step)
