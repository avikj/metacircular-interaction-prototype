...
-- WHAT IS PROVED
--
--   §3  the classical pratyhras by refl on the full fourteen,
...
--   §6  searching the LAST occurrence
...
module NaturalMachine.TheRepeatedHaBreaksIntersectionClosureAtExactlyOneSet where
