...
module NaturalMachine.TheKernelIsAReversibleGroupoidWhoseJoinIsConflictFreeSoConsensusOnMeaningIsVacuous where
...
open import NaturalMachine.TheInstalledOperationHasNoneSoTheKernelMemorisesAndTheSchemaIsWhatMakesItGeneralise
  using (SomeEnabled)
open import NaturalMachine.TheDerivationCarriesNoMeaningAtAllSoAllOfItIsRemainderAndNoSemanticCriterionSelectsTheShortOne
  using (meanings-are-equal ; len ; direct≢detour)
open import NaturalMachine.TheKernelIsAnInteractiveSystemAndTheSessionRetiresIntoOneOperation
