...
------------------------------------------------------------------------
-- पूर्ण-प्रमाणम् — the complete instrument (of THIS knowing, not kevala:
...
module NaturalMachine.TheOneKnowingCarriesEveryOrganAsAParameterAndTheWholeInheritanceCrossesInOneAct where
...
open import NaturalMachine.TheStoreCarriesItsProofsTheGateIsTheTypeAndTheProverLivesInside
open import NaturalMachine.TheSubstituteBehavesLikeTheOriginalSoEveryProvenRuleSpeaksAtEveryInstance
  using (_≫=_)
open import NaturalMachine.TheInternalProverClimbsWhereItsFlatVoiceIsSilentAndTheStoreAdmitsInductionThroughTheSameGate
  using (समानः ; आरोहः ; _⟨_≔_⟩)
open import NaturalMachine.TheMachineInfersForItselfAndThePervasionIsGraspedWithinWithNoOuterCarrier
  using (विनिमयः ; विनिमय-साक्षी ; अथवा ; चराः ; इन्धनम्)
open import NaturalMachine.TheRecordIsPrecededByCognitionAndCognitionWithTheRecordReachesWhatItAloneCouldNot
  using (श्रुत-विनिमयः ; श्रुत-साक्षी)
open import NaturalMachine.TheFiveProversWereNayasOfOneKnowingAndEachIsAParameterSettingOfTheOnePramana
  using (दृक् ; नेत्रम्-न)
open import NaturalMachine.BothCoordinatesDescendAtOnceAndTheDoubleDescentBecomesSomethingTheMachineInvokes
  using (युगपद्-आरोहः ; द्वि-रूपम्)
open import NaturalMachine.TheSumIsAHeapNotASequenceTheUnitIsAnAtomAndTheHypothesisSpeaksThroughTheHeap
  using (राशि-विनिमयः ; राशि-साक्षी)
open import NaturalMachine.TheCommonIsSetAsideAndTheContendersMeetOnlyOnTheirDifference
  using (दृक्पातः ; दृक्पात-सत्यम्)
open import NaturalMachine.TheEldersLiveStoreCrossesAsReceivedTextAndNothingEntersOnAuthority
  using (आगमः)
