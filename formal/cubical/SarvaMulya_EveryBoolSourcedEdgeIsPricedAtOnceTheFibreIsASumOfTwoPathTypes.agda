...
------------------------------------------------------------------------
-- ����������� � the price of all of them.  Compound built here,
-- 2026-08-23, from ordinary  (����, all; �����, price); no source
-- is claimed for the term.
--
-- WHY.  Mulyankana priced two of Jiva's five named Bool � � edges by
...
-- (������� below � a trichotomy carrying its evidence, never a flag).
--
...
--
-- The verdict discipline is Avaccheda's (�������� / ����� / ���) and the
-- refusal of a two-valued collapse is Saptabhangi.�������; the fibre is
...
module _ {B : Type ℓ} (f : Bool → B) (b : B) where
  ...
  ----------------------------------------------------------------------
  -- ������� � the decomposition.  No hypothesis on B.
  ----------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------
  -- ������� � over a discrete target the verdict is a computation, and
  ...
  -- positions, no flag (Saptabhangi.�������: a two-valued verdict on
