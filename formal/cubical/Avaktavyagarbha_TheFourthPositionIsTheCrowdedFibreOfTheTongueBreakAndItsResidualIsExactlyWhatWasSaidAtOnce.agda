...
--       and by `Residue`/`���` this is the second cell, ������, exhibited �
...
-- Avaktavya carries a `Residue` as a VALUE rather than a rendering � and it
...
-- proves the order-closure of the first three never touches it.  §1 says
...
-- �.�  IF the tongue-break destroyed nothing, saha WOULD be order�
