...
-- every depth.
--
-- ������� � the stream.  The earlier decomposition of SHA-256 was
...
-- decomposition in the corpus's coinductive calculus � Dhr
...
--
--     val  = gati roundStep   (the round layer: inputs are (Kt,Wt))
--     Khaa = gati compress    (the block layer: inputs are blocks)
--
-- WHAT IS PROVED, all checked terms, no postulates, no holes:
--
--   §2  ������-�������� � the chain forgets its past BY REFL: the tail
--       of the chain from H is the chain from the stepped state, on
--       the nose.  At the block layer this is the Merkle�Damgrd
...
--       future.
--   §2  ������-������ / ������-����� � the depth-(length xs) truncation
--       of the chain IS the finite run, and its last entry IS the
--       fold.  Corollary ���������-��������: sha256ws m is literally a
...
--   §2  ������� � unit-speed causality in the take-metric: input
...
--   §3  ���-������ � determinism is contractibility of the run
...
--   §4  ����-��������� � the decomposition sharpened in the limit.  At
...
--       ����-��������� � the rounds are a permutation, so no depth loses
...
--   §5  ��������-������� � the receipt: the NIST vector for the empty
...
-- its truncations), causality (�������), and uniqueness of history
-- (���-������) are statements no finite derivation can even type.
--
-- EA.  A stream is the DEGENERATE case of an interaction � the one
...
-- Merkle�Damgrd length-extension property, coinductively: two
