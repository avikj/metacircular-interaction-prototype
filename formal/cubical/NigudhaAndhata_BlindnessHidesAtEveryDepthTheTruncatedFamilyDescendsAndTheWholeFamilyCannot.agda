...
------------------------------------------------------------------------
-- ������-������ � hidden blindness.  Compound built here, 2026-08-23
-- (������, concealed; ������, blindness); not a source term.
--
...
--   dependent descent � Desc_S(F) = �[D] Π (F x ≡ D (S x)) � and
--   obstructs it in the inhabited/empty case by one transport.  The
--   general form is proved here (���-����): a blind pair whose fibres
...
--   derived from it in one line (���������), so the probe's theorem is
...
--       charge stratum, AnantaraArpana's �����), so a descended family
--       is CONSTRUCTED, ua of the contractibility equivalence;
--   (b) does NOT descend whole � S��� � Unit is refuted through the
--       corpus's own charge ladder: contractibility would climb the
--       truncation and the loop tower into AnantaraArpana's ��������,
--       forcing isContr �, i.e. pos 0 ≡ pos 1.
--
...
--   stated as the type ������-������, one n at a time, checked.
--
-- SOURCES AND SCOPE.  The engines are the library's (sphereConnected,
-- Cubical.HITs.Sn.Properties) and this corpus's own (��������,
-- AnantaraArpana � ����S��� � � read at the stratum above silence).
...
--     would climb into �������� and force isContr �.
------------------------------------------------------------------------
