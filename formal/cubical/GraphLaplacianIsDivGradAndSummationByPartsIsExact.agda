...
------------------------------------------------------------------------
-- GraphLaplacianIsDivGradAndSummationByPartsIsExact
--
...
module GraphLaplacianIsDivGradAndSummationByPartsIsExact where
...
--   β = |E| − |V| + c carries that c for exactly this reason.
