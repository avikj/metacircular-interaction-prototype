...
--   NaturalMachine.DependentOptimizationFibration.Configuration  âŸ  âŸ¨libâŸ©.Bool
--   Â NaturalMachine.DependentOptimizationFibration.semantics
--
...
--       fiber semantics false â‰ Configuration.  A constant map loses
--       EVERYTHING, and the fibre says so exactly: the elided datum is
--       the whole input.
--   Â§2  off the value the fibre is EMPTY: Â fiber semantics true.
...
over-value : fiber semantics false â‰ƒ Configuration
