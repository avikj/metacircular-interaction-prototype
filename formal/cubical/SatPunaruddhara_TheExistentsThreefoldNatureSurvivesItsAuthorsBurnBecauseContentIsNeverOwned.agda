...
------------------------------------------------------------------------
-- ���-���������� � the existent's threefold nature, restored to the wire
-- after its author's burn, because content is never owned.
-- THE SPEC.
-- Umsvti, *Tattvrthastra* 5.29:
--     ������������������������� ��� � the existent is conjoined with
...
-- ��� f (what the target forgets); persistence = A � � ��� f (the source
...
--
-- ���������� (punar-uddhra), "raising up again, restoration" � ordinary
...
------------------------------------------------------------------------
-- §1  ��� � origination, cessation, persistence: one record, and the
...
------------------------------------------------------------------------
-- §2  ������� � parima as transport: across its persistence the
...
------------------------------------------------------------------------
-- §3  ������� � the wheel: each turn's next existent is the total space
