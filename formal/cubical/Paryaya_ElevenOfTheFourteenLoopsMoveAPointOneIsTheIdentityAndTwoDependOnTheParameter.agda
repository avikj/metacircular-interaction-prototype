...
import EGBCycleHolonomy                                as CY
import AchromaticToy                                   as AT
import EGBReversalInvariant                            as RV
...
-- १.१  EGBCycleHolonomy.holBool : Bool ≃ Bool — three `not`s, so `not`.
...
-- २.२  EGBCycleHolonomy.hol is not a loop: it is a FAMILY over three
...
-- २.३  EGBReversalInvariant.revEquiv is likewise a family, over the
