...
-- ��� non-associative, by a counterexample.  `Avaktavyagarbha_�` prices the
-- collapse as a fibre.  What neither says is what ��� IS, and it has a
-- one-line answer:
--
--     ���  =  r ∘ krama,   r = ����������,   r idempotent  (§1)
--
-- so ��� is not a second primitive operation.  It is krama read through a
...
--       non-associative operation arises, and `Avaktavyagarbha_�.�����������-�����`
--       is the converse half (identity � associative).
--   §3  �'s kernel, universally.  `SaptabhangiSamyoga` records `������` as
--       ONE refl � that the seventh bhaga arises by krama.  §3 gives the
...
-- between krama and saha (Laghyastraya, c. 720�780) is, in this algebra,
...
------------------------------------------------------------------------
-- � � ����������� � the tongue-break is IDEMPOTENT, so ��� = r ∘ krama with
