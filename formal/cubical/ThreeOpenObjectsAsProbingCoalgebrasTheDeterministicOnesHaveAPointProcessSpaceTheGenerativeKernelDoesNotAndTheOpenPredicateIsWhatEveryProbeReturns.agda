...
module ThreeOpenObjectsAsProbingCoalgebrasTheDeterministicOnesHaveAPointProcessSpaceTheGenerativeKernelDoesNotAndTheOpenPredicateIsWhatEveryProbeReturns where
...
module Kernel where
  ...
  ----------------------------------------------------------------------
  -- वर्धन-बहुत्वम् — THE PROCESS SPACE IS NOT A POINT.
