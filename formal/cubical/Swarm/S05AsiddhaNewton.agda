...
-- for units is FOUR polynomial identities in �[a,x,y]; each identity is
...
--                 observer cannot tell apart.  Pini 8.2.1: the later
...
-- �tale over the base � stated with the ideal quantifiers made explicit
...
-- self-contained exact computation over �: the broadcast's boxed
-- 5�� ≡ 29 (mod 72), obtained by ONE application of N, with no
-- kuaka, no CRT gluing and no per-prime residue sensors.
------------------------------------------------------------------------
...
-- and 5�� ≡ 2 (mod 9) and gluing by kuaka/CRT.  But 5�5 = 25 = 1+24,
