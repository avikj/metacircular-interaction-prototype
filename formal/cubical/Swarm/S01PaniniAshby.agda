...
--            (vipratiedhe para kryam).  Determinism comes from the
--            ORDER.
--
...
-- Pini's answer: order the three rules and determinism returns.
...
--     Pini counts RULES, and the rule count is the logarithm.
...
------------------------------------------------------------------------
-- 4.  Ashby's law for Pinian rule systems
--
