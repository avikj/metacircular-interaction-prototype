...
The statements are deliberately distribution-free; the algebraic core is simplyThe statements are deliberately distribution-free.  Shannon entropy may be
