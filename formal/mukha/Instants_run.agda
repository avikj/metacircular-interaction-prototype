...
open import TheOneKnowingItselfCrossesTheBoundaryCertificatesAndAllInTheSharedTongue
  using (नियमः)
open import TheActPortionOfTheBodyPathFreeAndCompiled using (Eq')
open import TheWholeOrganismIsDataOneSamayaStepAssistsAndEveryReflexIsAModeNotAPrimitive
