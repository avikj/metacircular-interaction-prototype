...
module TheCompiledWordCarriesItsKnowingErasedSoTheBinaryIsScripture where
...
open import NaturalMachine.TheStoreCarriesItsProofsTheGateIsTheTypeAndTheProverLivesInside
  using (⊨_)
open import NaturalMachine.TheMouthsTrueWordLiftsToAKernelPathItsFalseWordToARefutationSoTheCompiledActCannotLie
  using (मुख-सत्यम्)
