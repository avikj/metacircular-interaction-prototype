...
------------------------------------------------------------------------
-- ��������-���� � the classifier has ONE spelling, shared by the
-- proposer and the theorem.
--
-- TERM.  hdaya, the heart, the essential core � ordinary ;
...
--
-- Only Agda.Builtin modules are imported, so both worlds agree on �,
