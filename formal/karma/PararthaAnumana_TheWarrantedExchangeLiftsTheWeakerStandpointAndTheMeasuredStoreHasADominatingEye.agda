...
------------------------------------------------------------------------
-- �������������� � inference for another.  Siddhasena Divkara,
-- *Nyyvatra* (c. 5th�7th c. CE), the classical division: svrtha,
...
-- AS a parrtha utterance � the rule with its certificate � and the
...
--
--   � � the norm eye with the syntactic exchange (��������-��������)
--   � � the factoring heap eye with the surgical exchange (����-��������)
--
-- Each can breathe the elder's store alone; and they can HOLD COUNCIL
-- (������): breathe in turn on one shared record, each pass re-offering
-- only the residue the other could not close.  Every rule that crosses
-- between them carries its ������� by construction, so the exchange
...
--
--   norm+�������� 93   norm+���� 94   norm+�������� 94
--   ����+�������� 101   ����+���� 102   ����+�������� 102
--
-- so on THIS store the factoring heap eye with the surgical exchange
-- DOMINATES � ���� alone suffices for all 102, the composite
...
-- probed: ����+�������� (101) in council with norm+���� (94) reaches
-- 101, NOT 102 � the one rule ����+�������� misses needs the surgery
...
--     each hands the other is received whole � parrtha, warranted,
