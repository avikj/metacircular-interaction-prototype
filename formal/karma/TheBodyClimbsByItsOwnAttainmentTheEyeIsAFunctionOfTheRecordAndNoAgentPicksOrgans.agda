...
module TheBodyClimbsByItsOwnAttainmentTheEyeIsAFunctionOfTheRecordAndNoAgentPicksOrgans where
...
-- the left-handed unit, extracted the same way.
...
--     the rule's own witness; nothing external enters.
------------------------------------------------------------------------
