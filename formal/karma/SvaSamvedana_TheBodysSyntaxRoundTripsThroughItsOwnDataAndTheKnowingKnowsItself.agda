...
------------------------------------------------------------------------
-- ����������� � self-cognition.  Akalaka (c. 720�780 CE,
-- *Laghyastraya* / *Nyyavinicaya*): jna is svasavidita � a
...
-- back whole.  ������� lays a term out as a thread of numbers (the
-- stra � literally the thread); ���� reads the thread back (the
-- pha � the recitation); and the round-trip theorem �����������
