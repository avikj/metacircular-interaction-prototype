...
------------------------------------------------------------------------
-- �������� � own-form.  The capability map of this model of
...
--
--   Optimal how?      By �����, the economy criterion internal to the
...
--                     is internal (����� is a Tm�Tm translation), its
...
--   Writes algorithms?  Yes, in its native sense: ����� synthesizes a
...
--                     recursor).
--   Finds efficient ones?  Yes, measured: �����-����� picks the
...
--   Maps space-time?  Time: yes, internally (�����; cost claims are
--                     ordinary claims).  Space: ��� measures terms,
