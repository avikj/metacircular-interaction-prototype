...
------------------------------------------------------------------------
-- अशान्तिः — unquiet.  Ordinary  (the negation of śānti);
...
module TheBodyPosesItsOwnProblemsCostDissatisfactionBecomesADriveAndTheBreathEatsTheAnswers where
...
open import TheActPortionOfTheBodyPathFreeAndCompiled
  using (Tm ; Eq' ; समः)
open import TheOneKnowingItselfCrossesTheBoundaryCertificatesAndAllInTheSharedTongue
  using ( नियमः ; niyama ; गूढ-दृक् ; संयुक्त-यन्त्रम् ; पूर्ण-प्रमाणम् ; इन्धनम्
        ; _++_ ; _×_ ; if_then_else_ ; _≤?_ )
open import TimeIsASubstanceInTheSameTongueAndTheMachineProvesCostAsItProvesTruth
  using (कालम् ; लाघव-नयनम्)
open import ThePosedProblemIsSolvedAsOptimizationTheAnswerCertifiedAndTheCostJudgedAtScales
  using (मानम्)
