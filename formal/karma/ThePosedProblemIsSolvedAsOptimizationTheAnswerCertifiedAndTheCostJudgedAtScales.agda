...
module ThePosedProblemIsSolvedAsOptimizationTheAnswerCertifiedAndTheCostJudgedAtScales where
...
------------------------------------------------------------------------
-- §4  The solver: admit by proof, judge by the clock, claim by syt.
------------------------------------------------------------------------
