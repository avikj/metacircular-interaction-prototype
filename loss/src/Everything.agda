...
open import Loss.Sesa_TheResidualIsTheOtherProjectionOfTheSameGraph
...
open import Loss.Adharmin_TheUnposedQuestionIsNotAnEmptyFibreAndTheCensusCannotSayIt

-- The arithmetic instance, and the proof that it computes.
open import Loss.Viveka
open import Loss.Compute
...
open import Loss.KuttakaValli_TheSideIsAFreeSlotAndThatIsWhatMakesTheStepDecisionFree
...
open import Loss.Bhavana_TheKsepaIsDeterminedByTheRootsAndCompositionMultipliesIt
...
open import Loss.Sthanivadbhava_TheAdesasFormIsTheFreeSlotAndItsDesignationsAreCarried

-- भित्ति: the carrier is not two-valued, and the wall crosses its own ford.
open import Loss.BhittiSthanivat_PaninisCarrierIsNotTwoValuedAndTheWallCrossesItsOwnFord
...
open import Loss.SthanivatSankhya_TheAdesaStateSpaceIsExactlyEightyOneAndTheJoinToTheNumberComponentIsChecked
...
open import Loss.Labdhi_TheQuotientSlotIsNeverCrowdedSoExactDivisionCanOnlyFailByBeingUnposed
