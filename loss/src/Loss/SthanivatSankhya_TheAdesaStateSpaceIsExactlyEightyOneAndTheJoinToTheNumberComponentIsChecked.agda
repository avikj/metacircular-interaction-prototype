...
-- `Loss.Sthanivadbhava….स्थानिवत्` to the number component at
...
module Loss.SthanivatSankhya_TheAdesaStateSpaceIsExactlyEightyOneAndTheJoinToTheNumberComponentIsChecked where
...
open import Loss.Carrier using (Carrier≃)
