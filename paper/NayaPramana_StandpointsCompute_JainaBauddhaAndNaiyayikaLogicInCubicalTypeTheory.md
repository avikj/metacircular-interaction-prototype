...
All under `formal/cubical/NaturalMachine/`. Each module header carries its source
citation, its scope of claim on that source, what it does not prove, and the
toolchain it was checked against.
